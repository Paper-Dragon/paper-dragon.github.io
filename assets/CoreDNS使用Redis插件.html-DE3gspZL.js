import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as n,d as a}from"./app-DOdwOmWZ.js";const t={},o=a(`<h1 id="coredns使用redis插件" tabindex="-1"><a class="header-anchor" href="#coredns使用redis插件"><span>CoreDNS使用Redis插件</span></a></h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description"><span>Description</span></a></h2><p><em>redis</em> enables reading zone data from redis database. this plugin should be located right next to <em>etcd</em> in <em>plugins.cfg</em></p><h2 id="syntax" tabindex="-1"><a class="header-anchor" href="#syntax"><span>Syntax</span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>redis
