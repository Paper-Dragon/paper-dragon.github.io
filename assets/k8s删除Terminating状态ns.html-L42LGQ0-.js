import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as t}from"./app-3a9u-IC9.js";const e={},o=t(`<h1 id="k8s删除terminating状态ns" tabindex="-1"><a class="header-anchor" href="#k8s删除terminating状态ns" aria-hidden="true">#</a> k8s删除Terminating状态ns</h1><h1 id="假设你要删掉ns资源-发现一直删不了处于terminating状态" tabindex="-1"><a class="header-anchor" href="#假设你要删掉ns资源-发现一直删不了处于terminating状态" aria-hidden="true">#</a> 假设你要删掉ns资源，发现一直删不了处于terminating状态</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># kubectl get ns</span>
NAME              STATUS        AGE
