import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as e}from"./app-IV-u4sF5.js";const t="/assets/image-20211116145510909-16370457460581-BuXkOS6Q.png",i="/assets/image-20211116145621627-ZDfS-qt6.png",o="/assets/image-20211116151442638-D10xxSDc.png",l="/assets/image-20211117083904657-qrAxXDcc.png",c="/assets/image-20211117231143675-ExYhCZee.png",p="/assets/image-20211117231243044-XqkMdRjO.png",u="/assets/image-20211117231251486-b3umTi1k.png",r="/assets/image-20211117231308169-iBGTb18E.png",d="/assets/image-20211117235501571-9WMeqmr-.png",v="/assets/image-20211118000511866-tvj6-Enr.png",m="/assets/image-20211118000504423-RP77cuWT.png",b="/assets/image-20211118000526400-AKywjozh.png",k="/assets/image-20211118000641707-yW0KmPko.png",g={},h=e('<h1 id="elk日志分析系统" tabindex="-1"><a class="header-anchor" href="#elk日志分析系统" aria-hidden="true">#</a> ELK日志分析系统</h1><figure><img src="'+t+'" alt="image-20211116145510909" tabindex="0" loading="lazy"><figcaption>image-20211116145510909</figcaption></figure><figure><img src="'+i+'" alt="image-20211116145621627" tabindex="0" loading="lazy"><figcaption>image-20211116145621627</figcaption></figure><h1 id="e-elasticsearch" tabindex="-1"><a class="header-anchor" href="#e-elasticsearch" aria-hidden="true">#</a> E Elasticsearch</h1><p>弹性搜索，日志<strong>存储</strong></p><h1 id="l-logstash" tabindex="-1"><a class="header-anchor" href="#l-logstash" aria-hidden="true">#</a> L Logstash</h1><p>日志收集</p><h1 id="k-kibana" tabindex="-1"><a class="header-anchor" href="#k-kibana" aria-hidden="true">#</a> K Kibana</h1><p>日志展示</p><figure><img src="'+o+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="实战" tabindex="-1"><a class="header-anchor" href="#实战" aria-hidden="true">#</a> 实战</h1><h2 id="环境" tabindex="-1"><a class="header-anchor" href="#环境" aria-hidden="true">#</a> 环境</h2><p>操作系统优化</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>master-slave模式</p><figure><img src="`+l+`" alt="image-20211117083904657" tabindex="0" loading="lazy"><figcaption>image-20211117083904657</figcaption></figure><p>内存：大于2G</p><h2 id="elasticsearch" tabindex="-1"><a class="header-anchor" href="#elasticsearch" aria-hidden="true">#</a> Elasticsearch</h2><h3 id="基础环境安装-node1-node2同时进行" tabindex="-1"><a class="header-anchor" href="#基础环境安装-node1-node2同时进行" aria-hidden="true">#</a> 基础环境安装 node1 node2同时进行</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@node1 ~<span class="token punctuation">]</span><span class="token comment"># rpm --import https://packages.elastic.co/GPG-KEY-elasticsearch</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="两台服务器均可插件测试" tabindex="-1"><a class="header-anchor" href="#两台服务器均可插件测试" aria-hidden="true">#</a> 两台服务器均可插件测试</h3><figure><img src="`+c+'" alt="image-20211117231143675" tabindex="0" loading="lazy"><figcaption>image-20211117231143675</figcaption></figure><figure><img src="'+p+'" alt="image-20211117231243044" tabindex="0" loading="lazy"><figcaption>image-20211117231243044</figcaption></figure><figure><img src="'+u+'" alt="image-20211117231251486" tabindex="0" loading="lazy"><figcaption>image-20211117231251486</figcaption></figure><figure><img src="'+r+`" alt="image-20211117231308169" tabindex="0" loading="lazy"><figcaption>image-20211117231308169</figcaption></figure><h2 id="logstash" tabindex="-1"><a class="header-anchor" href="#logstash" aria-hidden="true">#</a> Logstash</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Apache
安装httpd并开启服务
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+v+'" alt="image-20211118000511866" tabindex="0" loading="lazy"><figcaption>image-20211118000511866</figcaption></figure><figure><img src="'+m+'" alt="image-20211118000504423" tabindex="0" loading="lazy"><figcaption>image-20211118000504423</figcaption></figure><figure><img src="'+b+'" alt="image-20211118000526400" tabindex="0" loading="lazy"><figcaption>image-20211118000526400</figcaption></figure><figure><img src="'+k+`" alt="image-20211118000641707" tabindex="0" loading="lazy"><figcaption>image-20211118000641707</figcaption></figure><h1 id="elasticsearch-redis" tabindex="-1"><a class="header-anchor" href="#elasticsearch-redis" aria-hidden="true">#</a> Elasticsearch + Redis</h1><p>首先从redis这台服务器下手吧</p><pre><code>yum install -y redis
...
</code></pre><p>接下来在kibana上显示：</p><p>浏览器&quot; http://192.168.1.10:5601/&quot;</p><h1 id="面试题" tabindex="-1"><a class="header-anchor" href="#面试题" aria-hidden="true">#</a> 面试题：</h1><p>ELK插件</p><p>https://blog.csdn.net/sinat_35930259/article/details/81052139</p>`,78),f=[h];function q(y,x){return s(),a("div",null,f)}const E=n(g,[["render",q],["__file","ELK.html.vue"]]);export{E as default};
