import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as e}from"./app-FRYDlucV.js";const t={},l=e(`<h1 id="jumperserver-docker容器部署" tabindex="-1"><a class="header-anchor" href="#jumperserver-docker容器部署"><span>JumperServer Docker容器部署</span></a></h1><h2 id="环境展示和配置如下" tabindex="-1"><a class="header-anchor" href="#环境展示和配置如下"><span>环境展示和配置如下</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/redhat-release</span>
