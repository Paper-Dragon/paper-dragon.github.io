import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c,a as n,e as s,d as e,f as i}from"./app-11b06613.js";const o="/assets/image-20211108175559426-16363653618291-ad8ef8be.png",r="/assets/image-20211108175735388-937b86d8.png",d={},u=i(`<h1 id="nginx初级篇" tabindex="-1"><a class="header-anchor" href="#nginx初级篇" aria-hidden="true">#</a> Nginx初级篇</h1><h1 id="_1、nginx-的优势" tabindex="-1"><a class="header-anchor" href="#_1、nginx-的优势" aria-hidden="true">#</a> 1、Nginx 的优势</h1><p>Nginx (engine x) 是一个高性能的HTTP(解决C10k的问题)和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。反代图示</p><p>nginx的web优势</p><h2 id="_1、io多路复用" tabindex="-1"><a class="header-anchor" href="#_1、io多路复用" aria-hidden="true">#</a> 1、io多路复用</h2><p>理论方法</p><h3 id="第一种方法" tabindex="-1"><a class="header-anchor" href="#第一种方法" aria-hidden="true">#</a> 第一种方法：</h3><p>最传统的多进程并发模型 (每进来一个新的I/O流会分配一个新的进程管理）。</p><h3 id="第二种方法" tabindex="-1"><a class="header-anchor" href="#第二种方法" aria-hidden="true">#</a> 第二种方法：</h3><p>I/O多路复用 (单个线程，通过记录跟踪每个I/O流(sock)的状态，来同时管理多个I/O流 。)发明它的原因，是尽量多的提高服务器的吞吐能力。在同一个线程里面， 通过拨开关的方式，来同时传输多个I/O流</p><p>技术类型</p><h4 id="select" tabindex="-1"><a class="header-anchor" href="#select" aria-hidden="true">#</a> select</h4><pre><code>select是第一个实现 (1983 左右在BSD里面实现的)。 
...
</code></pre><h3 id="_2-urn" tabindex="-1"><a class="header-anchor" href="#_2-urn" aria-hidden="true">#</a> ② URN</h3><p>用于区分<br> URN仅用于命名，而不指定地址。用于标识唯一书目的ISBN系统是一个典型的URN使用范例。例如，ISBN 0486275574(urn:isbn:0-486-27557-4)无二义性地标识出莎士比亚的戏剧《罗密欧与朱丽叶》的某一特定版本。<br> URN 是另一种形式的 URI，它通过特定命名空间中的唯一名称来标识资源。<br> urn:isbn:9780141036144<br> urn:ietf:rfc:7230<br> 上面两个 URN 标识了下面的资源：<br> • 乔治·奥威尔所著的《1984》<br> • IETF规范7230，超文本传输协议 (HTTP/1.1)：Message Syntax and Routing.</p><h3 id="_3-三者关系图" tabindex="-1"><a class="header-anchor" href="#_3-三者关系图" aria-hidden="true">#</a> ③ 三者关系图</h3><p>​</p><h3 id="_4-统一资源标识符的语法-url" tabindex="-1"><a class="header-anchor" href="#_4-统一资源标识符的语法-url" aria-hidden="true">#</a> ④ 统一资源标识符的语法（URL）</h3><p>URL分为6个部分，分别是协议、主机、端口、路径、查询、片段。</p><p>协议</p><pre><code> &quot;http://&quot; 告诉浏览器使用何种协议。对于大部分 Web 资源，通常使用 HTTP 协议或其安全版本，HTTPS 协议。另外，浏览器也知道如何处理其他协议。例如， “mailto:” 协议指示浏览器打开邮件客户端；“ftp:”协议指示浏览器处理文件传输。
...
</code></pre><p>② Web服务端<br> 在上述通信过程的另一端，就是一个Web Server来服务并提供客户端请求的文档。Server只是虚拟意义上：它可以是许多共同分担负载（负载平衡）的一组服务器组成的计算机群，也可以是一种复杂的软件，通过向其他计算机发起请求来获取部分或全部资源的软件。</p><p>③ Proxies<br> 在浏览器和服务器之间，有许多计算机和其他设备转发了HTTP的消息。因为Web栈层次结构的原因，它们大多数都出现在传输层、网络层和物理层上，对于HTTP的应用层来说就是透明的（虽然它们可能会对应用层的性能有重要影响）。而还有一部分表现在应用层上的，就叫做proxies了。Proxies既可以表现得透明，又可以不透明（看请求是否通过它们），主要表现在这几个功能上。</p><p>报文</p><p>请求：</p><p>eg：</p>`,65),v=n("br",null,null,-1),m=n("br",null,null,-1),b=n("br",null,null,-1),k={href:"http://developer.mozilla.org",target:"_blank",rel:"noopener noreferrer"},h=n("br",null,null,-1),g=n("br",null,null,-1),f=i("<p>回应：</p><p>eg：</p><p>元素： • HTTP的版本号。<br> • 一个状态码（status code），来告知对应的请求发送成功或失败，以及失败的原因。<br> • 一个状态信息，这个信息是非权威的状态码描述信息，也就是说可以由服务端自行设定的。<br> • HTTP headers，与请求的很像。<br> • 可选的，但是比在请求报文中更加常见地包含获取资源的body。</p><p>三、HTTP headers</p><p>实验分析http报头信息</p><p>1、下载一个源码包</p>",6),x={href:"http://nginx.org/download/nginx-1.12.1.tar.gz",target:"_blank",rel:"noopener noreferrer"},_=n("p",null,"2、分析debug信息",-1),w=n("pre",null,[n("code",null,`DEBUG output created by Wget 1.14 on linux-gnu.
---request begin---                                            请求开始
...
`)],-1),$=n("p",null,"3、相关资料",-1),q=n("pre",null,[n("code",null,`HTTP/1.1          HTTP协议版本1.1；
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_7、nginx日志log" tabindex="-1"><a class="header-anchor" href="#_7、nginx日志log" aria-hidden="true">#</a> 7、Nginx日志Log</h1><h2 id="日志设置" tabindex="-1"><a class="header-anchor" href="#日志设置" aria-hidden="true">#</a> 日志设置</h2><h3 id="日志模块" tabindex="-1"><a class="header-anchor" href="#日志模块" aria-hidden="true">#</a> 日志模块</h3><h4 id="官方文档" tabindex="-1"><a class="header-anchor" href="#官方文档" aria-hidden="true">#</a> 官方文档</h4>`,30),z={href:"http://nginx.org/us/docs/http/ngx_http_log_module",target:"_blank",rel:"noopener noreferrer"},I=i(`<h4 id="日志模块名称" tabindex="-1"><a class="header-anchor" href="#日志模块名称" aria-hidden="true">#</a> 日志模块名称</h4><p>ngx_http_log_module</p><h3 id="相关指令" tabindex="-1"><a class="header-anchor" href="#相关指令" aria-hidden="true">#</a> 相关指令</h3><h4 id="log-format" tabindex="-1"><a class="header-anchor" href="#log-format" aria-hidden="true">#</a> log_format</h4><p>日志格式</p><p>nginx有非常灵活的日志记录模式，每个级别的配置跨行业有地里的访问日志，</p><p>语法</p><p>Syntax： log_format name [escape=default|json] string # name是名称 string是定义</p><h3 id="日志的格式和命令" tabindex="-1"><a class="header-anchor" href="#日志的格式和命令" aria-hidden="true">#</a> 日志的格式和命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>格式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="日志轮转、切割" tabindex="-1"><a class="header-anchor" href="#日志轮转、切割" aria-hidden="true">#</a> 日志轮转、切割</h2><p>[root@nginx-server ~]# rpm -ql nginx | grep log<br> /etc/logrotate.d/nginx<br> /var/log/nginx</p><p>default:vim /etc/logrotate.d/nginx</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>/var/log/nginx/*.log <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li></li><li><p>请注意隐藏文件并不会被随机选取</p></li><li><p><strong>隐藏文件不会被读取</strong></p></li></ul><h2 id="替换模块" tabindex="-1"><a class="header-anchor" href="#替换模块" aria-hidden="true">#</a> 替换模块</h2><p>sub_module</p><p>网站可能由模板生成,实现纠错，文字校验</p><p>sub_filter 云透视 &#39;somestring&#39;;<br> #sub_filter_once on; #只换一次</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/net_map.conf </span>
server<span class="token punctuation">{</span>
  open_log_file_cache <span class="token assign-left variable">max</span><span class="token operator">=</span><span class="token number">1000</span> <span class="token assign-left variable">inactive</span><span class="token operator">=</span>20s <span class="token assign-left variable">min_uses</span><span class="token operator">=</span><span class="token number">3</span> <span class="token assign-left variable">valid</span><span class="token operator">=</span>1m<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>白名单</p>`,140),N={href:"http://b.com",target:"_blank",rel:"noopener noreferrer"},H=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
  root /a.com<span class="token punctuation">;</span>
  index index.html<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,40);function R(L,U){const a=t("ExternalLinkIcon");return p(),c("div",null,[u,n("p",null,[s("元素： • 一个HTTP的method，经常是由一个动词像GET, POST 或者一个名词像OPTIONS，HEAD来定义客户端的动"),v,s(" 作行为的。通常客户端的操作都是获取资源（用GET方法）或者发送一个HTML form表单的值（用POST方法），"),m,s(" 虽然在一些情况下也会有其他的操作。"),b,s(" • 要获取的资源的路径，通常是上下文中就很明显的元素资源的URL，它没有protocol （http://），domain（"),n("a",k,[s("developer.mozilla.org"),e(a)]),s("），或是TCP的port（HTTP是80端口）。"),h,s(" • HTTP协议的版本号。"),g,s(" • 为服务端表达其他信息的可选择性的headers。")]),f,n("p",null,[s("wget -d "),n("a",x,[s("http://nginx.org/download/nginx-1.12.1.tar.gz"),e(a)])]),_,w,$,q,y,T,n("p",null,[n("a",P,[s("https://nginx.org"),e(a)])]),S,n("p",null,[n("a",z,[s("nginx.org/us/docs/http/ngx_http_log_module"),e(a)])]),I,n("p",null,[s("写法： server_name 192.168.100.* ~tianyun ~.google. ~.baidu. "),n("a",N,[s("b.com"),e(a)]),s(";")]),H])}const C=l(d,[["render",R],["__file","nginx01.html.vue"]]);export{C as default};
