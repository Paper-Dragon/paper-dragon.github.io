import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,d as e}from"./app-Dxn2XM5Q.js";const o={},l=e(`<h1 id="grep中级" tabindex="-1"><a class="header-anchor" href="#grep中级"><span>Grep中级</span></a></h1><h2 id="开始结束符号" tabindex="-1"><a class="header-anchor" href="#开始结束符号"><span>开始结束符号</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@oldboyedu59 ~<span class="token punctuation">]</span><span class="token comment"># #在 /etc/services 文件中过滤出包含3306的行</span>
