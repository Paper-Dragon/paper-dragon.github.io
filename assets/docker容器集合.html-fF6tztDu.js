...
wg show
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>`,2),k=i(`<h3 id="frp-docker" tabindex="-1"><a class="header-anchor" href="#frp-docker" aria-hidden="true">#</a> frp docker</h3><h4 id="服务端" tabindex="-1"><a class="header-anchor" href="#服务端" aria-hidden="true">#</a> 服务端</h4><p>frp-restart.sh</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">NAME</span><span class="token operator">=</span>frps
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker-ssh-探针" tabindex="-1"><a class="header-anchor" href="#docker-ssh-探针" aria-hidden="true">#</a> docker ssh 探针</h3>`,12),h={href:"https://man.openbsd.org/sshd_config#Match",target:"_blank",rel:"noopener noreferrer"},g={href:"https://docs.linuxserver.io/images/docker-openssh-server",target:"_blank",rel:"noopener noreferrer"},f={href:"https://www.ssh.com/academy/ssh/authorized-keys-openssh",target:"_blank",rel:"noopener noreferrer"},_={href:"https://blog.zzsqwq.cn/posts/docker-gitlab-ssh/",target:"_blank",rel:"noopener noreferrer"},y=i(`<div class="language-\\ line-numbers-mode" data-ext="\\"><pre class="language-\\"><code>---
version: &quot;2.1&quot;
services:
  openssh-server:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="poste-io" tabindex="-1"><a class="header-anchor" href="#poste-io" aria-hidden="true">#</a> poste.io</h3><p>一键构建邮件服务器</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token punctuation">\\</span>
