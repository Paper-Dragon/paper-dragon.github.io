import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as t}from"./app-iXloerPV.js";const e="/assets/009_士兵突击-VhHHFMqY.png",o={},p=t('<h1 id="面向对象封装案例-ii" tabindex="-1"><a class="header-anchor" href="#面向对象封装案例-ii"><span>面向对象封装案例 II</span></a></h1><h2 id="目标" tabindex="-1"><a class="header-anchor" href="#目标"><span>目标</span></a></h2><ul><li>士兵突击案例</li><li>身份运算符</li></ul><p><strong>封装</strong></p><ol><li><strong>封装</strong> 是面向对象编程的一大特点</li><li>面向对象编程的 <strong>第一步</strong> —— 将 <strong>属性</strong> 和 <strong>方法</strong> <strong>封装</strong> 到一个抽象的 <strong>类</strong> 中</li><li><strong>外界</strong> 使用 <strong>类</strong> 创建 <strong>对象</strong>，然后 <strong>让对象调用方法</strong></li><li><strong>对象方法的细节</strong> 都被 <strong>封装</strong> 在 <strong>类的内部</strong></li></ol><blockquote><p>一个对象的 <strong>属性</strong> 可以是 <strong>另外一个类创建的对象</strong></p></blockquote><h2 id="_01-士兵突击" tabindex="-1"><a class="header-anchor" href="#_01-士兵突击"><span>01. 士兵突击</span></a></h2><p><strong>需求</strong></p><ol><li><strong>士兵</strong> <strong>许三多</strong> 有一把 <strong>AK47</strong></li><li><strong>士兵</strong> 可以 <strong>开火</strong></li><li><strong>枪</strong> 能够 <strong>发射</strong> 子弹</li><li><strong>枪</strong> 装填 <strong>装填子弹</strong> —— <strong>增加子弹数量</strong></li></ol><figure><img src="'+e+`" alt="009_士兵突击" tabindex="0" loading="lazy"><figcaption>009_士兵突击</figcaption></figure><h3 id="_1-1-开发枪类" tabindex="-1"><a class="header-anchor" href="#_1-1-开发枪类"><span>1.1 开发枪类</span></a></h3><p><strong><code>shoot</code> 方法需求</strong></p><ul><li>1&gt; 判断是否有子弹，没有子弹无法射击</li><li>2&gt; 使用 <code>print</code> 提示射击，并且输出子弹数量</li></ul><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">Gun</span><span class="token punctuation">:</span>
