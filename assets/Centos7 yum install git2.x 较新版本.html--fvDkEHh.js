import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as t,c as n,e as o}from"./app-7YCC2lWP.js";const i={},s=o(`<h1 id="centos7-yum-install-git2-x-较新版本" tabindex="-1"><a class="header-anchor" href="#centos7-yum-install-git2-x-较新版本" aria-hidden="true">#</a> Centos7 yum install git2.x(较新版本)</h1><p>centos7 默认的git版本是1.8.x</p><pre><code># git --version
git version 1.8.3.1
