import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c as l,b as s,d as n,a as i,e as a}from"./app-EFu5zsXS.js";const c={},r=a(`<h1 id="nginx配置示例" tabindex="-1"><a class="header-anchor" href="#nginx配置示例" aria-hidden="true">#</a> Nginx配置示例</h1><h2 id="book-itrusts-top-conf" tabindex="-1"><a class="header-anchor" href="#book-itrusts-top-conf" aria-hidden="true">#</a> book.itrusts.top.conf</h2><pre><code>server {
    listen 80;
