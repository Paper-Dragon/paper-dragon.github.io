import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as s,a as i,e as d,f as a}from"./app-eaf7338a.js";const l={},t=i("h2",{id:"简介",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),d(" 简介")],-1),r=i("ul",null,[i("li",null,"awk 擅长对列进行操作/进行数据信息操作"),i("li",null,"awk 的基本使用（高级使用在shell)"),i("li",null,"awk把文本文档看作是数据库，每一行看作一条数据库中的记录，可以指定数据列的分隔符，默认的分隔符是”\\t”,即Tab。"),i("li",null,"awk工作流程是这样的：读入有’\\n’换行符分割的一条记录，然后将记录按指定的域分隔符划分域，填充域，$0则表示所有域, 1 表 示"),i("li",null,"第 一 个 域 , 1表示第一个域, 1表示第一个域,n表示第n个域。默认域分隔符是”空白键” 或 “[tab]键”"),i("li",{filenames:""},"awk的执行模式是： awk '{pattern + action}'")],-1),v=a(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sed</span> <span class="token punctuation">[</span>参数<span class="token punctuation">]</span> ‘条件-处理方式 文件
...
# 删除所有空白：（空格、TAB等）【注：三条语句等效】：
    ...
    [oracle@localhost 201402261951.script]$ echo &#39;a bc  d&#39; | awk &#39;gsub(/[[:blank:]]/, &quot;&quot;,$0)&#39;
abcd
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,101),u=[t,r,v];function c(m,b){return e(),s("div",null,u)}const w=n(l,[["render",c],["__file","AWK案例入门看这一篇就够了.html.vue"]]);export{w as default};
