import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as o,d as n}from"./app-BGSicZb9.js";const i={},r=n(`<h1 id="centos7的yum安装较新版本git2-x" tabindex="-1"><a class="header-anchor" href="#centos7的yum安装较新版本git2-x"><span>Centos7的yum安装较新版本git2.x</span></a></h1><p>centos7 默认的git版本是1.8.x</p><pre><code># git --version
git version 1.8.3.1
