import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as d,o as a,c as l,b as e,e as n,a as t,d as r}from"./app-FRYDlucV.js";const c="/assets/1034759-20191123171511586-952619728-16918406481011-LgLt3Q7k.png",v="/assets/1034759-20191123171846178-306539553-16918406503293-sMN3eyAF.png",m="/assets/1034759-20191123172154297-518829231-16918406525315-fk2I0TUL.png",o="/assets/1034759-20191123173004191-1776516653-16918406560269-2EYRfO4N.png",u="/assets/1034759-20191123173122519-900176878-16918406543237-cFJctwvW.png",b="/assets/1034759-20191123174517612-971806757-169184065782711-cXLvYKnX.png",p={},g=r(`<p>服务发现，说白了就是服务(应用)之间相互定位的过程。</p><p>服务发现需要解决的问题：</p><p>1、服务动态性强--容器在k8s中ip变化或迁移</p><p>2、更新发布频繁--版本迭代快</p><p>3、支持自动伸缩--大促或流量高峰</p><p>我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题，</p><p>那么，如何解决service资源名称和service资源暴露出来的集群网络IP做自动的对应呢，从而达到服务的自动发现呢？</p><p>在k8s中，coredns就是为了解决以上问题。</p><p>从coredns开始，我们采用向k8s中交付容器的方式，来部署服务，并且使用声明式的方式，来部署服务。</p><p>首先在hdss7-200上创建一个nginx虚拟主机，用来获取资源配置清单：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>vi /etc/nginx/conf.d/k8s-yaml.od.com.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+o+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>可以看到我们没有手动添加任何解析记录，我们nginx-dp的service资源的IP，已经被解析了：</p><figure><img src="'+u+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>那么为什么呢？</p>',53),x={href:"http://ccnuo.com/2019/08/25/CoreDNS%EF%BC%9AKubernetes%E5%86%85%E9%83%A8%E5%9F%9F%E5%90%8D%E8%A7%A3%E6%9E%90%E5%8E%9F%E7%90%86%E3%80%81%E5%BC%8A%E7%AB%AF%E5%8F%8A%E4%BC%98%E5%8C%96%E6%96%B9%E5%BC%8F/",target:"_blank",rel:"noopener noreferrer"},k=e("p",null,"大家可以看到，当我进入到pod内部以后，我们会发现我们的dns地址是我们的coredns地址，以及搜索域：",-1),h=e("figure",null,[e("img",{src:b,alt:"img",tabindex:"0",loading:"lazy"}),e("figcaption",null,"img")],-1),y=e("p",null,"现在，我们已经解决了在集群内部解析的问题，但是我们怎么做到在集群外部访问我们的服务呢？",-1),f=e("p",null,"接下来我们来学习k8s服务暴露。",-1);function _(E,C){const i=d("ExternalLinkIcon");return a(),l("div",null,[g,e("p",null,[n("推荐大家了解一下coredns都做了什么："),e("a",x,[n("Kubernetes内部域名解析原理、弊端及优化方式"),t(i)])]),k,h,y,f])}const P=s(p,[["render",_],["__file","kubernetes进阶（三）服务发现-coredns.html.vue"]]),D=JSON.parse('{"path":"/note-book/Kubernetes/kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%B8%89%EF%BC%89%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0-coredns.html","title":"","lang":"zh-CN","frontmatter":{"description":"服务发现，说白了就是服务(应用)之间相互定位的过程。 服务发现需要解决的问题： 1、服务动态性强--容器在k8s中ip变化或迁移 2、更新发布频繁--版本迭代快 3、支持自动伸缩--大促或流量高峰 我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题， 那么，如何解决ser...","head":[["meta",{"property":"og:url","content":"https://www.geekery.cn/note-book/Kubernetes/kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%B8%89%EF%BC%89%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0-coredns.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:description","content":"服务发现，说白了就是服务(应用)之间相互定位的过程。 服务发现需要解决的问题： 1、服务动态性强--容器在k8s中ip变化或迁移 2、更新发布频繁--版本迭代快 3、支持自动伸缩--大促或流量高峰 我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题， 那么，如何解决ser..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-08-13T15:08:38.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2023-08-13T15:08:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-08-13T15:08:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[],"git":{"createdTime":1691939318000,"updatedTime":1691939318000,"contributors":[{"name":"PaperDragon","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":3.75,"words":1125},"filePathRelative":"note-book/Kubernetes/kubernetes进阶（三）服务发现-coredns.md","localizedDate":"2023年8月13日","excerpt":"<p>服务发现，说白了就是服务(应用)之间相互定位的过程。</p>\\n<p>服务发现需要解决的问题：</p>\\n<p>1、服务动态性强--容器在k8s中ip变化或迁移</p>\\n<p>2、更新发布频繁--版本迭代快</p>\\n<p>3、支持自动伸缩--大促或流量高峰</p>\\n<p>我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题，</p>\\n<p>那么，如何解决service资源名称和service资源暴露出来的集群网络IP做自动的对应呢，从而达到服务的自动发现呢？</p>\\n<p>在k8s中，coredns就是为了解决以上问题。</p>","autoDesc":true}');export{P as comp,D as data};
