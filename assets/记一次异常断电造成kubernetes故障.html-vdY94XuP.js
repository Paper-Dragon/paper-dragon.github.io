import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as s,d as a}from"./app-Dnopv_tp.js";const i="/assets/image-20230818150814096-DaQfOChT.png",t="/assets/image-20230818154811917-CuQCJSbP.png",l="/assets/image-20230818154840385-IDaERR0f.png",r="/assets/image-20230818154847190-CAdvrhFJ.png",c="/assets/image-20230818154854781-Cyqyq0UI.png",d={},p=a('<h1 id="记一次异常断电造成kubernetes故障" tabindex="-1"><a class="header-anchor" href="#记一次异常断电造成kubernetes故障"><span>记一次异常断电造成kubernetes故障</span></a></h1><h2 id="断电造成kubernetes故障" tabindex="-1"><a class="header-anchor" href="#断电造成kubernetes故障"><span>断电造成kubernetes故障</span></a></h2><blockquote><p>http://31mwww.linuxea.com/2580.html https://blog.csdn.net/liuyij3430448/article/details/130406844 因为宿主机系统 esxi 的内存条老化，导致esxi异常关机。内部虚拟机全部断电。总共30几台吧。</p><p>经过检查和擦拭内存金手指，服务器正常开机。</p><p>老家伙你不能倒下啊。你不run了我就得run啊。。。</p></blockquote><p>服务器显示状态</p><figure><img src="'+i+`" alt="image-20230818150814096" tabindex="0" loading="lazy"><figcaption>image-20230818150814096</figcaption></figure><h2 id="处理存储空间问题" tabindex="-1"><a class="header-anchor" href="#处理存储空间问题"><span>处理存储空间问题</span></a></h2><p>所幸，os 层面并没有损坏。系统正常的开机。硬盘已经满了。不知道这个设备之前是怎么在磁盘根目录100%的情况下还能正常运行的。</p><h3 id="发现异常" tabindex="-1"><a class="header-anchor" href="#发现异常"><span>发现异常</span></a></h3><ul><li>vim在保存任何文件的时候都会显示vim.viminfo报错。</li><li>运行速度非常缓慢</li></ul><p>经过检查是根目录存储空间不足。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token builtin class-name">cd</span> /var/log
