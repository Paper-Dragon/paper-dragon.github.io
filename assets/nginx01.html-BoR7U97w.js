import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,d as e}from"./app-CAtSu0sD.js";const i="/assets/image-20211108175559426-16363653618291-9H0kzjuJ.png",l="/assets/image-20211108175735388-hHkrgZ3r.png",t={},p=e(`<h1 id="nginx初级篇" tabindex="-1"><a class="header-anchor" href="#nginx初级篇"><span>Nginx初级篇</span></a></h1><h1 id="_1、nginx-的优势" tabindex="-1"><a class="header-anchor" href="#_1、nginx-的优势"><span>1、Nginx 的优势</span></a></h1><p>Nginx (engine x) 是一个高性能的HTTP(解决C10k的问题)和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。反代图示</p><p>nginx的web优势</p><h2 id="_1、io多路复用" tabindex="-1"><a class="header-anchor" href="#_1、io多路复用"><span>1、io多路复用</span></a></h2><p>理论方法</p><h3 id="第一种方法" tabindex="-1"><a class="header-anchor" href="#第一种方法"><span>第一种方法：</span></a></h3><p>最传统的多进程并发模型 (每进来一个新的I/O流会分配一个新的进程管理）。</p><h3 id="第二种方法" tabindex="-1"><a class="header-anchor" href="#第二种方法"><span>第二种方法：</span></a></h3><p>I/O多路复用 (单个线程，通过记录跟踪每个I/O流(sock)的状态，来同时管理多个I/O流 。)发明它的原因，是尽量多的提高服务器的吞吐能力。在同一个线程里面， 通过拨开关的方式，来同时传输多个I/O流</p><p>技术类型</p><h4 id="select" tabindex="-1"><a class="header-anchor" href="#select"><span>select</span></a></h4><pre><code>select是第一个实现 (1983 左右在BSD里面实现的)。 
...
</code></pre><h4 id="poll" tabindex="-1"><a class="header-anchor" href="#poll"><span>poll</span></a></h4><pre><code>于是14年以后(1997年）一帮人又实现了poll, poll 修复了select的很多问题，比如
...
</code></pre><h4 id="epoll" tabindex="-1"><a class="header-anchor" href="#epoll"><span>epoll</span></a></h4><pre><code>于是5年以后, 在2002, 大神 Davide Libenzi 实现了epoll. 
...
</code></pre><h2 id="_2、时分多路复用" tabindex="-1"><a class="header-anchor" href="#_2、时分多路复用"><span>2、时分多路复用</span></a></h2><p>CPU时钟/中断设计</p><h2 id="_3、频分多路复用" tabindex="-1"><a class="header-anchor" href="#_3、频分多路复用"><span>3、频分多路复用</span></a></h2><p>ADSL</p><h1 id="_2、http协议详解" tabindex="-1"><a class="header-anchor" href="#_2、http协议详解"><span>2、HTTP协议详解</span></a></h1><h2 id="_1、http协议概述" tabindex="-1"><a class="header-anchor" href="#_1、http协议概述"><span>1、http协议概述</span></a></h2><p>HTTP--Hyper Text Transfer Protocol，超文本传输协议，是一种建立在TCP上的无状态连接，整个基本的工作流程是客户端发送一个HTTP请求，说明客户端想要访问的资源和请求的动作，服务端收到请求之后，服务端开始处理请求，并根据请求做出相应的动作访问服务器资源，最后通过发送HTTP响应把结果返回给客户端。其中一个请求的开始到一个响应的结束称为事务，当一个事物结束后还会在服务端添加一条日志条目。</p><h2 id="_2、uri" tabindex="-1"><a class="header-anchor" href="#_2、uri"><span>2、URI</span></a></h2><p>统一资源标识符(Uniform Resource Identifier,或URI) HTTP 请求的内容通称为&quot;资源&quot;。”资源“这一概念非常宽泛，它可以是你能够想到的格式。每个资源都由一个 (URI) 来进行标识。URL即统一资源定位符，它是 URI 的一种。一份文档，一张图片，或所有其他。URI包含URL,URN</p><h3 id="_1-url" tabindex="-1"><a class="header-anchor" href="#_1-url"><span>① URL</span></a></h3><p>URL 用于定位 全称叫做:统一资源定位符(URL,英语Uniform Resource Locator的缩写)也被称为网页地址</p><p>示例</p><pre><code>https://developer.mozilla.org
...
</code></pre><h3 id="_2-urn" tabindex="-1"><a class="header-anchor" href="#_2-urn"><span>② URN</span></a></h3><p>用于区分 URN仅用于命名，而不指定地址。用于标识唯一书目的ISBN系统是一个典型的URN使用范例。例如，ISBN 0486275574(urn:isbn:0-486-27557-4)无二义性地标识出莎士比亚的戏剧《罗密欧与朱丽叶》的某一特定版本。 URN 是另一种形式的 URI，它通过特定命名空间中的唯一名称来标识资源。 urn:isbn:9780141036144 urn:ietf:rfc:7230 上面两个 URN 标识了下面的资源： • 乔治·奥威尔所著的《1984》 • IETF规范7230，超文本传输协议 (HTTP/1.1)：Message Syntax and Routing.</p><h3 id="_3-三者关系图" tabindex="-1"><a class="header-anchor" href="#_3-三者关系图"><span>③ 三者关系图</span></a></h3><p>​</p><h3 id="_4-统一资源标识符的语法-url" tabindex="-1"><a class="header-anchor" href="#_4-统一资源标识符的语法-url"><span>④ 统一资源标识符的语法（URL）</span></a></h3><p>URL分为6个部分，分别是协议、主机、端口、路径、查询、片段。</p><p>协议</p><pre><code> &quot;http://&quot; 告诉浏览器使用何种协议。对于大部分 Web 资源，通常使用 HTTP 协议或其安全版本，HTTPS 协议。另外，浏览器也知道如何处理其他协议。例如， “mailto:” 协议指示浏览器打开邮件客户端；“ftp:”协议指示浏览器处理文件传输。
...
</code></pre><h2 id="_3、http协议概述" tabindex="-1"><a class="header-anchor" href="#_3、http协议概述"><span>3、HTTP协议概述</span></a></h2><p>图示</p><pre><code>  HTTP是一种能够获取如 HTML 这样的网络资源的通讯协议。它是 Web 上数据交换的基础，是一种 client-server 协议，也就是说请求通常是由像浏览器这样的接受方发起的。一个完整的web文档是由不同的子文档重新组建而成的，像是文本、布局描述、图片、视频、脚本等等。
...
</code></pre><h1 id="_3、nginx-部署-yum" tabindex="-1"><a class="header-anchor" href="#_3、nginx-部署-yum"><span>3、Nginx 部署 Yum</span></a></h1><h2 id="官网链接" tabindex="-1"><a class="header-anchor" href="#官网链接"><span>官网链接</span></a></h2><p>https://nginx.org</p><h3 id="nginx-版本类型" tabindex="-1"><a class="header-anchor" href="#nginx-版本类型"><span>nginx 版本类型</span></a></h3><ul><li><p>Mainline Version：主线版，即开发版</p></li><li><p>♥Stable Version：最新稳定版，生产环境使用</p></li><li><p>Legacy version：遗留老版本的稳定版</p></li></ul><p>配置yum源</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>nginx.org -<span class="token operator">&gt;</span> documents -<span class="token operator">&gt;</span> <span class="token function">install</span> -<span class="token operator">&gt;</span> linux -<span class="token operator">&gt;</span> RHEL
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4、nginx-配置文件" tabindex="-1"><a class="header-anchor" href="#_4、nginx-配置文件"><span>4、Nginx 配置文件</span></a></h1><h2 id="全部文件" tabindex="-1"><a class="header-anchor" href="#全部文件"><span>全部文件</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># rpm -ql nginx</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_5、nginx编译参数" tabindex="-1"><a class="header-anchor" href="#_5、nginx编译参数"><span>5、Nginx编译参数</span></a></h1><p>yum参数</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># nginx -V</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_6、nginx基本配置" tabindex="-1"><a class="header-anchor" href="#_6、nginx基本配置"><span>6、Nginx基本配置</span></a></h1><h2 id="观察主配置" tabindex="-1"><a class="header-anchor" href="#观察主配置"><span>观察主配置</span></a></h2><h3 id="_1、全局、核心块" tabindex="-1"><a class="header-anchor" href="#_1、全局、核心块"><span>1、全局、核心块</span></a></h3><p>配置影响nginx全局的指令，一般有运行nginx服务器的用户组，nginx进程pid存放路径日志存放路径，配置文件引入，允许生成worker process数等</p><h3 id="_2、events块" tabindex="-1"><a class="header-anchor" href="#_2、events块"><span>2、events块</span></a></h3><p>配置影响服务器与用户的网络连接，有每天个进程的最大连接数，选取哪种事务驱动模型处理连接请求，是否允许同时接受多个网路连接，开启多个网络连接序列化</p><h3 id="_3、http块" tabindex="-1"><a class="header-anchor" href="#_3、http块"><span>3、http块</span></a></h3><p>可以嵌套多个server，配置代理、缓存，日志定义等大多数动能和第三方模块的配置。如文件引入，mine-type定义，日志自定义，是否使用sendfile传输文件，连接超时时间，单连接请求数等</p><h3 id="_4、server块" tabindex="-1"><a class="header-anchor" href="#_4、server块"><span>4、server块</span></a></h3><p>配置虚拟主机的相关参数，一个http中有多个server</p><h3 id="_5、location块" tabindex="-1"><a class="header-anchor" href="#_5、location块"><span>5、location块</span></a></h3><p>配置请求的路由，以及各种页面的处理情况</p><h2 id="观察默认虚拟主机配置文件" tabindex="-1"><a class="header-anchor" href="#观察默认虚拟主机配置文件"><span>观察默认虚拟主机配置文件</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/default.conf </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="观察一个新的虚拟主机" tabindex="-1"><a class="header-anchor" href="#观察一个新的虚拟主机"><span>观察一个新的虚拟主机</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/net_map.conf </span>
server<span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_7、nginx日志log" tabindex="-1"><a class="header-anchor" href="#_7、nginx日志log"><span>7、Nginx日志Log</span></a></h1><h2 id="日志设置" tabindex="-1"><a class="header-anchor" href="#日志设置"><span>日志设置</span></a></h2><h3 id="日志模块" tabindex="-1"><a class="header-anchor" href="#日志模块"><span>日志模块</span></a></h3><h4 id="官方文档" tabindex="-1"><a class="header-anchor" href="#官方文档"><span>官方文档</span></a></h4><p>nginx.org/us/docs/http/ngx_http_log_module</p><h4 id="日志模块名称" tabindex="-1"><a class="header-anchor" href="#日志模块名称"><span>日志模块名称</span></a></h4><p>ngx_http_log_module</p><h3 id="相关指令" tabindex="-1"><a class="header-anchor" href="#相关指令"><span>相关指令</span></a></h3><h4 id="log-format" tabindex="-1"><a class="header-anchor" href="#log-format"><span>log_format</span></a></h4><p>日志格式</p><p>nginx有非常灵活的日志记录模式，每个级别的配置跨行业有地里的访问日志，</p><p>语法</p><p>Syntax： log_format name [escape=default|json] string # name是名称 string是定义</p><h3 id="日志的格式和命令" tabindex="-1"><a class="header-anchor" href="#日志的格式和命令"><span>日志的格式和命令</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>格式
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="访问日志和错误日志" tabindex="-1"><a class="header-anchor" href="#访问日志和错误日志"><span>访问日志和错误日志</span></a></h3><h4 id="access-log" tabindex="-1"><a class="header-anchor" href="#access-log"><span>access_log</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable">$remote_address</span> 远程地址
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="error-log" tabindex="-1"><a class="header-anchor" href="#error-log"><span>error_log</span></a></h4><p>var/log/nginx/error.log-20211108</p><p>404 Not found</p><p>403 forbidden</p><h3 id="日志缓存" tabindex="-1"><a class="header-anchor" href="#日志缓存"><span>日志缓存</span></a></h3><p>open_log_file_cache</p><p>默认是关闭的。。占用内存，减少磁盘占有量</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>syntac: open_log_file_cache <span class="token assign-left variable">max</span><span class="token operator">=</span><span class="token number">1000</span> <span class="token assign-left variable">inactive</span><span class="token operator">=</span>20s <span class="token assign-left variable">min_uses</span><span class="token operator">=</span><span class="token number">3</span> <span class="token assign-left variable">valid</span><span class="token operator">=</span>1m
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="日志轮转、切割" tabindex="-1"><a class="header-anchor" href="#日志轮转、切割"><span>日志轮转、切割</span></a></h2><p>[root@nginx-server ~]# rpm -ql nginx | grep log /etc/logrotate.d/nginx /var/log/nginx</p><p>default:vim /etc/logrotate.d/nginx</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>/var/log/nginx/*.log <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="日志分析" tabindex="-1"><a class="header-anchor" href="#日志分析"><span>日志分析</span></a></h2><p>常用变量</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token variable">$remote_addr</span>, 远程地址： 记录客户端IP地址
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>\\1. 统计2017年9月5日 PV量（网页页面访问量）</p><p>8点-9点间</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017:08&#39; sz.mobiletrain.org.log |wc -l 
awk &#39;$4&gt;=&quot;[05/Sep/2017:08:00:00&quot; &amp;&amp; $4&lt;=&quot;[05/Sep/2017:09:00:00&quot; {print $0}&#39; sz.mobiletrain.org.log | wc -l
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>\\2. 统计2017年9月5日 一天内访问最多的10个IP（ip top10）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; cd.mobiletrain.org.log | awk &#39;{ ips[$1]++ } END{for(i in ips){print i,ips[i]} } &#39;| sort -k2 -rn | head -n10 （end小写不显示）
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\3. 统计2017年9月5日 访问大于100次的IP</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; cd.mobiletrain.org.log | awk &#39;{ ips[$1]++ } END{for(i in ips){ if(ips[i]&gt;100) {print i,ips[i]}} } &#39;| sort -k2 -rn | head -n10
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\4. 统计2017年9月5日 访问最多的10个页面（$request top 10）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; cd.mobiletrain.org.log |awk &#39;{urls[$7]++} END{for(i in urls){print urls[i],i}}&#39; |sort -k1 -rn |head -n10
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\5. 统计2017年9月5日 每个URL访问内容总大小（$body_bytes_sent）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; sz.mobiletrain.org.log |awk &#39;{ urls[$7]++; size[$7]+=$10}END{for(i in urls){print urls[i],size[i],i}}&#39;|sort -k1 -rn | head -n10
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\6. 统计2017年9月5日 每个IP访问状态码数量（$status）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; cd.mobiletrain.org.log | awk &#39;{ ip_code[$1&quot; &quot;$9]++}END{ for(i in ip_code){print i,ip_code[i]} }&#39; | sort -k1 -rn | head -n10
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\7. 统计2017年9月5日 每个IP访问状态码为404及出现次数（$status）</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; cd.mobiletrain.org.log |awk &#39;$9==&quot;404&quot;{ccc[$1&quot; &quot;$9]++}END{for(i in ccc){print i,ccc[i]}}&#39; | sort -k3 -rn grep &#39;05/Sep/2017&#39; sz.mobiletrain.org.log | awk &#39;{if($9=&quot;404&quot;){ip_code[$1&quot; &quot;$9]++}}END{for(i in ip_code){print i,ip_code[i]}}&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\8. 统计前一分钟的PV量</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>date=$(date -d &#39;-1 minute&#39; +%d/%b/%Y:%H:%M);awk -v date=$date &#39;$0 ~ date {i++} END{print i}&#39; sz.mobiletrain.org.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>shell中的变量在awk程序中无法使用，因为在执行AWK时，是一个新的进程去处理的，因此就需要-v 来向awk程序中传参数了，</p><p>你比如在shell程序中有一个变量a=15，你在awk程序中直接使用变量a是不行的，而你用awk -v b=a， 这样在AWK程序中就可以使用变量b了！也就相当于使用a了！</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># date=$(date -d &#39;-1 minute&#39; +%Y:%H:%M); awk -v date=$date &#39;$0 ~ date{i++}END{print i}&#39; /var/log/nginx/xuleilinux.access.log 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\9. 统计2017年9月5日 8:30－9:00，每个IP，出现404状态码的数量</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>awk &#39;$4&gt;=&quot;[05/Sep/2017:08:30:00&quot; &amp;&amp; $4&lt;=&quot;[05/Sep/2017:09:00:00&quot; {if($9=&quot;404&quot;){ip_code[$1&quot; &quot;$9]++}}END{for(i in ip_code){print i,ip_code[i]}}&#39; sz.mobiletrain.org.log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>\\10. 统计2017年9月5日 各种状态码数量</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; sz.mobiletrain.org.log |awk &#39;{code[$9]++} END{for(i in code){print i,code[i]}}&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>百分比</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>grep &#39;05/Sep/2017&#39; sz.mobiletrain.org.log | awk &#39;{code[$9]++;total++} END{for(i in code){printf i&quot; &quot;;printf code[i]&quot;\\t&quot;;printf &quot;%.2f&quot;,code[i]/total*100;print &quot;%&quot;}}&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">cat</span> <span class="token operator">&lt;&lt;</span> <span class="token string">EOF
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>统计 pv 量</p><p>统计 一天内访问最多的10个ip</p><p>统计访问量超过100次的ip</p><h1 id="_8、nginx-web模块" tabindex="-1"><a class="header-anchor" href="#_8、nginx-web模块"><span>8、Nginx WEB模块</span></a></h1><h2 id="连接状态" tabindex="-1"><a class="header-anchor" href="#连接状态"><span>连接状态</span></a></h2><h3 id="stub-status-module" tabindex="-1"><a class="header-anchor" href="#stub-status-module"><span>stub_status_module</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[root@nginx-server ~]# cat /etc/nginx/conf.d/net_map.conf 
server{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+i+'" alt="image-20211108175559426" tabindex="0" loading="lazy"><figcaption>image-20211108175559426</figcaption></figure><figure><img src="'+l+`" alt="image-20211108175735388" tabindex="0" loading="lazy"><figcaption>image-20211108175735388</figcaption></figure><p>Active connections 当前活动连接数</p><p>发起连接数 成功连接数 请求书</p><p>读 写 写</p><h3 id="什么是连接" tabindex="-1"><a class="header-anchor" href="#什么是连接"><span>什么是连接</span></a></h3><p>TCP机制</p><p>重传计时器 Retransmession</p><p>持久计时器 Persistance</p><p>保活计时器 keep-alive</p><p>时间等待 time-wait</p><h3 id="什么是长连接" tabindex="-1"><a class="header-anchor" href="#什么是长连接"><span>什么是长连接</span></a></h3><p>只握手不不挥手</p><p>[root@nginx-server ~]# vim /etc/nginx/nginx.conf [root@nginx-server ~]#</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code> keepalive_timeout  <span class="token number">65</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="随机主页" tabindex="-1"><a class="header-anchor" href="#随机主页"><span>随机主页</span></a></h2><h3 id="目的" tabindex="-1"><a class="header-anchor" href="#目的"><span>目的</span></a></h3><p>random_index_module</p><p>将主页设置为随机页面，是一种微调机制</p><h3 id="启动随机主页" tabindex="-1"><a class="header-anchor" href="#启动随机主页"><span>启动随机主页</span></a></h3><ul><li>创建主页目录</li></ul><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># pwd</span>
/root
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li><p>创建多个主页</p></li><li><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># echo blue &gt;&gt; app/blue.html </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>启动随机主页</p></li><li><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/net_map.conf </span>
server<span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li></li><li><p>请注意隐藏文件并不会被随机选取</p></li><li><p><strong>隐藏文件不会被读取</strong></p></li></ul><h2 id="替换模块" tabindex="-1"><a class="header-anchor" href="#替换模块"><span>替换模块</span></a></h2><p>sub_module</p><p>网站可能由模板生成,实现纠错，文字校验</p><p>sub_filter 云透视 &#39;somestring&#39;; #sub_filter_once on; #只换一次</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/conf.d/net_map.conf </span>
server<span class="token punctuation">{</span>
  open_log_file_cache <span class="token assign-left variable">max</span><span class="token operator">=</span><span class="token number">1000</span> <span class="token assign-left variable">inactive</span><span class="token operator">=</span>20s <span class="token assign-left variable">min_uses</span><span class="token operator">=</span><span class="token number">3</span> <span class="token assign-left variable">valid</span><span class="token operator">=</span>1m<span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文件读取" tabindex="-1"><a class="header-anchor" href="#文件读取"><span>文件读取</span></a></h2><p>ngx_http_core_module</p><h3 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h3><h4 id="sendfile-on-off" tabindex="-1"><a class="header-anchor" href="#sendfile-on-off"><span>sendfile [on] | off;</span></a></h4><p>文件传输过程</p><p>未使用sendfile【默认】</p><p>硬盘 &gt;&gt; kernel buffer &gt;&gt; user buffer &gt;&gt; kernel socket buffer &gt;&gt; 协议栈</p><p>使用sendfile()</p><p>硬盘 &gt;&gt; kernel buffer 快速拷贝到kernelsocket buffer &gt;&gt; 协议栈</p><h4 id="tcp-nopush" tabindex="-1"><a class="header-anchor" href="#tcp-nopush"><span>tcp_nopush</span></a></h4><p>未使用tcp_nopush，网络资源浪费</p><p>应用操作每产生一次操作就发送一个包，典型情况携带40字的包头，于是产生4000%过载，网络堵塞</p><p>使用tcp_nopush ，网络传输效率提升</p><p>tcp_nopush on | [default off];</p><p>包攒到一定数量再发</p><h4 id="tcp-nodelay" tabindex="-1"><a class="header-anchor" href="#tcp-nodelay"><span>tcp_nodelay</span></a></h4><p>开启或关闭nginx使用tcp_nodelay选项的功能。这个选项仅在连接编程<strong>长连接</strong>时候才能被启用，</p><p>tcp_nodelay 是禁用nagle算法，即数据包立即发送出去</p><p>由于Nagle 和DelayedACK的原因，数据包的确认信息需要积攒到两个时才发送，长连接情况下，奇数包会造成延时40ms，所以tcp_nodelay会将ack立刻发送除去，如果不在长连接时，可以关闭此模块，因为ack会被立刻发送出去</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
<span class="token punctuation">..</span>.
...
<span class="token punctuation">..</span>.
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文件压缩" tabindex="-1"><a class="header-anchor" href="#文件压缩"><span>文件压缩</span></a></h2><p>ngx_http_gzip_module</p><p>gzip on|[default off]</p><p>context:http,server,location, if in location</p><p>gzip_comp_level [level 1-9]</p><p>context http,server,location</p><p>gzip_http_version 1.0|[default 1.1]</p><p>context http,server,location</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@nginx-server ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/nginx/nginx.conf </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="页面缓存" tabindex="-1"><a class="header-anchor" href="#页面缓存"><span>页面缓存</span></a></h2><p>ngx_http_headers_module</p><p>http段或者server段或者location段</p><p>expires [modified] time;</p><p>expires epoch |max十年 | off;</p><p>default expires off;</p><p>context http,server,location,if in location</p><p>1、开启浏览器缓存，浏览页面</p><p>第一次返货状态码200，页面对象全文传输</p><p>第二次返回状态304，页面对象部分传输</p><p>2、金庸缓存，访问</p><p>状态码200</p><p>vim /etc/nginx/conf.d/net_map.conf</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
<span class="token punctuation">..</span>.
  expeires 24h<span class="token punctuation">;</span>
<span class="token punctuation">..</span>.
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>​ 浏览器缓存head中 有一个</p><p>cache-control: 86400 单位秒</p><h2 id="防盗链" tabindex="-1"><a class="header-anchor" href="#防盗链"><span>防盗链</span></a></h2><p>模块： ngx_</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>白名单</p><p>写法： server_name 192.168.100.* ~tianyun ~.google. ~.baidu. b.com;</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
  root /a.com<span class="token punctuation">;</span>
  index index.html<span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>生产环境</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>location ~*<span class="token punctuation">\\</span>.<span class="token punctuation">(</span>jpg<span class="token operator">|</span>png<span class="token operator">|</span>gif<span class="token operator">|</span>bmp<span class="token punctuation">)</span>$ <span class="token punctuation">{</span>
  root /a.com<span class="token punctuation">;</span>
  index index.html<span class="token punctuation">;</span>
  valid_referer none blocked *.b.com server_name <span class="token number">192.168</span>.100.* ~tianyun ~<span class="token punctuation">\\</span>.google<span class="token punctuation">\\</span>. ~<span class="token punctuation">\\</span>.baidu<span class="token punctuation">\\</span>. b.com<span class="token punctuation">;</span>
  if<span class="token punctuation">(</span><span class="token variable">$invalid_referer</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_9、nginx访问限制" tabindex="-1"><a class="header-anchor" href="#_9、nginx访问限制"><span>9、Nginx访问限制</span></a></h1><p>一定程度防泛洪攻击：ngx_http_limit_req_module ngx_http_limit_conn_module</p><p>测试：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>yum install -t httpd-tools
...
<span class="token builtin class-name">echo</span> <span class="token string">&#39;&#39;</span>
<span class="token keyword">fi</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>怎么用</p><p>vim /etc/nginx/nginx.conf</p><h2 id="request限制" tabindex="-1"><a class="header-anchor" href="#request限制"><span>request限制</span></a></h2><p>定义：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>limit_req_zone <span class="token variable">$binary_remote_addr</span> <span class="token assign-left variable">zone</span><span class="token operator">=</span>req_zone:10m <span class="token assign-left variable">rate</span><span class="token operator">=</span>1r/s
限制请求         二进制地址            限制策略的名称  占用10M空间 允许每秒1次请求
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>引用</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>http <span class="token punctuation">{</span>
...
limit_req <span class="token assign-left variable">zone</span><span class="token operator">=</span>req_zone
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="限制tcp连接" tabindex="-1"><a class="header-anchor" href="#限制tcp连接"><span>限制tcp连接</span></a></h2><p>[单个ip，同时只有一个连接]</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>http <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_10、nginx访问控制" tabindex="-1"><a class="header-anchor" href="#_10、nginx访问控制"><span>10、Nginx访问控制</span></a></h1><h2 id="基于主机-ip" tabindex="-1"><a class="header-anchor" href="#基于主机-ip"><span>基于主机（ip）</span></a></h2><p>module : ngx_http_access_module</p><p>Directives：</p><p>Allow：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>allow 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Deny:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>deny
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Syntax：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code> allow address <span class="token operator">|</span> CIDR <span class="token operator">|</span> unix: <span class="token operator">|</span>all<span class="token punctuation">;</span>
 context: http,server,location,limit_except
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>启用控制</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>http <span class="token punctuation">{</span>
  <span class="token punctuation">..</span>.
  allow <span class="token number">192.168</span>.100.10<span class="token punctuation">;</span>
  deny all<span class="token punctuation">;</span>
  <span class="token punctuation">..</span>.
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="基于用户-username-password" tabindex="-1"><a class="header-anchor" href="#基于用户-username-password"><span>基于用户（username&amp;password)</span></a></h2><p>module:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ngx_http_auth_basic_module
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>Syntax 1:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>auth_basic string <span class="token operator">|</span> off<span class="token punctuation">;</span>
context: http,server,location,limit_expcet
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>Syntax 2:</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>auth_basic_user_file <span class="token function">file</span>
context: http,server,location,limit_except
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>启用控制：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> httpd-tools
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>server <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,292),c=[p];function o(r,d){return s(),a("div",null,c)}const m=n(t,[["render",o],["__file","nginx01.html.vue"]]),b=JSON.parse('{"path":"/note-book/Nginx__OpenResty/nginx01.html","title":"Nginx初级篇","lang":"zh-CN","frontmatter":{"description":"Nginx初级篇 1、Nginx 的优势 Nginx (engine x) 是一个高性能的HTTP(解决C10k的问题)和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。反代图示 nginx的web优势 1、io多路复用 理论方法 第一种方法： 最传统的多进程并发模型 (每进来一个新的I/O流会分配一个新的进程管理）。 第二种方法： I/O...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Nginx__OpenResty/nginx01.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"Nginx初级篇"}],["meta",{"property":"og:description","content":"Nginx初级篇 1、Nginx 的优势 Nginx (engine x) 是一个高性能的HTTP(解决C10k的问题)和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。反代图示 nginx的web优势 1、io多路复用 理论方法 第一种方法： 最传统的多进程并发模型 (每进来一个新的I/O流会分配一个新的进程管理）。 第二种方法： I/O..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-23T03:38:57.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-01-23T03:38:57.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Nginx初级篇\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-01-23T03:38:57.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"1、io多路复用","slug":"_1、io多路复用","link":"#_1、io多路复用","children":[{"level":3,"title":"第一种方法：","slug":"第一种方法","link":"#第一种方法","children":[]},{"level":3,"title":"第二种方法：","slug":"第二种方法","link":"#第二种方法","children":[]}]},{"level":2,"title":"2、时分多路复用","slug":"_2、时分多路复用","link":"#_2、时分多路复用","children":[]},{"level":2,"title":"3、频分多路复用","slug":"_3、频分多路复用","link":"#_3、频分多路复用","children":[]},{"level":2,"title":"1、http协议概述","slug":"_1、http协议概述","link":"#_1、http协议概述","children":[]},{"level":2,"title":"2、URI","slug":"_2、uri","link":"#_2、uri","children":[{"level":3,"title":"① URL","slug":"_1-url","link":"#_1-url","children":[]},{"level":3,"title":"② URN","slug":"_2-urn","link":"#_2-urn","children":[]},{"level":3,"title":"③ 三者关系图","slug":"_3-三者关系图","link":"#_3-三者关系图","children":[]},{"level":3,"title":"④ 统一资源标识符的语法（URL）","slug":"_4-统一资源标识符的语法-url","link":"#_4-统一资源标识符的语法-url","children":[]}]},{"level":2,"title":"3、HTTP协议概述","slug":"_3、http协议概述","link":"#_3、http协议概述","children":[]},{"level":2,"title":"官网链接","slug":"官网链接","link":"#官网链接","children":[{"level":3,"title":"nginx 版本类型","slug":"nginx-版本类型","link":"#nginx-版本类型","children":[]}]},{"level":2,"title":"全部文件","slug":"全部文件","link":"#全部文件","children":[]},{"level":2,"title":"观察主配置","slug":"观察主配置","link":"#观察主配置","children":[{"level":3,"title":"1、全局、核心块","slug":"_1、全局、核心块","link":"#_1、全局、核心块","children":[]},{"level":3,"title":"2、events块","slug":"_2、events块","link":"#_2、events块","children":[]},{"level":3,"title":"3、http块","slug":"_3、http块","link":"#_3、http块","children":[]},{"level":3,"title":"4、server块","slug":"_4、server块","link":"#_4、server块","children":[]},{"level":3,"title":"5、location块","slug":"_5、location块","link":"#_5、location块","children":[]}]},{"level":2,"title":"观察默认虚拟主机配置文件","slug":"观察默认虚拟主机配置文件","link":"#观察默认虚拟主机配置文件","children":[]},{"level":2,"title":"观察一个新的虚拟主机","slug":"观察一个新的虚拟主机","link":"#观察一个新的虚拟主机","children":[]},{"level":2,"title":"日志设置","slug":"日志设置","link":"#日志设置","children":[{"level":3,"title":"日志模块","slug":"日志模块","link":"#日志模块","children":[]},{"level":3,"title":"相关指令","slug":"相关指令","link":"#相关指令","children":[]},{"level":3,"title":"日志的格式和命令","slug":"日志的格式和命令","link":"#日志的格式和命令","children":[]},{"level":3,"title":"访问日志和错误日志","slug":"访问日志和错误日志","link":"#访问日志和错误日志","children":[]},{"level":3,"title":"日志缓存","slug":"日志缓存","link":"#日志缓存","children":[]}]},{"level":2,"title":"日志轮转、切割","slug":"日志轮转、切割","link":"#日志轮转、切割","children":[]},{"level":2,"title":"日志分析","slug":"日志分析","link":"#日志分析","children":[]},{"level":2,"title":"连接状态","slug":"连接状态","link":"#连接状态","children":[{"level":3,"title":"stub_status_module","slug":"stub-status-module","link":"#stub-status-module","children":[]},{"level":3,"title":"什么是连接","slug":"什么是连接","link":"#什么是连接","children":[]},{"level":3,"title":"什么是长连接","slug":"什么是长连接","link":"#什么是长连接","children":[]}]},{"level":2,"title":"随机主页","slug":"随机主页","link":"#随机主页","children":[{"level":3,"title":"目的","slug":"目的","link":"#目的","children":[]},{"level":3,"title":"启动随机主页","slug":"启动随机主页","link":"#启动随机主页","children":[]}]},{"level":2,"title":"替换模块","slug":"替换模块","link":"#替换模块","children":[]},{"level":2,"title":"文件读取","slug":"文件读取","link":"#文件读取","children":[{"level":3,"title":"语法","slug":"语法","link":"#语法","children":[]}]},{"level":2,"title":"文件压缩","slug":"文件压缩","link":"#文件压缩","children":[]},{"level":2,"title":"页面缓存","slug":"页面缓存","link":"#页面缓存","children":[]},{"level":2,"title":"防盗链","slug":"防盗链","link":"#防盗链","children":[]},{"level":2,"title":"request限制","slug":"request限制","link":"#request限制","children":[]},{"level":2,"title":"限制tcp连接","slug":"限制tcp连接","link":"#限制tcp连接","children":[]},{"level":2,"title":"基于主机（ip）","slug":"基于主机-ip","link":"#基于主机-ip","children":[]},{"level":2,"title":"基于用户（username&password)","slug":"基于用户-username-password","link":"#基于用户-username-password","children":[]}],"git":{"createdTime":1705981137000,"updatedTime":1705981137000,"contributors":[{"name":"PaperDragon-SH","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":32.95,"words":9886},"filePathRelative":"note-book/Nginx&&OpenResty/nginx01.md","localizedDate":"2024年1月23日","excerpt":"\\n<h1>1、Nginx 的优势</h1>\\n<p>Nginx (engine x) 是一个高性能的HTTP(解决C10k的问题)和反向代理服务器，也是一个IMAP/POP3/SMTP服务器。反代图示</p>\\n<p>nginx的web优势</p>\\n<h2>1、io多路复用</h2>\\n<p>理论方法</p>\\n<h3>第一种方法：</h3>\\n<p>最传统的多进程并发模型 (每进来一个新的I/O流会分配一个新的进程管理）。</p>\\n<h3>第二种方法：</h3>\\n<p>I/O多路复用 (单个线程，通过记录跟踪每个I/O流(sock)的状态，来同时管理多个I/O流 。)发明它的原因，是尽量多的提高服务器的吞吐能力。在同一个线程里面， 通过拨开关的方式，来同时传输多个I/O流</p>","autoDesc":true}');export{m as comp,b as data};
