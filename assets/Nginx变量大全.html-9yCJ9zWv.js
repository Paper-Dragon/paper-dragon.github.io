import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,d as a}from"./app-T8Dw5a2s.js";const t={},i=a(`<h1 id="nginx的变量参数-详解" tabindex="-1"><a class="header-anchor" href="#nginx的变量参数-详解"><span>Nginx的变量参数 详解</span></a></h1><h2 id="参数" tabindex="-1"><a class="header-anchor" href="#参数"><span>参数</span></a></h2><div class="language-nginx line-numbers-mode" data-ext="nginx" data-title="nginx"><pre class="language-nginx"><code>$args                    <span class="token comment">#请求中的参数值</span>
