...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>apiserver可以正常运行</p><h2 id="总结" tabindex="-1"><a class="header-anchor" href="#总结"><span>总结</span></a></h2><p>做了什么搞好的</p><ul><li>更新了 /etc/kubernetes/目录下的证书使用kubeadm命令</li><li>复制admin.conf作为当前kubectl的配置文件</li><li>复制 admin.conf里的证书临时作为kubelet证书使用，让他轮转产生新的证书</li><li>产生新的证书之后 /var/lib/kubelet/pki kubelet文件更改回原来的 /var/lib/kubelet/pki下的证书，不改也行。</li><li>删除etcd下多余的成员</li></ul>`,58),o=[p];function u(b,v){return n(),s("div",null,o)}const h=e(d,[["render",u],["__file","记一次异常断电造成kubernetes故障.html.vue"]]);export{h as default};
