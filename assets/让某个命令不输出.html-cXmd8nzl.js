import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as i,e as s}from"./app-YuN-mc5Y.js";const t={},u=s(`<h1 id="让某个命令不输出" tabindex="-1"><a class="header-anchor" href="#让某个命令不输出" aria-hidden="true">#</a> 让某个命令不输出</h1><p>假如让ls命令不输出</p><p>正常情况下</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ls</span> <span class="token operator">&amp;&gt;</span>/dev/null
