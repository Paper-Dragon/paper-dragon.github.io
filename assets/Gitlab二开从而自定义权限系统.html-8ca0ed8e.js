import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-11b06613.js";const l={},r=e(`<h1 id="gitlab二开从而自定义权限系统" tabindex="-1"><a class="header-anchor" href="#gitlab二开从而自定义权限系统" aria-hidden="true">#</a> Gitlab二开从而自定义权限系统</h1><blockquote><p>Gitlab所给的权限太少了，因为业务需要，二开gitlab，自定义权限系统。</p><p>下面给guest角色删除源码访问权限。并保留提出issue的权限。查看label的权限</p></blockquote><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><p>我们都知道gitlab社区版和商业版本的内核是相同的，所以说社区版本的功能是企业版本的全部。只是部分配置没有放到web界面，需要命令行去修改</p><h2 id="修改" tabindex="-1"><a class="header-anchor" href="#修改" aria-hidden="true">#</a> 修改</h2><p>经过查询，gitlab的权限以文本文件的形式存储在目录中,下面是权限系统的配置文件。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>root@83f572345d3c:/<span class="token comment"># cd  /opt/gitlab/embedded/service/gitlab-rails/app/policies/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编辑 project_policy.rb</p><div class="language-ruby line-numbers-mode" data-ext="rb"><pre class="language-ruby"><code><span class="token number">204</span>   rule <span class="token punctuation">{</span> can<span class="token operator">?</span><span class="token punctuation">(</span><span class="token symbol">:guest_access</span><span class="token punctuation">)</span> <span class="token punctuation">}</span><span class="token punctuation">.</span>policy <span class="token keyword">do</span>
<span class="token number">205</span>     enable <span class="token symbol">:read_project</span>
<span class="token number">206</span>     enable <span class="token symbol">:create_merge_request_in</span>
<span class="token number">207</span>     enable <span class="token symbol">:read_issue_board</span>
<span class="token number">208</span>     enable <span class="token symbol">:read_issue_board_list</span>
<span class="token number">209</span>     enable <span class="token symbol">:read_wiki</span>
<span class="token number">210</span>     enable <span class="token symbol">:read_issue</span>
<span class="token number">211</span>     enable <span class="token symbol">:read_label</span>
<span class="token number">212</span>     enable <span class="token symbol">:read_milestone</span>
<span class="token number">213</span>     enable <span class="token symbol">:read_snippet</span>
<span class="token number">214</span>     enable <span class="token symbol">:read_project_member</span>
<span class="token number">215</span>     enable <span class="token symbol">:read_note</span>
<span class="token number">216</span>     enable <span class="token symbol">:create_project</span>
<span class="token number">217</span>     enable <span class="token symbol">:create_issue</span>
<span class="token number">218</span>     enable <span class="token symbol">:create_note</span>
<span class="token number">219</span>     enable <span class="token symbol">:upload_file</span>
<span class="token number">220</span>     enable <span class="token symbol">:read_cycle_analytics</span>
<span class="token number">221</span>     enable <span class="token symbol">:award_emoji</span>
<span class="token number">222</span>     enable <span class="token symbol">:read_pages_content</span>
<span class="token number">223</span>     enable <span class="token symbol">:read_release</span>
<span class="token number">224</span>     enable <span class="token symbol">:read_analytics</span>
<span class="token number">225</span>     enable <span class="token symbol">:read_insights</span>
<span class="token number">226</span>     <span class="token comment">#  new add 2023/07/12: for guest users enable label_create</span>
<span class="token number">227</span>     enable <span class="token symbol">:admin_label</span>
<span class="token number">228</span>     enable <span class="token symbol">:admin_issue</span>
<span class="token number">229</span>     enable <span class="token symbol">:admin_issue_board</span>
<span class="token number">230</span>   <span class="token keyword">end</span>

</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="重启服务器" tabindex="-1"><a class="header-anchor" href="#重启服务器" aria-hidden="true">#</a> 重启服务器</h2><p>若为rpm安装包安装，运行以下命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
gitlab-ctl reconfigure
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>若为docker运行，运行以下命令</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>gitlab-ctl reconfigure
gitlab-ctl restart
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="权限例子" tabindex="-1"><a class="header-anchor" href="#权限例子" aria-hidden="true">#</a> 权限例子</h2><div class="language-ruby line-numbers-mode" data-ext="rb"><pre class="language-ruby"><code>enable <span class="token symbol">:guest_access</span>
enable <span class="token symbol">:reporter_access</span>
enable <span class="token symbol">:developer_access</span>
enable <span class="token symbol">:maintainer_access</span>
enable <span class="token symbol">:change_namespace</span>
enable <span class="token symbol">:change_visibility_level</span>
enable <span class="token symbol">:rename_project</span>
enable <span class="token symbol">:remove_project</span>
enable <span class="token symbol">:archive_project</span>
enable <span class="token symbol">:remove_fork_project</span>
enable <span class="token symbol">:destroy_merge_request</span>
enable <span class="token symbol">:destroy_issue</span>
enable <span class="token symbol">:set_issue_iid</span>
enable <span class="token symbol">:set_issue_created_at</span>
enable <span class="token symbol">:set_issue_updated_at</span>
enable <span class="token symbol">:set_note_created_at</span>
enable <span class="token symbol">:set_emails_disabled</span>
enable <span class="token symbol">:set_show_default_award_emojis</span>
enable <span class="token symbol">:read_project</span>
enable <span class="token symbol">:create_merge_request_in</span>
enable <span class="token symbol">:read_issue_board</span>
enable <span class="token symbol">:read_issue_board_list</span>
enable <span class="token symbol">:read_wiki</span>
enable <span class="token symbol">:read_issue</span>
enable <span class="token symbol">:read_label</span>
enable <span class="token symbol">:read_milestone</span>
enable <span class="token symbol">:read_snippet</span>
enable <span class="token symbol">:read_project_member</span>
enable <span class="token symbol">:read_note</span>
enable <span class="token symbol">:create_project</span>
enable <span class="token symbol">:create_issue</span>
enable <span class="token symbol">:create_note</span>
enable <span class="token symbol">:upload_file</span>
enable <span class="token symbol">:read_cycle_analytics</span>
enable <span class="token symbol">:award_emoji</span>
enable <span class="token symbol">:read_pages_content</span>
enable <span class="token symbol">:read_release</span>
enable <span class="token symbol">:read_analytics</span>
enable <span class="token symbol">:read_insights</span>
enable <span class="token symbol">:read_board</span>
enable <span class="token symbol">:read_list</span>
enable <span class="token symbol">:read_pipeline</span>
enable <span class="token symbol">:admin_label</span>
enable <span class="token symbol">:admin_issue</span>
enable <span class="token symbol">:public_user_access</span>
enable <span class="token symbol">:read_project_for_iids</span>
enable <span class="token symbol">:public_access</span>
enable <span class="token symbol">:build_download_code</span>
enable <span class="token symbol">:build_read_container_image</span>
enable <span class="token symbol">:request_access</span>
enable <span class="token symbol">:fork_project</span>
enable <span class="token symbol">:read_prometheus</span>
enable <span class="token symbol">:read_deployment</span>
enable <span class="token symbol">:create_metrics_user_starred_dashboard</span>
enable <span class="token symbol">:read_metrics_user_starred_dashboard</span>
enable <span class="token symbol">:create_package</span>
enable <span class="token symbol">:admin_issue_board</span>
enable <span class="token symbol">:admin_merge_request</span>
enable <span class="token symbol">:admin_milestone</span>
enable <span class="token symbol">:update_merge_request</span>
enable <span class="token symbol">:reopen_merge_request</span>
enable <span class="token symbol">:create_commit_status</span>
enable <span class="token symbol">:update_commit_status</span>
enable <span class="token symbol">:create_build</span>
enable <span class="token symbol">:update_build</span>
enable <span class="token symbol">:create_merge_request_from</span>
enable <span class="token symbol">:create_wiki</span>
enable <span class="token symbol">:push_code</span>
enable <span class="token symbol">:resolve_note</span>
enable <span class="token symbol">:create_container_image</span>
enable <span class="token symbol">:update_container_image</span>
enable <span class="token symbol">:destroy_container_image</span>
enable <span class="token symbol">:create_environment</span>
enable <span class="token symbol">:update_environment</span>
enable <span class="token symbol">:destroy_environment</span>
enable <span class="token symbol">:create_deployment</span>
enable <span class="token symbol">:update_deployment</span>
enable <span class="token symbol">:create_release</span>
enable <span class="token symbol">:update_release</span>
enable <span class="token symbol">:daily_statistics</span>
enable <span class="token symbol">:create_metrics_dashboard_annotation</span>
enable <span class="token symbol">:delete_metrics_dashboard_annotation</span>
enable <span class="token symbol">:update_metrics_dashboard_annotation</span>
enable <span class="token symbol">:read_alert_management_alert</span>
enable <span class="token symbol">:update_alert_management_alert</span>
enable <span class="token symbol">:create_design</span>
enable <span class="token symbol">:move_design</span>
enable <span class="token symbol">:destroy_design</span>
enable <span class="token symbol">:read_terraform_state</span>
enable <span class="token symbol">:read_pod_logs</span>
enable <span class="token symbol">:read_feature_flag</span>
enable <span class="token symbol">:create_feature_flag</span>
enable <span class="token symbol">:update_feature_flag</span>
enable <span class="token symbol">:destroy_feature_flag</span>
enable <span class="token symbol">:admin_feature_flag</span>
enable <span class="token symbol">:admin_feature_flags_user_lists</span>
enable <span class="token symbol">:create_pipeline</span>
enable <span class="token symbol">:update_pipeline</span>
enable <span class="token symbol">:create_pipeline_schedule</span>
enable <span class="token symbol">:destroy_package</span>
enable <span class="token symbol">:push_to_delete_protected_branch</span>
enable <span class="token symbol">:update_snippet</span>
enable <span class="token symbol">:admin_snippet</span>
enable <span class="token symbol">:admin_project_member</span>
enable <span class="token symbol">:admin_note</span>
enable <span class="token symbol">:admin_wiki</span>
enable <span class="token symbol">:admin_project</span>
enable <span class="token symbol">:admin_commit_status</span>
enable <span class="token symbol">:admin_build</span>
enable <span class="token symbol">:admin_container_image</span>
enable <span class="token symbol">:admin_pipeline</span>
enable <span class="token symbol">:admin_environment</span>
enable <span class="token symbol">:admin_deployment</span>
enable <span class="token symbol">:admin_pages</span>
enable <span class="token symbol">:read_pages</span>
enable <span class="token symbol">:update_pages</span>
enable <span class="token symbol">:remove_pages</span>
enable <span class="token symbol">:read_cluster</span>
enable <span class="token symbol">:add_cluster</span>
enable <span class="token symbol">:create_cluster</span>
enable <span class="token symbol">:update_cluster</span>
enable <span class="token symbol">:admin_cluster</span>
enable <span class="token symbol">:create_environment_terminal</span>
enable <span class="token symbol">:destroy_release</span>
enable <span class="token symbol">:destroy_artifacts</span>
enable <span class="token symbol">:admin_operations</span>
enable <span class="token symbol">:read_deploy_token</span>
enable <span class="token symbol">:create_deploy_token</span>
enable <span class="token symbol">:destroy_deploy_token</span>
enable <span class="token symbol">:read_prometheus_alerts</span>
enable <span class="token symbol">:admin_terraform_state</span>
enable <span class="token symbol">:create_freeze_period</span>
enable <span class="token symbol">:read_freeze_period</span>
enable <span class="token symbol">:update_freeze_period</span>
enable <span class="token symbol">:destroy_freeze_period</span>
enable <span class="token symbol">:admin_feature_flags_client</span>
enable <span class="token symbol">:metrics_dashboard</span>
enable <span class="token symbol">:read_package</span>
enable <span class="token symbol">:read_merge_request</span>
enable <span class="token symbol">:read_pipeline_schedule</span>
enable <span class="token symbol">:read_environment</span>
enable <span class="token symbol">:read_commit_status</span>
enable <span class="token symbol">:read_container_image</span>
enable <span class="token symbol">:download_code</span>
enable <span class="token symbol">:download_wiki_code</span>
enable <span class="token symbol">:read_build</span>
enable <span class="token symbol">:read_design</span>
enable <span class="token symbol">:read_design_activity</span>
enable <span class="token symbol">:read_issue_link</span>
enable <span class="token symbol">:read_security_configuration</span>
enable <span class="token symbol">:read_repository_graphs</span>
enable <span class="token symbol">:read_build_report_results</span>
enable <span class="token symbol">:admin_resource_access_tokens</span>
enable <span class="token symbol">:set_pipeline_variables</span>
enable <span class="token symbol">:access_security_and_compliance</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16),p=[r];function o(i,b){return s(),a("div",null,p)}const m=n(l,[["render",o],["__file","Gitlab二开从而自定义权限系统.html.vue"]]);export{m as default};
