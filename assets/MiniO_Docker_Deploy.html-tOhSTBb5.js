import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as s,e}from"./app-IDsSPDgA.js";const i={},t=e(`<h1 id="使用docker部署minio" tabindex="-1"><a class="header-anchor" href="#使用docker部署minio" aria-hidden="true">#</a> 使用Docker部署minio</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">ENGINE</span><span class="token operator">=</span>docker
