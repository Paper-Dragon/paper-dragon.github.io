...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="镜像加速的解释" tabindex="-1"><a class="header-anchor" href="#镜像加速的解释" aria-hidden="true">#</a> 镜像加速的解释</h2><p>docker中国区官方镜像加速：</p><ul><li>https://registry.docker-cn.com</li></ul><p>网易镜像加速：</p><ul><li>http://hub-mirror.c.163.com</li></ul><p>腾讯云镜像加速：</p><ul><li>https://mirror.ccs.tencentyun.com</li></ul><p>阿里云镜像加速：</p><ul><li>https://ung2thfc.mirror.aliyuncs.com</li></ul><p>创建或修改/etc/docker/daemon.json文件 默认没有daemon文件，先创建。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">tee</span> /etc/docker/daemon.json <span class="token operator">&lt;&lt;-</span><span class="token string">&#39;EOF&#39;
{
  &quot;registry-mirrors&quot;: [
