import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as t,c as d,b as e,e as i,a as r,d as n}from"./app-RZa02TnW.js";const c={},u=n(`<h1 id="基于wireguard技术的虚拟个人网络搭建-基于lighthouse服务器" tabindex="-1"><a class="header-anchor" href="#基于wireguard技术的虚拟个人网络搭建-基于lighthouse服务器"><span>基于Wireguard技术的虚拟个人网络搭建（基于Lighthouse服务器）</span></a></h1><h2 id="服务端安装-强烈推荐-docker-安装" tabindex="-1"><a class="header-anchor" href="#服务端安装-强烈推荐-docker-安装"><span>服务端安装 （强烈推荐 docker 安装）</span></a></h2><h2 id="docker安装wireguard-更简单更方便" tabindex="-1"><a class="header-anchor" href="#docker安装wireguard-更简单更方便"><span>Docker安装Wireguard (更简单更方便)</span></a></h2><h3 id="通过容器安装wg-easy" tabindex="-1"><a class="header-anchor" href="#通过容器安装wg-easy"><span>通过容器安装wg-easy</span></a></h3><p>括号里面的的是你需要修改的，修改完删掉就可以了</p><h4 id="关于centos7-模块安装" tabindex="-1"><a class="header-anchor" href="#关于centos7-模块安装"><span>关于CentOS7 模块安装</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>$ <span class="token function">sudo</span> yum <span class="token function">install</span> epel-release elrepo-release
