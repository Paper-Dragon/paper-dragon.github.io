import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as e,f as a}from"./app-6c07b424.js";const t={},o=a(`<h1 id="使用redis插件" tabindex="-1"><a class="header-anchor" href="#使用redis插件" aria-hidden="true">#</a> 使用Redis插件</h1><h2 id="description" tabindex="-1"><a class="header-anchor" href="#description" aria-hidden="true">#</a> Description</h2><p><em>redis</em> enables reading zone data from redis database.<br> this plugin should be located right next to <em>etcd</em> in <em>plugins.cfg</em></p><h2 id="syntax" tabindex="-1"><a class="header-anchor" href="#syntax" aria-hidden="true">#</a> Syntax</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>redis
...
2) &quot;example.net.&quot;
redis-cli&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dns-rrs" tabindex="-1"><a class="header-anchor" href="#dns-rrs" aria-hidden="true">#</a> DNS RRs</h3><p>dns RRs are stored in redis as json strings inside a hash map using address as field key.<br><em>@</em> is used for zone&#39;s own RR values.</p><h4 id="a" tabindex="-1"><a class="header-anchor" href="#a" aria-hidden="true">#</a> A</h4><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
