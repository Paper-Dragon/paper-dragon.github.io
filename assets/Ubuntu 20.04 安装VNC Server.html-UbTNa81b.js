import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,e as a}from"./app-gFxrH9LE.js";const r={},i=a(`<h1 id="ubuntu-20-04-安装vnc-server超简单教程" tabindex="-1"><a class="header-anchor" href="#ubuntu-20-04-安装vnc-server超简单教程" aria-hidden="true">#</a> Ubuntu 20.04 安装VNC Server超简单教程</h1><h2 id="_1-确保安装了gnome-desktop" tabindex="-1"><a class="header-anchor" href="#_1-确保安装了gnome-desktop" aria-hidden="true">#</a> 1.确保安装了GNOME DESKTOP</h2><p>对于桌面版是不用说了，服务器版操作系统需要安装一下桌面</p><pre><code># apt install ubuntu-gnome-desktop
