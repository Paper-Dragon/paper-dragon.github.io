import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-996337bd.js";const t={},i=e(`<h1 id="jumperserver-docker容器部署" tabindex="-1"><a class="header-anchor" href="#jumperserver-docker容器部署" aria-hidden="true">#</a> JumperServer Docker容器部署</h1><h2 id="环境展示和配置如下" tabindex="-1"><a class="header-anchor" href="#环境展示和配置如下" aria-hidden="true">#</a> 环境展示和配置如下</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@localhost ~<span class="token punctuation">]</span><span class="token comment"># cat /etc/redhat-release</span>
