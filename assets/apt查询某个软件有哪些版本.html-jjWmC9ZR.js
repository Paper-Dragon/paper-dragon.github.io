import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as a,c as s,b as t,d as n}from"./app-Lk-a7biu.js";const c={},r=t("h1",{id:"apt查询某个软件有哪些版本",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#apt查询某个软件有哪些版本","aria-hidden":"true"},"#"),n(" apt查询某个软件有哪些版本")],-1),i=t("blockquote",null,[t("p",null,"https://blog.csdn.net/quantum7/article/details/103417643")],-1),d=t("p",null,"安装默认，有时候会出问题。怎么办？查询一下版本：",-1),o=t("pre",null,[t("code",null,`sudo apt update
...
`)],-1),u=t("p",null,"安装低版本：",-1),m=t("p",null,"apt install g++=4:6.3.0-4",-1),h=[r,i,d,o,u,m];function l(_,p){return a(),s("div",null,h)}const f=e(c,[["render",l],["__file","apt查询某个软件有哪些版本.html.vue"]]);export{f as default};
