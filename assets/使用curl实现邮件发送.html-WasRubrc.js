import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as n,d as e}from"./app-U10FbIpD.js";const i="/assets/image-20220810164720943-vAB5LtfF.png",l="/assets/image-20220810164713378-qsgzFnME.png",t={},r=e(`<h1 id="使用curl实现邮件发送" tabindex="-1"><a class="header-anchor" href="#使用curl实现邮件发送"><span>使用curl实现邮件发送</span></a></h1><h1 id="概述" tabindex="-1"><a class="header-anchor" href="#概述"><span>概述</span></a></h1><p>本文讲解如何通过curl实现邮件发送功能，通过此功能，可以将一些配置信息自动发送到指定邮箱，满足自动运维要求。 测试发件邮箱：sina 测试收件邮箱：qq</p><h1 id="脚本实例" tabindex="-1"><a class="header-anchor" href="#脚本实例"><span>脚本实例</span></a></h1><p>curl_send_mail.bat</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>@echo off
rem 使用curl实现邮件发送
rem -------------------------------------------
rem 参数
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="执行结果" tabindex="-1"><a class="header-anchor" href="#执行结果"><span>执行结果</span></a></h1><figure><img src="`+i+'" alt="image-20220810164720943" tabindex="0" loading="lazy"><figcaption>image-20220810164720943</figcaption></figure><h1 id="邮箱配置" tabindex="-1"><a class="header-anchor" href="#邮箱配置"><span>邮箱配置</span></a></h1><p>新浪邮箱配置： <img src="'+l+'" alt="image-20220810164713378" loading="lazy"></p>',10),c=[r];function o(p,d){return s(),n("div",null,c)}const v=a(t,[["render",o],["__file","使用curl实现邮件发送.html.vue"]]);export{v as default};
