import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e as t}from"./app-_oiYTxSE.js";const p="/assets/image-20201122194840726-1NbQTgD8.png",e="/assets/image-20201122203450056-oZtVNvuF.png",i={},o=t(`<h1 id="_004-布局2" tabindex="-1"><a class="header-anchor" href="#_004-布局2" aria-hidden="true">#</a> 004-布局2</h1><h2 id="一、qformlayout" tabindex="-1"><a class="header-anchor" href="#一、qformlayout" aria-hidden="true">#</a> 一、QFormLayout</h2><p>一般适用于提交数据<strong>form表单</strong>。比如： 登录，注册类似的场景</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
