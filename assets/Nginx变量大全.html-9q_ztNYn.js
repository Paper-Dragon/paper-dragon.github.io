import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,e as a}from"./app-W_F1xAQx.js";const t={},i=a(`<h1 id="nginx的变量参数-详解" tabindex="-1"><a class="header-anchor" href="#nginx的变量参数-详解" aria-hidden="true">#</a> Nginx的变量参数 详解</h1><h2 id="参数" tabindex="-1"><a class="header-anchor" href="#参数" aria-hidden="true">#</a> 参数</h2><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code>$args                    <span class="token comment">#请求中的参数值</span>
