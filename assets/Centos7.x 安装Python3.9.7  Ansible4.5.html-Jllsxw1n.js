import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app--IoMPkS2.js";const i={},l=e(`<h1 id="centos7-x-安装python3-9-7-ansible4-5-已验证" tabindex="-1"><a class="header-anchor" href="#centos7-x-安装python3-9-7-ansible4-5-已验证" aria-hidden="true">#</a> Centos7.x 安装Python3.9.7 &amp; Ansible4.5 （已验证）</h1><h2 id="_1、环境信息" tabindex="-1"><a class="header-anchor" href="#_1、环境信息" aria-hidden="true">#</a> 1、环境信息</h2><p>前期安装Ansible失败报&quot;Failed to validate the SSL certificate&quot;，可能前期安装python3时有问题，后索性升级SSH/SSL后再重新安装Python3,然后再升级pip,最后再安装Ansible</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>安装环境： 　Centos7.9
