import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as e,d as a}from"./app-CJpFwaIP.js";const i="/assets/image-20220815102732430-DIu65CMX.png",t={},c=a(`<h1 id="一、安装helm工具" tabindex="-1"><a class="header-anchor" href="#一、安装helm工具"><span>一、安装helm工具</span></a></h1><h2 id="_1-下载软件包" tabindex="-1"><a class="header-anchor" href="#_1-下载软件包"><span>（1）下载软件包</span></a></h2><pre><code>wget https://get.helm.sh/helm-v3.8.0-linux-amd64.tar.gz
