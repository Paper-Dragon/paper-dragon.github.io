import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-FoPXP0Y_.js";const o={},i=e(`<h1 id="samba共享文件时文件属性nobody" tabindex="-1"><a class="header-anchor" href="#samba共享文件时文件属性nobody" aria-hidden="true">#</a> Samba共享文件时文件属性nobody</h1><p>Linux于Windows使用Samba共享文件时文件属性nobody nogroup的解决办法</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/samba/smb.conf修改配置文件如下:
