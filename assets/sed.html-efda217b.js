import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as t,c as h,a as e,e as o,d,f as s}from"./app-8bb3cc4f.js";const l={},i=e("h1",{id:"linux三剑客-sed",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#linux三剑客-sed","aria-hidden":"true"},"#"),o(" Linux三剑客-sed")],-1),y=e("pre",null,[e("code",null,`19999,9999,9999,9999
[root@handsome-man ~]# 
`)],-1),c=e("h2",{id:"sed命令执行过程",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#sed命令执行过程","aria-hidden":"true"},"#"),o(" sed命令执行过程")],-1),O={href:"https://www.processon.com/view/link/5bea32c5e4b0ad314e894f53",target:"_blank",rel:"noopener noreferrer"},C=s(`<p>sed -n &#39;3 p&#39; oldboy.txt<br> 参数 条件 命令</p><p>print<br> sed取范围</p><pre><code>[root@oldboyedu59 /oldboy]# sed -n &#39;5p&#39; lidao.txt
105,feixue,CIO
...
105,feixue,CIO
110,alex,COCO
</code></pre>`,33),b=e("br",null,null,-1),x=e("br",null,null,-1),p={href:"https://blog.csdn.net/weixin_44922815/article/details/89391262",target:"_blank",rel:"noopener noreferrer"};function f(u,_){const n=r("ExternalLinkIcon");return t(),h("div",null,[i,y,c,e("p",null,[e("a",O,[o("https://www.processon.com/view/link/5bea32c5e4b0ad314e894f53"),d(n)])]),C,e("p",null,[o("————————————————"),b,o(" 版权声明：本文为CSDN博主「追梦娃」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。"),x,o(" 原文链接："),e("a",p,[o("https://blog.csdn.net/weixin_44922815/article/details/89391262"),d(n)])])])}const F=a(l,[["render",f],["__file","sed.html.vue"]]);export{F as default};
