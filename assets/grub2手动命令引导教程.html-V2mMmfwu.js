import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as t,d as i}from"./app-JuDnXlF7.js";const e={},u=i(`<h1 id="grub2各种手动命令引导教程" tabindex="-1"><a class="header-anchor" href="#grub2各种手动命令引导教程"><span>grub2各种手动命令引导教程</span></a></h1><h2 id="手动引导ubuntu的iso镜像文件" tabindex="-1"><a class="header-anchor" href="#手动引导ubuntu的iso镜像文件"><span>手动引导ubuntu的iso镜像文件</span></a></h2><p>从而安装ubuntu，grub&gt;代表命令的开始</p><p>假设ubuntu镜像在U盘的第一个分区的根目录下即：(hd0,1)/ubuntu-18.04-desktop-amd64.iso</p><p>手动引导下可以按TAB键补全命令、目录以及文件名</p><pre><code>#查询所有已安装磁盘并打印详细信息
grub&gt;ls -l
