import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as t}from"./app-d-G7c0BN.js";const e={},o=t(`<h1 id="k8s删除terminating状态ns" tabindex="-1"><a class="header-anchor" href="#k8s删除terminating状态ns"><span>k8s删除Terminating状态ns</span></a></h1><h1 id="假设你要删掉ns资源-发现一直删不了处于terminating状态" tabindex="-1"><a class="header-anchor" href="#假设你要删掉ns资源-发现一直删不了处于terminating状态"><span>假设你要删掉ns资源，发现一直删不了处于terminating状态</span></a></h1><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># kubectl get ns</span>
NAME              STATUS        AGE
...
kube-system       Active        7h11m
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="首先试一下先把这个ns的所有pod都删掉" tabindex="-1"><a class="header-anchor" href="#首先试一下先把这个ns的所有pod都删掉"><span>首先试一下先把这个ns的所有pod都删掉</span></a></h2><pre><code>kubectl delete pod --all -n kube-flannel
</code></pre><p>还是不行的话，加个参数强制删除</p><pre><code>kubectl delete pod --grace-period=0 --force -n kube-flannel
</code></pre><p>如果依然是卡死状态，就要使用下面的必杀技了</p><h2 id="首先生成一个tmp-json文件" tabindex="-1"><a class="header-anchor" href="#首先生成一个tmp-json文件"><span>首先生成一个tmp.json文件</span></a></h2><pre><code>kubectl get namespace kube-flannel -o json &gt; tmp.json
</code></pre><h2 id="然后修改这个json文件tmp-json-把finalizers的kubernetes删掉" tabindex="-1"><a class="header-anchor" href="#然后修改这个json文件tmp-json-把finalizers的kubernetes删掉"><span>然后修改这个json文件tmp.json ，把finalizers的kubernetes删掉</span></a></h2><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="然后本机服务暴露在本地端口的8001端口上" tabindex="-1"><a class="header-anchor" href="#然后本机服务暴露在本地端口的8001端口上"><span>然后本机服务暴露在本地端口的8001端口上</span></a></h2><pre><code>kubectl proxy

kubectl proxy
Starting to serve on 127.0.0.1:8001
</code></pre><h2 id="新开一个terminal-把修改后的tmp-json到要删除的ns资源目录下" tabindex="-1"><a class="header-anchor" href="#新开一个terminal-把修改后的tmp-json到要删除的ns资源目录下"><span>新开一个terminal，把修改后的tmp.json到要删除的ns资源目录下</span></a></h2><pre><code>curl -k -H &quot;Content-Type: application/json&quot; -X PUT --data-binary @tmp.json http://127.0.0.1:8001/api/v1/namespaces/kube-flannel/finalize
