import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as t,c as i,d as n}from"./app-B8GWEu9h.js";const s={},d=n(`<h1 id="概述资料地址-https-blog-csdn-net-bbwangj-article-details-81904350" tabindex="-1"><a class="header-anchor" href="#概述资料地址-https-blog-csdn-net-bbwangj-article-details-81904350"><span>概述资料地址：https://blog.csdn.net/bbwangj/article/details/81904350</span></a></h1><p>![img](二进制安装kubernetes（五） kubelet组件安装.assets/1034759-20191113174751232-1888238592-16918405999271.png)</p><p>Kubelet组件运行在Node节点上，维持运行中的Pods以及提供kuberntes运行时环境，主要完成以下使命： １．监视分配给该Node节点的pods ２．挂载pod所需要的volumes ３．下载pod的secret ４．通过docker/rkt来运行pod中的容器 ５．周期的执行pod中为容器定义的liveness探针 ６．上报pod的状态给系统的其他组件 ７．上报Node的状态</p><p>kubelet安装在node节点，我们的node跟apiserver在一起，这里安装在hdss7-21,22上：</p><p>首先，kubernetes依赖pause，我们先将此服务上传到们自己的docker私有仓库：</p><p>kubernetes中的pause容器主要为每个业务容器提供以下功能：</p><ul><li>在pod中担任Linux命名空间共享的基础；</li><li>启用pid命名空间，开启init进程。</li></ul><p>HDSS7-200上:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># docker pull kubernetes/pause
