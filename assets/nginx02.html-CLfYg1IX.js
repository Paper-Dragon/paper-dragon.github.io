import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as a,c as s,d as e}from"./app-CAtSu0sD.js";const t="/assets/image-20211109120422697-BQ28DQYR.png",i="/assets/image-20211109120844510-D0I4rYnc.png",p="/assets/image-20211109132501205-EmXzdZF3.png",l={},o=e(`<h1 id="nginx高级进阶篇" tabindex="-1"><a class="header-anchor" href="#nginx高级进阶篇"><span>Nginx高级进阶篇</span></a></h1><h2 id="nginx-web服务器" tabindex="-1"><a class="header-anchor" href="#nginx-web服务器"><span>Nginx Web服务器</span></a></h2><h2 id="nginx-proxy-服务器" tabindex="-1"><a class="header-anchor" href="#nginx-proxy-服务器"><span>Nginx Proxy 服务器</span></a></h2><h3 id="原理" tabindex="-1"><a class="header-anchor" href="#原理"><span>原理</span></a></h3><h4 id="正向代理" tabindex="-1"><a class="header-anchor" href="#正向代理"><span>正向代理</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>内网客户机通过代理访问互联网，通常需要设置代理服务器的地址和端口
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+t+`" alt="image-20211109120422697" tabindex="0" loading="lazy"><figcaption>image-20211109120422697</figcaption></figure><p>squid：</p><h4 id="反向代理" tabindex="-1"><a class="header-anchor" href="#反向代理"><span>反向代理</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>外网用户通过代理访问内网服务器，内网服务器无感知
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+i+`" alt="image-20211109120844510" tabindex="0" loading="lazy"><figcaption>image-20211109120844510</figcaption></figure><h4 id="正向代理和反向代理的区别是什么" tabindex="-1"><a class="header-anchor" href="#正向代理和反向代理的区别是什么"><span>正向代理和反向代理的区别是什么</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>--------正代--------
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="proxy代理" tabindex="-1"><a class="header-anchor" href="#proxy代理"><span>Proxy代理</span></a></h3><h4 id="模块" tabindex="-1"><a class="header-anchor" href="#模块"><span>模块</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>ngx_http_proxy_module
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="语法" tabindex="-1"><a class="header-anchor" href="#语法"><span>语法</span></a></h4><p>代理</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>Syntax: 	proxy_pass URL<span class="token punctuation">;</span> 代理后端服务器URL
Default: 	—
Context: 	location, <span class="token keyword">if</span> <span class="token keyword">in</span> location, limit_except
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>缓冲区</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>Syntax: 	proxy_buffering on <span class="token operator">|</span> off<span class="token punctuation">;</span> 缓冲开关
...
Context: 	http, server, location
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="启用代理" tabindex="-1"><a class="header-anchor" href="#启用代理"><span>启用代理</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>location / <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="proxy缓存" tabindex="-1"><a class="header-anchor" href="#proxy缓存"><span>Proxy缓存</span></a></h3><figure><img src="`+p+`" alt="image-20211109132501205" tabindex="0" loading="lazy"><figcaption>image-20211109132501205</figcaption></figure><h4 id="缓存类型" tabindex="-1"><a class="header-anchor" href="#缓存类型"><span>缓存类型</span></a></h4><p>网页缓存 CDN</p><p>数据库缓存 memcache redis</p><p>网页缓存 nginx-proxy</p><p>客户端缓存，浏览器缓存</p><h4 id="模块-1" tabindex="-1"><a class="header-anchor" href="#模块-1"><span>模块</span></a></h4><p>ngx_http_proxy_module</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>原理：将Proxy服务器作为realServer的缓存服务器，加速用户的访问过程
      将realServer上的一部分数据放到Proxy服务器上
      当用户请求数据时,realServer将数据返回时,先将数据在Proxy上进行暂存,在发送给用户。
      当用户第二次访问时,访问到缓存的数据,可直接返回,加速用户对服务器的访问。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="语法-1" tabindex="-1"><a class="header-anchor" href="#语法-1"><span>语法</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>缓存开关
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="启动缓存" tabindex="-1"><a class="header-anchor" href="#启动缓存"><span>启动缓存</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>http <span class="token punctuation">{</span>
  <span class="token punctuation">..</span>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>proxy_cache_path命令中的参数及对应配置说明如下：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token number">1</span>.用于缓存的本地磁盘目录是/app/tianyun.me/cache
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="课后题" tabindex="-1"><a class="header-anchor" href="#课后题"><span>课后题</span></a></h4><h3 id="负载均衡部分详解" tabindex="-1"><a class="header-anchor" href="#负载均衡部分详解"><span>负载均衡部分详解</span></a></h3><h2 id="nginx-email" tabindex="-1"><a class="header-anchor" href="#nginx-email"><span>Nginx Email</span></a></h2>`,42),c=[o];function r(d,u){return a(),s("div",null,c)}const b=n(l,[["render",r],["__file","nginx02.html.vue"]]),h=JSON.parse('{"path":"/note-book/Nginx__OpenResty/nginx02.html","title":"Nginx高级进阶篇","lang":"zh-CN","frontmatter":{"description":"Nginx高级进阶篇 Nginx Web服务器 Nginx Proxy 服务器 原理 正向代理 image-20211109120422697image-20211109120422697 squid： 反向代理 image-20211109120844510image-20211109120844510 正向代理和反向代理的区别是什么 Proxy代理...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Nginx__OpenResty/nginx02.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"Nginx高级进阶篇"}],["meta",{"property":"og:description","content":"Nginx高级进阶篇 Nginx Web服务器 Nginx Proxy 服务器 原理 正向代理 image-20211109120422697image-20211109120422697 squid： 反向代理 image-20211109120844510image-20211109120844510 正向代理和反向代理的区别是什么 Proxy代理..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-23T03:38:57.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-01-23T03:38:57.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Nginx高级进阶篇\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-01-23T03:38:57.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"Nginx Web服务器","slug":"nginx-web服务器","link":"#nginx-web服务器","children":[]},{"level":2,"title":"Nginx Proxy 服务器","slug":"nginx-proxy-服务器","link":"#nginx-proxy-服务器","children":[{"level":3,"title":"原理","slug":"原理","link":"#原理","children":[]},{"level":3,"title":"Proxy代理","slug":"proxy代理","link":"#proxy代理","children":[]},{"level":3,"title":"Proxy缓存","slug":"proxy缓存","link":"#proxy缓存","children":[]},{"level":3,"title":"负载均衡部分详解","slug":"负载均衡部分详解","link":"#负载均衡部分详解","children":[]}]},{"level":2,"title":"Nginx Email","slug":"nginx-email","link":"#nginx-email","children":[]}],"git":{"createdTime":1705981137000,"updatedTime":1705981137000,"contributors":[{"name":"PaperDragon-SH","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":7.09,"words":2126},"filePathRelative":"note-book/Nginx&&OpenResty/nginx02.md","localizedDate":"2024年1月23日","excerpt":"\\n<h2>Nginx Web服务器</h2>\\n<h2>Nginx Proxy 服务器</h2>\\n<h3>原理</h3>\\n<h4>正向代理</h4>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code>内网客户机通过代理访问互联网，通常需要设置代理服务器的地址和端口\\n</code></pre></div><figure><figcaption>image-20211109120422697</figcaption></figure>\\n<p>squid：</p>\\n<h4>反向代理</h4>","autoDesc":true}');export{b as comp,h as data};
