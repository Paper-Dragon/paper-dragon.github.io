...
</code></pre>`,19),d={href:"http://192.168.31.100:8500",target:"_blank",rel:"noopener noreferrer"},m=a(`<h3 id="_2-修改从节点centos8-4" tabindex="-1"><a class="header-anchor" href="#_2-修改从节点centos8-4"><span>2）修改从节点CentOS8.4</span></a></h3><p>vim /etc/docker/daemon.json</p><p>有了上面配置的基础，从节点配置简单一点，其他配使用默认就可以。仅配置下面的三行。需要注意的是集群广播监听的地址cluster-advertise，要配置为从节点自己的IP。</p><pre><code>&quot;cluster-store&quot;:&quot;consul://192.168.31.100:8500&quot;,
