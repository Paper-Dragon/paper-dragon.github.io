import{_ as d}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as a,o as l,c as t,b as i,d as e,a as r,e as n}from"./app-3a9u-IC9.js";const u="/assets/2ab113f5bbfc49a9befae75e5d06fa08tplv-k3u1fbpfcp-zoom-in-crop-mark4536000-y_k96fF-.webp",v="/assets/6474dac09c9f4e9584cb52f4369659dftplv-k3u1fbpfcp-zoom-in-crop-mark4536000-LQ5VoiCF.webp",c="/assets/0093421e41164cadaa99f7c6cff38cdbtplv-k3u1fbpfcp-zoom-in-crop-mark4536000-awTWQVV1.webp",o="/assets/79962ef2cd624404a0561097cf39a7c2tplv-k3u1fbpfcp-zoom-in-crop-mark4536000-DYjxmJFR.webp",m="/assets/8271350760154f89bf6bf126de2a5b85tplv-k3u1fbpfcp-zoom-in-crop-mark4536000-kOec3Wve.webp",b={},p=n(`<h1 id="fastapi-python高性能web框架" tabindex="-1"><a class="header-anchor" href="#fastapi-python高性能web框架" aria-hidden="true">#</a> FastAPI--python高性能web框架</h1><blockquote><p>https://github.com/Paper-Dragon/learn-fastapi</p><p>https://www.bilibili.com/video/BV1iN411X72b</p></blockquote><h2 id="第2章-fastapi介绍和项目准备" tabindex="-1"><a class="header-anchor" href="#第2章-fastapi介绍和项目准备" aria-hidden="true">#</a> 第2章 FastAPI介绍和项目准备</h2><h3 id="_2-1-starlette-pydantic-与-fastapi-框架是什么关系" tabindex="-1"><a class="header-anchor" href="#_2-1-starlette-pydantic-与-fastapi-框架是什么关系" aria-hidden="true">#</a> 2.1 Starlette，Pydantic 与 FastAPI 框架是什么关系？</h3><p>python的类型提示，基于类型提示type hints</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Pydantic是一个基于Python类型提示来定义数据验证，序列化和文档（使用JSON模式）库</p><p>Starlette是一个轻量级的ASGI框架/工具包，是构建高性能Asyncio服务的理想选择</p><figure><img src="`+u+'" alt="image-20210202092756107" tabindex="0" loading="lazy"><figcaption>image-20210202092756107</figcaption></figure>',9),q={href:"https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fliaogx%2Ffastapi-tutorial",target:"_blank",rel:"noopener noreferrer"},_=n(`<p>一定要注意版本的兼容性</p><h3 id="_2-2-pydantic基础教程" tabindex="-1"><a class="header-anchor" href="#_2-2-pydantic基础教程" aria-hidden="true">#</a> 2.2 Pydantic基础教程</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-fastapi的结构" tabindex="-1"><a class="header-anchor" href="#_3-2-fastapi的结构" aria-hidden="true">#</a> 3.2 fastApi的结构</h3><p>首先创建一个文件包，用于存放各个app <img src="`+c+`" alt=" image-20210202145110225" loading="lazy"></p><p>然后再<strong>chapter03.py</strong>中实现</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
def create_city_data(db: Session, data: schemas.CreateCity, city_id: int):
    ...
    db.refresh(db_data)
    return db_data
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_7-5-jinjia2渲染前端页面" tabindex="-1"><a class="header-anchor" href="#_7-5-jinjia2渲染前端页面" aria-hidden="true">#</a> 7.5 Jinjia2渲染前端页面</h3><p><strong>main.py</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
#!/usr/bin/python3
# -*- coding:utf-8 -*-
# __author__ = &#39;__Jack__&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-5-后台任务更新" tabindex="-1"><a class="header-anchor" href="#_8-5-后台任务更新" aria-hidden="true">#</a> 8.5 后台任务更新</h3><p>见7.5main.py</p><h3 id="_8-6-testclient编写测试用例" tabindex="-1"><a class="header-anchor" href="#_8-6-testclient编写测试用例" aria-hidden="true">#</a> 8.6 TestClient编写测试用例</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,115);function h(g,f){const s=a("ExternalLinkIcon");return l(),t("div",null,[p,i("p",null,[e("安装环境，python环境必须是3.6以上的，然后去github中将"),i("a",q,[e("github.com/liaogx/fast…"),r(s)]),e(" 拷贝下来，安装reqiurements.txt里面的包")]),_])}const k=d(b,[["render",h],["__file","FastAPI-Python高性能web框架.html.vue"]]);export{k as default};
