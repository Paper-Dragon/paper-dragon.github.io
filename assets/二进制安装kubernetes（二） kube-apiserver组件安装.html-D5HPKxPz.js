...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>检查VIP情况：</p><p>7-11是主，现在vip绑定在主上，正常：</p><p>![img](二进制安装kubernetes（二） kube-apiserver组件安装.assets/1034759-20191113163151886-1369051614-16918405286763.png)</p><p>如果keepalived出现脑裂问题，两台上面都有vip，可以加入以下配置，将多播修改成单播：</p><p>![img](二进制安装kubernetes（二） kube-apiserver组件安装.assets/1034759-20191209165848123-1526028674-16918405319815.png)</p><p>至此，apiserver部署完成，并且配置了负载高可用。下一章节部署kube-controller-manager。</p>`,58),l=[d];function a(r,u){return i(),n("div",null,l)}const o=e(t,[["render",a],["__file","二进制安装kubernetes（二） kube-apiserver组件安装.html.vue"]]);export{o as default};
