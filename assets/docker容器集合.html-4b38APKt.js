...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用mysql客户端连接到数据库" tabindex="-1"><a class="header-anchor" href="#使用mysql客户端连接到数据库"><span>使用MySQL客户端连接到数据库</span></a></h3><p>一旦数据库容器启动，就可以使用安装在主机上的任何MySQL客户端应用程序以用户ID <code>root</code> 和密码<code>websecret</code> 连接到 <code>localhost:3306</code>。</p><p>如果你手头没有MySQL客户端，<a href="https://www.adminer.org/" target="_blank" rel="noopener noreferrer">Admineris</a>是一个轻量级的基于php的选项。它也可以作为 <a href="https://hub.docker.com/_/adminer" target="_blank" rel="noopener noreferrer">Docker image</a> ,在另一个终端中运行以下命令：</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>docker run \\
...
db.createUser<span class="token punctuation">(</span>
 ...
 <span class="token punctuation">)</span>
  ...
  weejewel/wg-easy
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="客户端" tabindex="-1"><a class="header-anchor" href="#客户端"><span>客户端</span></a></h4><ul><li><p>windows 客户端下载 （科学上网）<a href="https://www.wireguard.com/install/" target="_blank" rel="noopener noreferrer">Installation - WireGuard</a></p></li><li><p>ubuntu</p></li><li><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> <span class="token parameter variable">-y</span> iptables wireguard openresolv
...
wg show
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li></ul><h3 id="frp-docker" tabindex="-1"><a class="header-anchor" href="#frp-docker"><span>frp docker</span></a></h3><h4 id="服务端" tabindex="-1"><a class="header-anchor" href="#服务端"><span>服务端</span></a></h4><p>限制端口版本frp</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="docker-ssh-探针" tabindex="-1"><a class="header-anchor" href="#docker-ssh-探针"><span>docker ssh 探针</span></a></h3><blockquote><p>参考链接1： <a href="https://man.openbsd.org/sshd_config#Match" target="_blank" rel="noopener noreferrer">sshd_config（5） - OpenBSD 手册页</a></p><p>参考链接2： <a href="https://docs.linuxserver.io/images/docker-openssh-server" target="_blank" rel="noopener noreferrer">Linux服务器/OpenSSH-server - LinuxServer.io</a></p><p>参考链接3：<a href="https://www.ssh.com/academy/ssh/authorized-keys-openssh" target="_blank" rel="noopener noreferrer">Detailed Description of How to Configure Authorized Keys for OpenSSH</a></p><p>参考链接4：<a href="https://blog.zzsqwq.cn/posts/docker-gitlab-ssh/" target="_blank" rel="noopener noreferrer">Docker-Gitlab 与主机共用 ssh 的 22 端口 · Zs&#39;s Blog (zzsqwq.cn)</a></p></blockquote><div class="language-\\ line-numbers-mode" data-ext="\\" data-title="\\"><pre class="language-\\"><code>---
version: &quot;2.1&quot;
services:
  openssh-server:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,61),l=[i];function p(r,o){return a(),s("div",null,l)}const u=n(t,[["render",p],["__file","docker容器集合.html.vue"]]),v=JSON.parse(`{"path":"/note-book/Docker/docker%E5%AE%B9%E5%99%A8%E9%9B%86%E5%90%88.html","title":"docker容器集合","lang":"zh-CN","frontmatter":{"description":"docker容器集合 docker 部署和镜像仓库优化 普通用户使用docker 以下方法仅适用于单用户电脑，若为多用户，即有越权漏洞！！！！ docker 常用的容器 mysql容器 使用MySQL客户端连接到数据库 一旦数据库容器启动，就可以使用安装在主机上的任何MySQL客户端应用程序以用户ID root 和密码websecret 连接到 loc...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Docker/docker%E5%AE%B9%E5%99%A8%E9%9B%86%E5%90%88.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"docker容器集合"}],["meta",{"property":"og:description","content":"docker容器集合 docker 部署和镜像仓库优化 普通用户使用docker 以下方法仅适用于单用户电脑，若为多用户，即有越权漏洞！！！！ docker 常用的容器 mysql容器 使用MySQL客户端连接到数据库 一旦数据库容器启动，就可以使用安装在主机上的任何MySQL客户端应用程序以用户ID root 和密码websecret 连接到 loc..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-11T07:18:30.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-01-11T07:18:30.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"docker容器集合\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-01-11T07:18:30.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"docker 部署和镜像仓库优化","slug":"docker-部署和镜像仓库优化","link":"#docker-部署和镜像仓库优化","children":[{"level":3,"title":"普通用户使用docker","slug":"普通用户使用docker","link":"#普通用户使用docker","children":[]}]},{"level":2,"title":"docker 常用的容器","slug":"docker-常用的容器","link":"#docker-常用的容器","children":[{"level":3,"title":"mysql容器","slug":"mysql容器","link":"#mysql容器","children":[]},{"level":3,"title":"使用MySQL客户端连接到数据库","slug":"使用mysql客户端连接到数据库","link":"#使用mysql客户端连接到数据库","children":[]},{"level":3,"title":"mongodb容器","slug":"mongodb容器","link":"#mongodb容器","children":[]},{"level":3,"title":"alist安装","slug":"alist安装","link":"#alist安装","children":[]},{"level":3,"title":"中文版本的 portainer","slug":"中文版本的-portainer","link":"#中文版本的-portainer","children":[]},{"level":3,"title":"英文版本portainer","slug":"英文版本portainer","link":"#英文版本portainer","children":[]},{"level":3,"title":"jupyter镜像","slug":"jupyter镜像","link":"#jupyter镜像","children":[]},{"level":3,"title":"WireGuard","slug":"wireguard","link":"#wireguard","children":[]},{"level":3,"title":"frp docker","slug":"frp-docker","link":"#frp-docker","children":[]},{"level":3,"title":"docker ssh 探针","slug":"docker-ssh-探针","link":"#docker-ssh-探针","children":[]},{"level":3,"title":"poste.io","slug":"poste-io","link":"#poste-io","children":[]}]}],"git":{"createdTime":1691939318000,"updatedTime":1704957510000,"contributors":[{"name":"PaperDragon","email":"2678885646@qq.com","commits":3},{"name":"PaperDragon-SH","email":"2678885646@qq.com","commits":2}]},"readingTime":{"minutes":4.49,"words":1347},"filePathRelative":"note-book/Docker/docker容器集合.md","localizedDate":"2023年8月13日","excerpt":"\\n<h2>docker 部署和镜像仓库优化</h2>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code><span class=\\"token function\\">sudo</span> <span class=\\"token function\\">curl</span> <span class=\\"token parameter variable\\">-fsSL</span> get.docker.com  <span class=\\"token operator\\">&amp;&amp;</span> <span class=\\"token function\\">sudo</span> <span class=\\"token function\\">sh</span>\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">mkdir</span> <span class=\\"token parameter variable\\">-p</span> /etc/docker\\n<span class=\\"token function\\">sudo</span> <span class=\\"token function\\">tee</span> /etc/docker/daemon.json <span class=\\"token operator\\">&lt;&lt;-</span><span class=\\"token string\\">'EOF'\\n{\\n  \\"registry-mirrors\\": [\\"http://hub-mirror.c.163.com\\"]\\n}\\nEOF</span>\\n<span class=\\"token function\\">sudo</span> systemctl <span class=\\"token builtin class-name\\">enable</span> <span class=\\"token function\\">docker</span>\\n<span class=\\"token function\\">sudo</span> systemctl start <span class=\\"token function\\">docker</span>\\n</code></pre></div>","autoDesc":true}`);export{u as comp,v as data};
