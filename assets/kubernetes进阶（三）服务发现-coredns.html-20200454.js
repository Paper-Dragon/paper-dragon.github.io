import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as a,o as r,c,a as e,e as n,d as s,f as d}from"./app-a9e2ba4f.js";const v="/assets/1034759-20191123171511586-952619728-16918406481011-d54ce47e.png",t="/assets/1034759-20191123171846178-306539553-16918406503293-398afbfc.png",u="/assets/1034759-20191123172154297-518829231-16918406525315-311e94aa.png",m="/assets/1034759-20191123173004191-1776516653-16918406560269-eb62a387.png",o="/assets/1034759-20191123173122519-900176878-16918406543237-363ca1ad.png",b="/assets/1034759-20191123174517612-971806757-169184065782711-4b53398d.png",p={},g=d(`<p>服务发现，说白了就是服务(应用)之间相互定位的过程。</p><p>服务发现需要解决的问题：</p><p>1、服务动态性强--容器在k8s中ip变化或迁移</p><p>2、更新发布频繁--版本迭代快</p><p>3、支持自动伸缩--大促或流量高峰</p><p>我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题，</p><p>那么，如何解决service资源名称和service资源暴露出来的集群网络IP做自动的对应呢，从而达到服务的自动发现呢？</p><p>在k8s中，coredns就是为了解决以上问题。</p><p>从coredns开始，我们采用向k8s中交付容器的方式，来部署服务，并且使用声明式的方式，来部署服务。</p><p>首先在hdss7-200上创建一个nginx虚拟主机，用来获取资源配置清单：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vi /etc/nginx/conf.d/k8s-yaml.od.com.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>coredns github地址：</p>`,17),x={href:"https://github.com/kubernetes/kubernetes/blob/master/cluster/addons/dns/coredns/coredns.yaml.base",target:"_blank",rel:"noopener noreferrer"},k=d(`<p>在hdss7-200上部署coredns：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># cd /data/k8s-yaml/coredns
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+m+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>可以看到我们没有手动添加任何解析记录，我们nginx-dp的service资源的IP，已经被解析了：</p><figure><img src="'+o+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>那么为什么呢？</p>',35),h={href:"http://ccnuo.com/2019/08/25/CoreDNS%EF%BC%9AKubernetes%E5%86%85%E9%83%A8%E5%9F%9F%E5%90%8D%E8%A7%A3%E6%9E%90%E5%8E%9F%E7%90%86%E3%80%81%E5%BC%8A%E7%AB%AF%E5%8F%8A%E4%BC%98%E5%8C%96%E6%96%B9%E5%BC%8F/",target:"_blank",rel:"noopener noreferrer"},f=e("p",null,"大家可以看到，当我进入到pod内部以后，我们会发现我们的dns地址是我们的coredns地址，以及搜索域：",-1),_=e("figure",null,[e("img",{src:b,alt:"img",tabindex:"0",loading:"lazy"}),e("figcaption",null,"img")],-1),y=e("p",null,"现在，我们已经解决了在集群内部解析的问题，但是我们怎么做到在集群外部访问我们的服务呢？",-1),E=e("p",null,"接下来我们来学习k8s服务暴露。",-1);function C(A,P){const i=a("ExternalLinkIcon");return r(),c("div",null,[g,e("p",null,[e("a",x,[n("https://github.com/kubernetes/kubernetes/blob/master/cluster/addons/dns/coredns/coredns.yaml.base"),s(i)])]),k,e("p",null,[n("推荐大家了解一下coredns都做了什么："),e("a",h,[n("Kubernetes内部域名解析原理、弊端及优化方式"),s(i)])]),f,_,y,E])}const q=l(p,[["render",C],["__file","kubernetes进阶（三）服务发现-coredns.html.vue"]]);export{q as default};
