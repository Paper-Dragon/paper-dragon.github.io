import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as e}from"./app-JuDnXlF7.js";const i="/assets/907596-20180407215024091-433702120-3JhsdwK2.png",t="/assets/907596-20180407215319157-2011576019-PpVtV0Ja.png",l="/assets/907596-20180407215527740-501171157-WbxY2Hhj.png",o="/assets/907596-20180407224020893-587829372-waBekgVh.png",c="/assets/907596-20180407224119811-217734152-k8ptHJQO.png",r="/assets/907596-20180407224246905-832890893-jKjJDFpB.png",p="/assets/907596-20180407224259485-817815131-wki7KKfp.png",d="/assets/907596-20180407224504255-28838527-JOL0yq5E.png",m="/assets/907596-20180407224512191-301366982-xStaeop5.png",u="/assets/907596-20180407224754246-1424015193-pCvSp8HF.png",v="/assets/907596-20180407224801293-2061544736-Lgf1ZwDn.png",b={},k=e(`<h1 id="linux下bind9之web管理-namedmanager部署" tabindex="-1"><a class="header-anchor" href="#linux下bind9之web管理-namedmanager部署"><span>Linux下Bind9之Web管理-NamedManager部署</span></a></h1><p>NamedManager 是一个基于Web的DNS管理系统，**可用来添加、调整和删除DNS的zones/records数据。**它使用Bind作为底层DNS服务，提供一个现代Ajax的Web界面，支持 IPv4和IPv6。该应用程序很稳定，在生产环境中使用没有任何问题。过多的介绍在此就不做说明了，下面说下NamedManager环境部署过程：</p><h2 id="_1-下载namedmanager的rpm安装包" tabindex="-1"><a class="header-anchor" href="#_1-下载namedmanager的rpm安装包"><span><strong>1）下载NamedManager的rpm安装包</strong></span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@dns ~<span class="token punctuation">]</span><span class="token comment"># hostname</span>
dns.kevin.cn
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-安装namedmanager" tabindex="-1"><a class="header-anchor" href="#_2-安装namedmanager"><span><strong>2）安装namedmanager</strong></span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[root@dns src]# yum install perl httpd mod_ssl mysql-server php php-intl php-ldap php-mysql php-soap php-xml
...
的安全。
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>==========================================================</p><h2 id="_3-启动named服务" tabindex="-1"><a class="header-anchor" href="#_3-启动named服务"><span><strong>3）启动named服务</strong></span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>[root@dns src]# service named start
...
......
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-设置防火墙" tabindex="-1"><a class="header-anchor" href="#_4-设置防火墙"><span><strong>4）设置防火墙</strong></span></a></h2><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>namedmanager部署机本机要么关闭iptables，要么安装如下设置：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5-访问namedmanager" tabindex="-1"><a class="header-anchor" href="#_5-访问namedmanager"><span><strong>5）访问namedmanager</strong></span></a></h2><p>访问 http://192.168.10.206/namedmanager ，<strong>默认用户名和密码（setup，setup123）</strong>。不要忘记在用户管理中修改用户名和密码。</p><figure><img src="`+i+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>接着设置API key（如下图。设置邮箱地址和API key，这个key是在上面的/etc/namedmanager/config-bind.php文件中设置的）</strong></p><figure><img src="'+t+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>添加服务器。Name Server FQDN的名称要和httpd中的ServerName一致。（如下添加部署机的主机名或者ip地址都可以）</strong></p><figure><img src="'+l+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><figure><img src="'+o+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>添加正向域名解析</strong></p><figure><img src="'+c+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>添加反向域名解析（如果有多个ip段的客户机，那么就如下图添加多个反向解析配置）</strong></p><figure><img src="'+r+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>查看正反向解析域名添加情况</strong></p><p><strong><img src="'+p+'" alt="img" loading="lazy"></strong></p><p><strong>上面已经成功添加了正反向解析域名，现在尝试添加一些域名的A记录和PTR记录</strong></p><p><strong>先添加A正向解析记录</strong></p><p><strong><img src="'+d+'" alt="img" loading="lazy"></strong></p><p><strong><img src="'+m+'" alt="img" loading="lazy"></strong></p><p><strong>由于上面在添加A正向解析的时候，已经勾选了PTR反向解析（如果没有勾选，则需要手动添加PTR反向解析记录），故这时候已经有了上面那几个域名的反向解析记录了：</strong></p><p><strong><img src="'+u+'" alt="img" loading="lazy"></strong></p><p><strong><img src="'+v+`" alt="img" loading="lazy"></strong></p><p><strong>如上，已经添加了几个正反向解析记录，现在到namedmanager部署机器本机上查看相关的正反向解析配置：</strong></p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@dns ~<span class="token punctuation">]</span><span class="token comment"># cd /var/named/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="注意一下" tabindex="-1"><a class="header-anchor" href="#注意一下"><span><strong>注意一下：</strong></span></a></h2><p>1）以上是在单机部署的BindManager服务，如果是线上环境的话，建议在多台机器上部署（至少两台机器）同样的BindManger服务，比如BindManager01、BindManager02两台机器； 2）在客户机的/etc/resolv.conf文件里将DNS地址配置成其中的一个BindManager部署机的ip地址，比如配置成BindManager01地址； 3）将BindManager01的正反向解析文件实时同步到BindManager02机器上（直接同步/var/named这个目录即可）；两台机器的BindaManger相关服务都要是启动状态。 4）如果BindManager01服务器发生故障，不能正常提供DNS解析服务。此时，可以迅速将BindManager02的ip地址修改成BindManager01的ip地址。这样就能很快的实现故障转移了。</p>`,40),g=[k];function h(f,N){return s(),a("div",null,g)}const y=n(b,[["render",h],["__file","NamedManager.html.vue"]]),I=JSON.parse('{"path":"/note-book/DNS/NamedManager.html","title":"Linux下Bind9之Web管理-NamedManager部署","lang":"zh-CN","frontmatter":{"description":"Linux下Bind9之Web管理-NamedManager部署 NamedManager 是一个基于Web的DNS管理系统，**可用来添加、调整和删除DNS的zones/records数据。**它使用Bind作为底层DNS服务，提供一个现代Ajax的Web界面，支持 IPv4和IPv6。该应用程序很稳定，在生产环境中使用没有任何问题。过多的介绍在此就...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/DNS/NamedManager.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"Linux下Bind9之Web管理-NamedManager部署"}],["meta",{"property":"og:description","content":"Linux下Bind9之Web管理-NamedManager部署 NamedManager 是一个基于Web的DNS管理系统，**可用来添加、调整和删除DNS的zones/records数据。**它使用Bind作为底层DNS服务，提供一个现代Ajax的Web界面，支持 IPv4和IPv6。该应用程序很稳定，在生产环境中使用没有任何问题。过多的介绍在此就..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-01-28T06:12:24.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-01-28T06:12:24.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Linux下Bind9之Web管理-NamedManager部署\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-01-28T06:12:24.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"1）下载NamedManager的rpm安装包","slug":"_1-下载namedmanager的rpm安装包","link":"#_1-下载namedmanager的rpm安装包","children":[]},{"level":2,"title":"2）安装namedmanager","slug":"_2-安装namedmanager","link":"#_2-安装namedmanager","children":[]},{"level":2,"title":"3）启动named服务","slug":"_3-启动named服务","link":"#_3-启动named服务","children":[]},{"level":2,"title":"4）设置防火墙","slug":"_4-设置防火墙","link":"#_4-设置防火墙","children":[]},{"level":2,"title":"5）访问namedmanager","slug":"_5-访问namedmanager","link":"#_5-访问namedmanager","children":[]},{"level":2,"title":"注意一下：","slug":"注意一下","link":"#注意一下","children":[]}],"git":{"createdTime":1706422344000,"updatedTime":1706422344000,"contributors":[{"name":"PaperDragon","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":8.28,"words":2485},"filePathRelative":"note-book/DNS/NamedManager.md","localizedDate":"2024年1月28日","excerpt":"\\n<p>NamedManager 是一个基于Web的DNS管理系统，**可用来添加、调整和删除DNS的zones/records数据。**它使用Bind作为底层DNS服务，提供一个现代Ajax的Web界面，支持 IPv4和IPv6。该应用程序很稳定，在生产环境中使用没有任何问题。过多的介绍在此就不做说明了，下面说下NamedManager环境部署过程：</p>\\n<h2><strong>1）下载NamedManager的rpm安装包</strong></h2>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code><span class=\\"token punctuation\\">[</span>root@dns ~<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># hostname</span>\\ndns.kevin.cn\\n \\n<span class=\\"token punctuation\\">[</span>root@dns named<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># cat /etc/hosts</span>\\n<span class=\\"token number\\">127.0</span>.0.1   localhost localhost.localdomain localhost4 localhost4.localdomain4\\n::1         localhost localhost.localdomain localhost6 localhost6.localdomain6\\n<span class=\\"token number\\">192.168</span>.10.206 dns.kevin.cn\\n \\n<span class=\\"token punctuation\\">[</span>root@dns ~<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># ifconfig |grep 192.168</span>\\n          inet addr:192.168.10.206  Bcast:192.168.10.255  Mask:255.255.255.0\\n \\n<span class=\\"token punctuation\\">[</span>root@dns named<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># ping dns.kevin.cn</span>\\nPING dns.kevin.cn <span class=\\"token punctuation\\">(</span><span class=\\"token number\\">192.168</span>.10.206<span class=\\"token punctuation\\">)</span> <span class=\\"token number\\">56</span><span class=\\"token punctuation\\">(</span><span class=\\"token number\\">84</span><span class=\\"token punctuation\\">)</span> bytes of data.\\n<span class=\\"token number\\">64</span> bytes from dns.kevin.cn <span class=\\"token punctuation\\">(</span><span class=\\"token number\\">192.168</span>.10.206<span class=\\"token punctuation\\">)</span>: <span class=\\"token assign-left variable\\">icmp_seq</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">1</span> <span class=\\"token assign-left variable\\">ttl</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">64</span> <span class=\\"token assign-left variable\\">time</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">0.027</span> ms\\n<span class=\\"token number\\">64</span> bytes from dns.kevin.cn <span class=\\"token punctuation\\">(</span><span class=\\"token number\\">192.168</span>.10.206<span class=\\"token punctuation\\">)</span>: <span class=\\"token assign-left variable\\">icmp_seq</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">2</span> <span class=\\"token assign-left variable\\">ttl</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">64</span> <span class=\\"token assign-left variable\\">time</span><span class=\\"token operator\\">=</span><span class=\\"token number\\">0.043</span> ms\\n<span class=\\"token punctuation\\">..</span><span class=\\"token punctuation\\">..</span><span class=\\"token punctuation\\">..</span>\\n  \\n<span class=\\"token punctuation\\">[</span>root@dns ~<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># cd /usr/local/src/</span>\\n<span class=\\"token punctuation\\">[</span>root@dns src<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># wget http://repos.jethrocarr.com/pub/amberdms/linux/centos/6/amberdms-custom/i386/namedmanager-bind-1.8.0-1.el6.noarch.rpm</span>\\n<span class=\\"token punctuation\\">[</span>root@dns src<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># wget http://repos.jethrocarr.com/pub/amberdms/linux/centos/6/amberdms-custom/i386/namedmanager-www-1.8.0-1.el6.noarch.rpm</span>\\n  \\n<span class=\\"token punctuation\\">[</span>root@dns src<span class=\\"token punctuation\\">]</span><span class=\\"token comment\\"># ll</span>\\ntotal <span class=\\"token number\\">1352</span>\\n-rw-r--r--. <span class=\\"token number\\">1</span> root root  <span class=\\"token number\\">109584</span> Dec <span class=\\"token number\\">22</span>  <span class=\\"token number\\">2013</span> namedmanager-bind-1.8.0-1.el6.noarch.rpm\\n-rw-r--r--. <span class=\\"token number\\">1</span> root root <span class=\\"token number\\">1270108</span> Dec <span class=\\"token number\\">22</span>  <span class=\\"token number\\">2013</span> namedmanager-www-1.8.0-1.el6.noarch.rpm\\n</code></pre></div>","autoDesc":true}');export{y as comp,I as data};
