import{_ as a}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,e as n}from"./app-zQGmJfuc.js";const r={},i=n(`<h1 id="samba配置举例" tabindex="-1"><a class="header-anchor" href="#samba配置举例" aria-hidden="true">#</a> Samba配置举例</h1><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>YOUR-SHARE-NAME<span class="token punctuation">]</span>
