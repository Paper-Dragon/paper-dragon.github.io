import{_ as t}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o,c as l,b as s,d as n,a as i,e as a}from"./app-CNBuK_I0.js";const c={},r=a(`<h1 id="nginx配置示例" tabindex="-1"><a class="header-anchor" href="#nginx配置示例" aria-hidden="true">#</a> Nginx配置示例</h1><h2 id="book-itrusts-top-conf" tabindex="-1"><a class="header-anchor" href="#book-itrusts-top-conf" aria-hidden="true">#</a> book.itrusts.top.conf</h2><pre><code>server {
    listen 80;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>我最近也被这个问题折腾了一遍。 不过我的解决办法比较野蛮 ，</p><p>sed -i &#39;s|#DefaultLimitNOFILE=|DefaultLimitNOFILE=65535|g&#39; /etc/systemd/system.conf</p><p>还有一个办法就是不直接修改service， 使用 systemctl edit xxxx.service 进行参数覆盖</p><h2 id="日志轮转切割" tabindex="-1"><a class="header-anchor" href="#日志轮转切割" aria-hidden="true">#</a> 日志轮转切割</h2><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">http</span></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="log文件记录请求url" tabindex="-1"><a class="header-anchor" href="#log文件记录请求url" aria-hidden="true">#</a> log文件记录请求url</h2>`,17),b={href:"https://so.csdn.net/so/search?q=nginx&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},h=a(`<div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>log_format main escape<span class="token operator">=</span>json  <span class="token char">&#39;{&#39;</span>
...
server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="log文件记录返回body和header" tabindex="-1"><a class="header-anchor" href="#log文件记录返回body和header" aria-hidden="true">#</a> log文件记录返回body和header</h2><p>① body：body数据需要在body_filter_by_lua_block阶段中手动赋值， 读取response body中的数据赋值给 $response_body 变量</p><p>② header：response header数据获取方式，同request header的获取方式一致。</p><p>完整配置如下</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>log_format main escape<span class="token operator">=</span>json  <span class="token char">&#39;{&#39;</span>
                                <span class="token char">&#39;&quot;host&quot;: &quot;$host&quot;,&#39;</span>
                                <span class="token char">&#39;&quot;request&quot;: &quot;$request&quot;,&#39;</span>
                                &#39;<span class="token string">&quot;request_header&quot;</span><span class="token operator">:</span> <span class="token string">&quot;$request_header&quot;</span><span class="token punctuation">,</span>&#39;
                                <span class="token char">&#39;&quot;request_body&quot;: &quot;$request_body&quot;,&#39;</span>
...
server <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nginx实现记录mine-qubic-li的所有请求信息" tabindex="-1"><a class="header-anchor" href="#nginx实现记录mine-qubic-li的所有请求信息" aria-hidden="true">#</a> Nginx实现记录mine.qubic.li的所有请求信息</h2><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>
...
http <span class="token punctuation">{</span>
    ...
    #<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,11);function f(w,q){const e=p("ExternalLinkIcon");return o(),l("div",null,[r,s("p",null,[s("a",d,[n("为CentOS/RHEL等发行版中的systemd服务配置ulimit限制 - 知乎 (zhihu.com)"),i(e)])]),u,s("p",null,[n("那么问题来了：对于"),v,n("，到底是否依旧沿用PAM模块实现资源限制呢？我在RedHat Bugzilla找到了Systemd最初被引入时的一篇Ticket："),s("a",k,[n("Bug 754285 - Hint that /etc/security/limits.conf does not apply to systemd services"),i(e)]),n("。帖子中提到了一模一样的问题。Systemd的作者之一Kay Sievers当时给与了以下回复：")]),m,s("p",null,[n("配置"),s("a",b,[n("nginx"),i(e)]),n("配置文件default.conf ，使用nginx内置变量 $host 和$request即可获得url数据")]),h,s("h2",g,[y,n(" log文件记录请求body和"),s("a",_,[n("header"),i(e)])]),x])}const S=t(c,[["render",f],["__file","nginx配置示例.html.vue"]]);export{S as default};
