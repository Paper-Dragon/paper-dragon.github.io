import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,d as t}from"./app-DtaQ5gOC.js";const e="/assets/image-20201119172023747-BLYixw2r.png",p="/assets/image-20201119172557560-CTZaX4oQ.png",i="/assets/image-20201119174456690-yAAtKXXu.png",o="/assets/image-20201119174747564-AvwZ-ZIg.png",c="/assets/image-20201119180244607-Ck2EUwof.png",l="/assets/image-20201119180544806-D2YT3uLl.png",u="/assets/image-20201119181842503-DEB6ZtGF.png",d="/assets/image-20201119182825369-Q5ATn9Ny.png",r={},k=t(`<h1 id="_002-pyqt基本ui" tabindex="-1"><a class="header-anchor" href="#_002-pyqt基本ui"><span>002-PyQt基本UI</span></a></h1><h2 id="一、第一个pyqt程序" tabindex="-1"><a class="header-anchor" href="#一、第一个pyqt程序"><span>一、第一个PyQt程序</span></a></h2><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行上述代码的效果如下：</p><figure><img src="`+e+'" alt="image-20201119172023747" tabindex="0" loading="lazy"><figcaption>image-20201119172023747</figcaption></figure><p>程序解释说明：</p><figure><img src="'+p+`" alt="image-20201119172557560" tabindex="0" loading="lazy"><figcaption>image-20201119172557560</figcaption></figure><h2 id="二、模块介绍" tabindex="-1"><a class="header-anchor" href="#二、模块介绍"><span>二、模块介绍</span></a></h2><p>PyQt中有非常多的功能模块,开发中最常用的功能模块主要有三个:</p><ul><li><strong>QtCore</strong>:包含了核心的非GUI的功能。主要和时间、文件与文件夹、各种数据、流、URLs、mime类文件、进程与线程一起使用</li><li><strong>QtGui</strong>:包含了窗口系统、事件处理、2D图像、基本绘画、字体和文字类</li><li><strong>QtWidgets</strong>:包含了一些列创建桌面应用的UI元素</li></ul><p>可以参考PyQt官网的所有模块，地址：https://www.riverbankcomputing.com/static/Docs/PyQt5/module_index.html#ref-module-index</p><p>C++具体实现的API文档，地址：https://doc.qt.io/qt-5/qtwidgets-module.html</p><p><strong>用到什么功能就它相关的api或者别人分享的使用心得，这是学习最快的方式</strong></p><h2 id="三、基本ui" tabindex="-1"><a class="header-anchor" href="#三、基本ui"><span>三、基本UI</span></a></h2><p>窗口内的所有控件，若想在窗口中显示，都需要表示它的父亲是谁，而不能直接使用 show 函数显示</p><h3 id="_1-按钮" tabindex="-1"><a class="header-anchor" href="#_1-按钮"><span>1. 按钮</span></a></h3><p>按钮对应的控件名称为 <code> QPushButton</code> ， 位于 <code>PyQt5.QtWidgets</code> 里面</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># 程序进行循环等待状态</span>
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行效果：</p><figure><img src="`+i+`" alt="image-20201119174456690" tabindex="0" loading="lazy"><figcaption>image-20201119174456690</figcaption></figure><h3 id="_2-文本" tabindex="-1"><a class="header-anchor" href="#_2-文本"><span>2. 文本</span></a></h3><p>纯文本控件名称为 <code> QLabel</code> ， 位于 <code>PyQt5.QtWidgets</code> 里面</p><p>纯文本控件仅仅作为标识显示而已，类似输入内容前的一段标签提示（账号 、密码）</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># 程序进行循环等待状态</span>
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行效果：</p><figure><img src="`+l+`" alt="image-20201119180544806" tabindex="0" loading="lazy"><figcaption>image-20201119180544806</figcaption></figure><h3 id="_5-窗口显示在屏幕的中间" tabindex="-1"><a class="header-anchor" href="#_5-窗口显示在屏幕的中间"><span>5. 窗口显示在屏幕的中间</span></a></h3><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># 程序进行循环等待状态</span>
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不在中央的样子</p><figure><img src="`+u+'" alt="image-20201119181842503" tabindex="0" loading="lazy"><figcaption>image-20201119181842503</figcaption></figure><p>在中央的样子</p><figure><img src="'+d+`" alt="image-20201119182825369" tabindex="0" loading="lazy"><figcaption>image-20201119182825369</figcaption></figure><h3 id="_6-设置窗口icon" tabindex="-1"><a class="header-anchor" href="#_6-设置窗口icon"><span>6. 设置窗口icon</span></a></h3><p>可以下载icon图标网站：https://www.easyicon.net/</p><div class="language-python line-numbers-mode" data-ext="py" data-title="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,44),m=[k];function v(b,g){return s(),a("div",null,m)}const _=n(r,[["render",v],["__file","002-PyQt基本UI.html.vue"]]),w=JSON.parse(`{"path":"/PyQt5%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B-%E7%8E%8B%E9%93%AD%E4%B8%9C/002-PyQt%E5%9F%BA%E6%9C%ACUI.html","title":"002-PyQt基本UI","lang":"zh-CN","frontmatter":{"description":"002-PyQt基本UI 一、第一个PyQt程序 运行上述代码的效果如下： image-20201119172023747image-20201119172023747 程序解释说明： image-20201119172557560image-20201119172557560 二、模块介绍 PyQt中有非常多的功能模块,开发中最常用的功能模块主要有三...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/PyQt5%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B-%E7%8E%8B%E9%93%AD%E4%B8%9C/002-PyQt%E5%9F%BA%E6%9C%ACUI.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"002-PyQt基本UI"}],["meta",{"property":"og:description","content":"002-PyQt基本UI 一、第一个PyQt程序 运行上述代码的效果如下： image-20201119172023747image-20201119172023747 程序解释说明： image-20201119172557560image-20201119172557560 二、模块介绍 PyQt中有非常多的功能模块,开发中最常用的功能模块主要有三..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-10-29T12:02:01.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2023-10-29T12:02:01.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"002-PyQt基本UI\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-10-29T12:02:01.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"一、第一个PyQt程序","slug":"一、第一个pyqt程序","link":"#一、第一个pyqt程序","children":[]},{"level":2,"title":"二、模块介绍","slug":"二、模块介绍","link":"#二、模块介绍","children":[]},{"level":2,"title":"三、基本UI","slug":"三、基本ui","link":"#三、基本ui","children":[{"level":3,"title":"1. 按钮","slug":"_1-按钮","link":"#_1-按钮","children":[]},{"level":3,"title":"2. 文本","slug":"_2-文本","link":"#_2-文本","children":[]},{"level":3,"title":"3. 输入框","slug":"_3-输入框","link":"#_3-输入框","children":[]},{"level":3,"title":"4. 调整窗口大小","slug":"_4-调整窗口大小","link":"#_4-调整窗口大小","children":[]},{"level":3,"title":"5. 窗口显示在屏幕的中间","slug":"_5-窗口显示在屏幕的中间","link":"#_5-窗口显示在屏幕的中间","children":[]},{"level":3,"title":"6. 设置窗口icon","slug":"_6-设置窗口icon","link":"#_6-设置窗口icon","children":[]}]}],"git":{"createdTime":1698580921000,"updatedTime":1698580921000,"contributors":[{"name":"PaperDragon","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":3.42,"words":1027},"filePathRelative":"PyQt5快速上手-王铭东/002-PyQt基本UI.md","localizedDate":"2023年10月29日","excerpt":"\\n<h2>一、第一个PyQt程序</h2>\\n<div class=\\"language-python\\" data-ext=\\"py\\" data-title=\\"py\\"><pre class=\\"language-python\\"><code><span class=\\"token keyword\\">import</span> sys\\n\\n<span class=\\"token keyword\\">from</span> PyQt5<span class=\\"token punctuation\\">.</span>QtWidgets <span class=\\"token keyword\\">import</span> QApplication<span class=\\"token punctuation\\">,</span> QWidget\\n\\n<span class=\\"token keyword\\">if</span> __name__ <span class=\\"token operator\\">==</span> <span class=\\"token string\\">'__main__'</span><span class=\\"token punctuation\\">:</span>\\n    app <span class=\\"token operator\\">=</span> QApplication<span class=\\"token punctuation\\">(</span>sys<span class=\\"token punctuation\\">.</span>argv<span class=\\"token punctuation\\">)</span>\\n\\n    w <span class=\\"token operator\\">=</span> QWidget<span class=\\"token punctuation\\">(</span><span class=\\"token punctuation\\">)</span>\\n\\n    <span class=\\"token comment\\"># 设置窗口标题</span>\\n    w<span class=\\"token punctuation\\">.</span>setWindowTitle<span class=\\"token punctuation\\">(</span><span class=\\"token string\\">\\"第一个PyQt\\"</span><span class=\\"token punctuation\\">)</span>\\n\\n    <span class=\\"token comment\\"># 展示窗口</span>\\n    w<span class=\\"token punctuation\\">.</span>show<span class=\\"token punctuation\\">(</span><span class=\\"token punctuation\\">)</span>\\n\\n    <span class=\\"token comment\\"># 程序进行循环等待状态</span>\\n    app<span class=\\"token punctuation\\">.</span><span class=\\"token keyword\\">exec</span><span class=\\"token punctuation\\">(</span><span class=\\"token punctuation\\">)</span>\\n</code></pre></div>","autoDesc":true}`);export{_ as comp,w as data};
