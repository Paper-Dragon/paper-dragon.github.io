import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as a,d as t}from"./app-23B57rN0.js";const e="/assets/image-20230112131250935-qMl5a6s1.png",i={},r=t('<h1 id="traefik作为docker的边缘路由" tabindex="-1"><a class="header-anchor" href="#traefik作为docker的边缘路由"><span>Traefik作为docker的边缘路由</span></a></h1><blockquote><p>即： provider为docker</p></blockquote><h2 id="方案设计" tabindex="-1"><a class="header-anchor" href="#方案设计"><span>方案设计</span></a></h2><p>流量想象成流动的水，我们的目的是把水进行分流到每个需要服务的地方，就如下图所示，我们要做的是需要利用Traefik的自动发现机制自动发现服务，然后自动注册到管道处：</p><figure><img src="'+e+`" alt="image-20230112131250935" tabindex="0" loading="lazy"><figcaption>image-20230112131250935</figcaption></figure><p>有以下几个要点：</p><ul><li>主管道： 外部nginx做第一次流量筛选，作为手动控制的开关</li><li>二级管道： Treafik，自动将水管接到服务处 <ul><li>http</li><li>tcp</li><li>udp</li></ul></li></ul><h2 id="主管道配置" tabindex="-1"><a class="header-anchor" href="#主管道配置"><span>主管道配置：</span></a></h2><blockquote><p>设计原理： 根据配置优先级，若server_name字段写一个具体的domain name，如果匹配不到则走下面的通用配置，由traefik进行域名路由和配置。</p></blockquote><div class="language-c line-numbers-mode" data-ext="c" data-title="c"><pre class="language-c"><code>    upstream default_backend_traefik <span class="token punctuation">{</span>
