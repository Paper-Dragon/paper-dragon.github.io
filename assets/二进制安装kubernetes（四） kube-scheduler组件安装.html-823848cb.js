import{_ as d}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as a,c as n,a as e,e as s,d as i,f as l}from"./app-231d24e9.js";const u={},c={id:"介绍资料转载地址-https-www-jianshu-com-p-c4c60ccda8d0",tabindex:"-1"},o=e("a",{class:"header-anchor",href:"#介绍资料转载地址-https-www-jianshu-com-p-c4c60ccda8d0","aria-hidden":"true"},"#",-1),v={href:"https://www.jianshu.com/p/c4c60ccda8d0",target:"_blank",rel:"noopener noreferrer"},b=l(`<h1 id="kube-scheduler在集群中的作用" tabindex="-1"><a class="header-anchor" href="#kube-scheduler在集群中的作用" aria-hidden="true">#</a> kube-scheduler在集群中的作用</h1><p>kube-scheduler是以插件形式存在的组件，正因为以插件形式存在，所以其具有可扩展可定制的特性。kube-scheduler相当于整个集群的调度决策者，其通过预选和优选两个过程决定容器的最佳调度位置。</p><h1 id="kube-scheduler源码中的关键性调用链" tabindex="-1"><a class="header-anchor" href="#kube-scheduler源码中的关键性调用链" aria-hidden="true">#</a> kube-scheduler源码中的关键性调用链</h1><p>![img](二进制安装kubernetes（四） kube-scheduler组件安装.assets/webp-16918409243531.webp)</p><p>kube-scheduler部署在hdss7-21,22上：</p><p>创建启动脚本：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># vi /opt/kubernetes/server/bin/kube-scheduler.sh
