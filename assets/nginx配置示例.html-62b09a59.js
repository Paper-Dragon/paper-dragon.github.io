import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as o,a as n,e as s,d as i,f as a}from"./app-8bb3cc4f.js";const p={},d=a(`<h1 id="nginx配置示例" tabindex="-1"><a class="header-anchor" href="#nginx配置示例" aria-hidden="true">#</a> Nginx配置示例</h1><h2 id="book-itrusts-top-conf" tabindex="-1"><a class="header-anchor" href="#book-itrusts-top-conf" aria-hidden="true">#</a> book.itrusts.top.conf</h2><pre><code>server {
    listen 80;
...
<span class="token macro property"><span class="token directive-hash">#</span>       <span class="token directive keyword">limit</span><span class="token expression">_rate_after <span class="token number">10240</span><span class="token punctuation">;</span> # 允许超速多少</span></span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,17),r={id:"nginx-实现偷站windy-com",tabindex:"-1"},v=n("a",{class:"header-anchor",href:"#nginx-实现偷站windy-com","aria-hidden":"true"},"#",-1),u={href:"http://xn--Windy-lj4h897dq67bnqn.com",target:"_blank",rel:"noopener noreferrer"},m=a(`<div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">user</span> www-data</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">worker_processes</span>  auto</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function _(x,w){const e=l("ExternalLinkIcon");return c(),o("div",null,[d,n("h2",r,[v,s(" Nginx "),n("a",u,[s("实现偷站Windy.com"),i(e)])]),m,n("p",null,[n("a",k,[s("为CentOS/RHEL等发行版中的systemd服务配置ulimit限制 - 知乎 (zhihu.com)"),i(e)])]),b,n("p",null,[s("那么问题来了：对于"),h,s("，到底是否依旧沿用PAM模块实现资源限制呢？我在RedHat Bugzilla找到了Systemd最初被引入时的一篇Ticket："),n("a",g,[s("Bug 754285 - Hint that /etc/security/limits.conf does not apply to systemd services"),i(e)]),s("。帖子中提到了一模一样的问题。Systemd的作者之一Kay Sievers当时给与了以下回复：")]),y])}const S=t(p,[["render",_],["__file","nginx配置示例.html.vue"]]);export{S as default};
