import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o,c as t,d}from"./app-C_8IUMwm.js";const a={},n=d(`<h1 id="date-显示或设置时间" tabindex="-1"><a class="header-anchor" href="#date-显示或设置时间"><span>date 显示或设置时间</span></a></h1><h2 id="显示时间" tabindex="-1"><a class="header-anchor" href="#显示时间"><span>显示时间</span></a></h2><p>按照我们要求的格式显示当前日期: 年-月-日</p><pre><code>2019-04-10
