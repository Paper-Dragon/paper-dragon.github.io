import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,f as e}from"./app-8bb3cc4f.js";const l={},o=e(`<h1 id="journal日志服务详解" tabindex="-1"><a class="header-anchor" href="#journal日志服务详解" aria-hidden="true">#</a> Journal日志服务详解</h1><h2 id="journal日志服务" tabindex="-1"><a class="header-anchor" href="#journal日志服务" aria-hidden="true">#</a> Journal日志服务</h2><blockquote><p>journalctl 用来查询 systemd-journald 服务收集到的日志。systemd-journald 服务是 systemd init 系统提供的收集系统日志的服务。</p></blockquote><p>常用命令行</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>journalctl 查看所有日志
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="配置文件参数详解" tabindex="-1"><a class="header-anchor" href="#配置文件参数详解" aria-hidden="true">#</a> 配置文件参数详解</h2><blockquote><p>配置文件所在位置：/etc/systemd/journald.conf默认状态所有选项均为注释状态</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>Journal<span class="token punctuation">]</span>
