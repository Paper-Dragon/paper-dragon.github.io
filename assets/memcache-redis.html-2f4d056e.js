import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,f as e}from"./app-015c2308.js";const i="/assets/image-20211117093651109-af207778.png",t="/assets/image-20211117094009409-8e338107.png",p="/assets/image-20211117100128558-f161c9c7.png",o="/assets/image-20211117100243328-e9e6aa44.png",l="/assets/image-20211117101044738-9265e230.png",c="/assets/image-20211117101741080-bd9b5711.png",r="/assets/image-20211117102324814-072fcb80.png",d="/assets/image-20211117102405840-4a96baac.png",u="/assets/image-20211117102501293-729cfcba.png",m="/assets/1200-0ea65991.png",v="/assets/1200-16371342662862-ef2d3646.png",k="/assets/1200-16371365201854-1c58612a.png",b="/assets/image-20211117160047246-626e5198.png",g="/assets/image-20211117160104710-d1fd47fa.png",h="/assets/image-20211117160310357-6874771a.png",f="/assets/image-20211117160340557-c2f933f2.png",y="/assets/image-20211117160428838-51ffd516.png",q="/assets/image-20211117160445302-cb54be9b.png",_="/assets/image-20211117160708876-f148ce33.png",x={},w=e('<h1 id="memcache-redis缓解数据库压力" tabindex="-1"><a class="header-anchor" href="#memcache-redis缓解数据库压力" aria-hidden="true">#</a> Memcache-Redis缓解数据库压力</h1><h1 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h1><figure><img src="'+i+'" alt="image-20211117093651109" tabindex="0" loading="lazy"><figcaption>image-20211117093651109</figcaption></figure><h1 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h1><h2 id="缓存服务器作用" tabindex="-1"><a class="header-anchor" href="#缓存服务器作用" aria-hidden="true">#</a> 缓存服务器作用</h2><p>加快访问速度，缓解数据库压力</p><h2 id="nosql" tabindex="-1"><a class="header-anchor" href="#nosql" aria-hidden="true">#</a> NoSQL</h2><p>net only sql</p><figure><img src="'+t+'" alt="image-20211117094009409" tabindex="0" loading="lazy"><figcaption>image-20211117094009409</figcaption></figure><h2 id="nosql产品" tabindex="-1"><a class="header-anchor" href="#nosql产品" aria-hidden="true">#</a> nosql产品</h2><p>redis</p><p>memcached</p><p>mongodb</p><h1 id="memcached" tabindex="-1"><a class="header-anchor" href="#memcached" aria-hidden="true">#</a> memcached</h1><h2 id="特点" tabindex="-1"><a class="header-anchor" href="#特点" aria-hidden="true">#</a> 特点</h2><p><strong>内置内存存储方式</strong> : 重启操作系统导致数据全部丢失</p><p><strong>key/value</strong> : 服务器不需要关心数据本身的意义和结构，只要是可序列化数据即可。存储由键、过期时间、可选标志及数据四个部分组成</p><p><strong>不互相通信的分布式</strong> :</p><figure><img src="'+p+'" alt="image-20211117100128558" tabindex="0" loading="lazy"><figcaption>image-20211117100128558</figcaption></figure><h2 id="支持的平台" tabindex="-1"><a class="header-anchor" href="#支持的平台" aria-hidden="true">#</a> 支持的平台</h2><p>多平台支持</p><h2 id="服务框架" tabindex="-1"><a class="header-anchor" href="#服务框架" aria-hidden="true">#</a> 服务框架</h2><figure><img src="'+o+`" alt="image-20211117100243328" tabindex="0" loading="lazy"><figcaption>image-20211117100243328</figcaption></figure><h2 id="实施" tabindex="-1"><a class="header-anchor" href="#实施" aria-hidden="true">#</a> 实施</h2><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> memchched <span class="token parameter variable">-y</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="redis-sentinel-哨兵模式" tabindex="-1"><a class="header-anchor" href="#redis-sentinel-哨兵模式" aria-hidden="true">#</a> redis-sentinel---哨兵模式</h2><p><strong>1、哨兵简介:Redis Sentinel</strong></p><blockquote><p>Sentinel(哨兵)是用于监控redis集群中Master状态的工具，其已经被集成在redis2.4+的版本中是Redis官方推荐的高可用性(HA)解决方案。</p></blockquote><p><strong>2、作用</strong></p><blockquote><p>1)：Master状态检测<br> 2)：如果Master异常，则会进行Master-Slave切换，将其中一个Slave作为Master，将之前的Master作为Slave<br> 3)：Master-Slave切换后，master_redis.conf、slave_redis.conf和sentinel.conf的内容都会发生改变，即master_redis.conf中会多一行slaveof的配置，sentinel.conf的监控目标会随之调换</p></blockquote><p><strong>3、工作模式</strong></p><blockquote><p>1)：每个Sentinel以每秒钟一次的频率向它所知的Master，Slave以及其他 Sentinel 实例发送一个 PING 命令<br> 2)：如果一个实例（instance）距离最后一次有效回复 PING 命令的时间超过 down-after-milliseconds 选项所指定的值， 则这个实例会被 Sentinel 标记为主观下线。<br> 3)：如果一个Master被标记为主观下线，则正在监视这个Master的所有 Sentinel 要以每秒一次的频率确认Master的确进入了主观下线状态。<br> 4)：当有足够数量的 Sentinel（大于等于配置文件指定的值）在指定的时间范围内确认Master的确进入了主观下线状态， 则Master会被标记为客观下线</p></blockquote><p><strong>4、主观下线和客观下线</strong></p><blockquote><p>主观下线：Subjectively Down，简称 SDOWN，指的是当前 Sentinel 实例对某个redis服务器做出的下线判断。<br> 客观下线：Objectively Down， 简称 ODOWN，指的是多个 Sentinel 实例在对Master Server做出 SDOWN 判断，并且通过 SENTINEL is-master-down-by-addr 命令互相交流之后，得出的Master Server下线判断，然后开启failover</p></blockquote><p><strong>5、配置哨兵模式</strong></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token number">1</span>.每台机器上修改redis主配置文件redis.conf文件设置：bind <span class="token number">0.0</span>.0.0   ---已经操作
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="课外资料" tabindex="-1"><a class="header-anchor" href="#课外资料" aria-hidden="true">#</a> 课外资料</h2><figure><img src="`+b+'" alt="image-20211117160047246" tabindex="0" loading="lazy"><figcaption>image-20211117160047246</figcaption></figure><figure><img src="'+g+'" alt="image-20211117160104710" tabindex="0" loading="lazy"><figcaption>image-20211117160104710</figcaption></figure><h1 id="面试题" tabindex="-1"><a class="header-anchor" href="#面试题" aria-hidden="true">#</a> 面试题</h1><figure><img src="'+h+'" alt="image-20211117160310357" tabindex="0" loading="lazy"><figcaption>image-20211117160310357</figcaption></figure><figure><img src="'+f+'" alt="image-20211117160340557" tabindex="0" loading="lazy"><figcaption>image-20211117160340557</figcaption></figure><figure><img src="'+y+'" alt="image-20211117160428838" tabindex="0" loading="lazy"><figcaption>image-20211117160428838</figcaption></figure><figure><img src="'+q+'" alt="image-20211117160445302" tabindex="0" loading="lazy"><figcaption>image-20211117160445302</figcaption></figure><figure><img src="'+_+'" alt="image-20211117160708876" tabindex="0" loading="lazy"><figcaption>image-20211117160708876</figcaption></figure>',101),R=[w];function S($,O){return n(),a("div",null,R)}const B=s(x,[["render",S],["__file","memcache-redis.html.vue"]]);export{B as default};
