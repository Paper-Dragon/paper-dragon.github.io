import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{o as e,c as n,f as a}from"./app-231d24e9.js";const r={},i=a(`<h1 id="进程" tabindex="-1"><a class="header-anchor" href="#进程" aria-hidden="true">#</a> 进程</h1><h2 id="什么是进程" tabindex="-1"><a class="header-anchor" href="#什么是进程" aria-hidden="true">#</a> 什么是进程:</h2><p>进程:</p><p>​ 运行中的程序的一个副本，是被载入内存的一个指令集合，是资源分配的单位<br> ​ 进程ID（Process ID，PID）号码被用来标记各个进程<br> ​ UID、GID、和SELinux语境决定对文件系统的存取和访问权限<br> ​ 通常从执行进程的用户来继承<br> ​ 存在生命周期</p><h2 id="进程创建" tabindex="-1"><a class="header-anchor" href="#进程创建" aria-hidden="true">#</a> 进程创建：</h2><p>​ init：第一个进程，从 CentOS7 以后为systemd<br> ​ 进程：都由其父进程创建，fork()，父子关系，CoW：Copy On Write<br> ​ 刚创建时，共用父进程的内存，有新数据像刚创建的子进程写入时，单独开辟一个内存空间，把父进程内存复制一份给子进程做数据修改<br> ​</p><h2 id="通过pid获取运行的真实程序" tabindex="-1"><a class="header-anchor" href="#通过pid获取运行的真实程序" aria-hidden="true">#</a> 通过pid获取运行的真实程序：</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>		<span class="token operator">!</span><span class="token operator">!</span>面试题
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="物理地址空间和虚拟地址空间" tabindex="-1"><a class="header-anchor" href="#物理地址空间和虚拟地址空间" aria-hidden="true">#</a> 物理地址空间和虚拟地址空间</h2><pre><code>MMU：Memory Management Unit 负责虚拟地址转换为物理地址
...
</code></pre><h2 id="c代码和内存布局之间的对应关系" tabindex="-1"><a class="header-anchor" href="#c代码和内存布局之间的对应关系" aria-hidden="true">#</a> C代码和内存布局之间的对应关系：</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>每个进程都包括5种不同的数据段
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="进程使用内存问题" tabindex="-1"><a class="header-anchor" href="#进程使用内存问题" aria-hidden="true">#</a> 进程使用内存问题：</h2><pre><code>	内存泄漏：Memory Leak
...
</code></pre><h2 id="进程状态" tabindex="-1"><a class="header-anchor" href="#进程状态" aria-hidden="true">#</a> 进程状态：</h2><pre><code>进程更多的状态：
	运行态：running
	就绪态：ready
	睡眠态：分为两种，可中断：interruptable，不可中断：uninterruptable
	停止态：stopped，暂停于内存，但不会被调度，除非手动启动
	僵死态：zombie，僵尸态，结束进程，父进程结束前，子进程不关闭，杀死父进程可以关闭僵死态的子进程
</code></pre><h2 id="lru算法" tabindex="-1"><a class="header-anchor" href="#lru算法" aria-hidden="true">#</a> LRU算法：</h2><p>​ Least Recently Used 近期最少使用算法（喜新厌旧），释放内存</p><h2 id="ipc进程间通信" tabindex="-1"><a class="header-anchor" href="#ipc进程间通信" aria-hidden="true">#</a> IPC进程间通信：</h2><pre><code>	IPC: Inter Process Communication
...
</code></pre><p>​</p><h2 id="进程优先级" tabindex="-1"><a class="header-anchor" href="#进程优先级" aria-hidden="true">#</a> 进程优先级：</h2><pre><code>系统优先级： 0-139，数字越小，优先级越高
...
</code></pre><h2 id="io调度算法" tabindex="-1"><a class="header-anchor" href="#io调度算法" aria-hidden="true">#</a> IO调度算法：</h2><pre><code>	NOOP
	Deadline scheduler
	Anticipatory scheduler
	CFQ
	
查看系统IO算法：cat /sys/block/sda/queue/scheduler
</code></pre>`,25),o=[i];function s(c,d){return e(),n("div",null,o)}const h=t(r,[["render",s],["__file","进程.html.vue"]]);export{h as default};
