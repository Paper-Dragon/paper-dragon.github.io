import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as s,e}from"./app-uRQLGptr.js";const d={},l=e(`<h1 id="vmware各个版本的激活密钥" tabindex="-1"><a class="header-anchor" href="#vmware各个版本的激活密钥" aria-hidden="true">#</a> VMware各个版本的激活密钥</h1><p>注：如果是WinXP或32位系统请用 10.0 版本；11.0 版本之后支持Win7或更高版64位系统。</p><p>VMware 所有版本永久许可证激活密钥：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>VMware Workstation v17 <span class="token keyword">for</span> Windows
