import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as s,e as a}from"./app-AFtG9SRj.js";const i={},o=a(`<h1 id="harbor离线搭建" tabindex="-1"><a class="header-anchor" href="#harbor离线搭建" aria-hidden="true">#</a> Harbor离线搭建</h1><blockquote><p>使用离线安装包安装Harbor和</p></blockquote><h1 id="先要条件" tabindex="-1"><a class="header-anchor" href="#先要条件" aria-hidden="true">#</a> 先要条件</h1><h2 id="_1-下载haobor安装包和docker-compose安装包" tabindex="-1"><a class="header-anchor" href="#_1-下载haobor安装包和docker-compose安装包" aria-hidden="true">#</a> 1.下载haobor安装包和docker-compose安装包</h2><p>harbor载地址：http://harbor.orientsoft.cn/</p><p>本次下载后放入的目录是/home/carter，解压安装包</p><pre><code>tar xf harbor-offline-installer-v1.10.10.tgz
...
</code></pre><h1 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h1><p>环境：centos7.6</p><h2 id="_1、安装docker" tabindex="-1"><a class="header-anchor" href="#_1、安装docker" aria-hidden="true">#</a> 1、安装docker</h2><p>详情见：https://www.cnblogs.com/wukc/p/13265528.html</p><p>2、配置时区</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>timedatectl set-timezone Asia/Shanghai
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_5、harbor安装" tabindex="-1"><a class="header-anchor" href="#_5、harbor安装" aria-hidden="true">#</a> 5、harbor安装</h2><p>wget https://github.com/goharbor/harbor/releases/download/v1.10.1/harbor-offline-installer-v1.10.1.tgz #下载文件</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6、登录验证" tabindex="-1"><a class="header-anchor" href="#_6、登录验证" aria-hidden="true">#</a> 6、登录验证</h2><p>http://ip 账号密码为上面配置文件中：admin：Harbor12345</p><h2 id="_7、配置docker使用harbor仓库" tabindex="-1"><a class="header-anchor" href="#_7、配置docker使用harbor仓库" aria-hidden="true">#</a> 7、配置docker使用harbor仓库</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>修改配置文件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,39),r=[o];function l(t,c){return e(),s("div",null,r)}const v=n(i,[["render",l],["__file","Harbor离线搭建.html.vue"]]);export{v as default};
