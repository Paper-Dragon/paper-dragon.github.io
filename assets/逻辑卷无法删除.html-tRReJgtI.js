import{_ as e}from"./plugin-vue_export-helper-x3n3nnut.js";import{o,c as s,e as t}from"./app-uRQLGptr.js";const r={},d=t(`<h1 id="逻辑卷删除问题" tabindex="-1"><a class="header-anchor" href="#逻辑卷删除问题" aria-hidden="true">#</a> 逻辑卷删除问题</h1><p>存储池名称：fs2 逻辑卷名称：fs2 逻辑卷文件系统被占用(Logical volume /dev/<em>/</em> contains a filesystem in use.)</p><p>[root@f1s2001 ldnas]# lvremove -f /dev/fs2/fs2 Logical volume fs2/fs2 contains a filesystem in use.</p><h1 id="逻辑卷可能被挂载了" tabindex="-1"><a class="header-anchor" href="#逻辑卷可能被挂载了" aria-hidden="true">#</a> 逻辑卷可能被挂载了</h1><p>​ df 查看挂载详情，找到对应逻辑卷进行卸载操作后，再执行删除 ​ 若挂载信息为： ​ /dev/fs2/fs2 1038336 32996 1005340 4% /mnt ​ 执行 umount /dev/fs2/fs2 或 umount /mnt 进行卸载</p><pre><code>    若出现umount 错误：
...
</code></pre><p>之后再进行逻辑卷的删除</p>`,12),n=[d];function a(f,m){return o(),s("div",null,n)}const l=e(r,[["render",a],["__file","逻辑卷无法删除.html.vue"]]);export{l as default};
