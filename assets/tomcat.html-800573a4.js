import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as p,c as o,a,e as n,d as e,f as t}from"./app-ab61ccef.js";const r="/assets/1-f37cc7d4.png",c="/assets/image-20211110215222063-f579522e.png",d="/assets/2-1ac72b37.png",u="/assets/3-211eb0e6.png",v={},m=t(`<h1 id="tomcat构建企业级高负载服务器" tabindex="-1"><a class="header-anchor" href="#tomcat构建企业级高负载服务器" aria-hidden="true">#</a> TOMCAT构建企业级高负载服务器</h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><h3 id="什么是java虚拟机" tabindex="-1"><a class="header-anchor" href="#什么是java虚拟机" aria-hidden="true">#</a> 什么是JAVA虚拟机</h3><pre><code>所谓虚拟机，就是一台虚拟的计算机。他是一款软件，用来执行一系列虚拟计算机指令。大体上，虚拟机可以分为系统虚拟机和程序虚拟机。大名鼎鼎的VisualBox、VMware就属于系统虚拟机。他们完全是对物理计算机的仿真。提供了一个可以运行完整操作系统的软件平台。
程序虚拟机的典型代表就是Java虚拟机，它专门为执行单个计算机程序而设计，在Java虚拟机中执行的指令我们称为Java字节码指令。无论是系统虚拟机还是程序虚拟机，在上面运行的软件都呗限制于虚拟机提供的资源中。
</code></pre><h3 id="java-如何做到跨平台" tabindex="-1"><a class="header-anchor" href="#java-如何做到跨平台" aria-hidden="true">#</a> JAVA 如何做到跨平台</h3><pre><code>同一个JAVA程序(JAVA字节码的集合)，通过JAVA虚拟机(JVM)运行于各大主流操作系统平台比如Windows、CentOS、Ubuntu等。程序以虚拟机为中介，来实现跨平台。
</code></pre><figure><img src="`+r+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h2 id="tomcat部署" tabindex="-1"><a class="header-anchor" href="#tomcat部署" aria-hidden="true">#</a> Tomcat部署</h2><p>官网地址</p><pre><code>tomcat下载地址
http://tomcat.apache.org/

JDK下载地址
http://www.oracle.com/technetwork/java/javase/downloads/index.html
</code></pre><h3 id="部署" tabindex="-1"><a class="header-anchor" href="#部署" aria-hidden="true">#</a> 部署</h3><h4 id="一、tomcat-http-server" tabindex="-1"><a class="header-anchor" href="#一、tomcat-http-server" aria-hidden="true">#</a> 一、Tomcat Http Server</h4><p>环境</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>5到8G内存
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol><li>部署JAVA环境</li></ol><p>提示<br> 建议卸载默认安装openjdk软件<br> ①解压安装包</p><p>tar xf jdk-8u151-linux-x64.tar.gz -C /usr/local<br> ②多版本部署java</p><p>ln -s /usr/local/jdk1.8.0_151/ /usr/local/java</p><p>3配置环境变量</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/profile
...
<span class="token function">env</span> <span class="token operator">|</span><span class="token function">grep</span> JAVA
		<span class="token assign-left variable">JAVA_HOME</span><span class="token operator">=</span>/usr/local/java
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这里插入图片描述<br> 4测试java</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">java</span> <span class="token parameter variable">-version</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ol start="2"><li>安装Tomcat:</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">tar</span> xf apache-tomcat-7.0.42.tar.gz  <span class="token parameter variable">-C</span> /usr/local/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>定义Tomcat所需环境变量:<br> vim /etc/profile</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token assign-left variable">CATALINA_HOME</span><span class="token operator">=</span>/usr/local/tomcat    //Tomcat安装目录
<span class="token builtin class-name">export</span> CATALINA_HOME

<span class="token builtin class-name">source</span> /etc/profile
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这里插入图片描述<br> 3.启动Tomcat</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>启动tomcat
...
如nginx和apache互通时使用
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,28),b=a("br",null,null,-1),k={href:"http://192.168.0.104:8080/",target:"_blank",rel:"noopener noreferrer"},g=a("br",null,null,-1),h=a("br",null,null,-1),f=a("br",null,null,-1),j=t(`<pre><code>#bash  /usr/local/tomcat/bin/shutdown.sh
</code></pre><p>在这里插入图片描述在这里插入图片描述<br> 4.关于tomcat</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@web ~<span class="token punctuation">]</span><span class="token comment"># cd /usr/local/tomcat/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="二、安装mysql" tabindex="-1"><a class="header-anchor" href="#二、安装mysql" aria-hidden="true">#</a> 二、安装MySQL</h4><p>1.创建数据库：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>创建jspgou数据库，字符集为utf-8
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="三、部署jspgou-电子商城" tabindex="-1"><a class="header-anchor" href="#三、部署jspgou-电子商城" aria-hidden="true">#</a> 三、部署jspgou（电子商城）</h4><p>1.解压源码包<br> unzip jspgouV6-ROOT.zip在这里插入图片描述<br> 2.更改数据库链接：</p><p>提示：在解压缩后的文件中，修改连接数据库的信息</p><pre><code>[root@localhost ~]# vim ROOT/WEB-INF/config/jdbc.properties
...
密 码：123456
点击上图右上角浏览器图标访问网站首页
</code></pre><h2 id="tomcat多实例" tabindex="-1"><a class="header-anchor" href="#tomcat多实例" aria-hidden="true">#</a> Tomcat多实例</h2><p>关闭主站</p><pre><code>bash /usr/local/tomcat/bin/shutdown.sh
...
29 directories
</code></pre><p>修改端口<br> 将web配置文件拷贝三份。分别修改为不同端口</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/tomcat/instance1/conf/server.xml
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>启动脚本<br> vim /usr/local/tomcat/instance1/ins1.sh</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>vim /usr/local/tomcat/instance2/ins2.sh</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
restart<span class="token punctuation">)</span>
        ...
        <span class="token punctuation">;</span><span class="token punctuation">;</span>
<span class="token keyword">esac</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>vim /usr/local/tomcat/instance3/ins3.sh</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
...
</code></pre><h2 id="jvm常用分析工具" tabindex="-1"><a class="header-anchor" href="#jvm常用分析工具" aria-hidden="true">#</a> JVM常用分析工具</h2><figure><img src="`+c+`" alt="image-20211110215222063" tabindex="0" loading="lazy"><figcaption>image-20211110215222063</figcaption></figure><p>命令行工具</p><h3 id="jps" tabindex="-1"><a class="header-anchor" href="#jps" aria-hidden="true">#</a> jps</h3><p>Java虚拟机进程状态工具</p><pre><code>jps [options] [hostid]
  -q 显示进程ID
  -m 显示进程ID、主类名、传入主方法的参数
  -l 显示进程ID、全类名
  -v 显示进程ID、主类名、虚拟机参数
  -V 显示进程ID、主类名【默认】
</code></pre><h3 id="jstat" tabindex="-1"><a class="header-anchor" href="#jstat" aria-hidden="true">#</a> jstat</h3><p>Java虚拟机统计监控工具</p><pre><code>jstat [ generalOption | outputOptions vmid [ interval [ s|ms ] [ count ] ] ]
...
|FGCT   | full GC所使用时间|
|GCT    | 总共垃圾回收时间|
</code></pre><h3 id="jinfo" tabindex="-1"><a class="header-anchor" href="#jinfo" aria-hidden="true">#</a> jinfo</h3><p>打印配置信息【重点其实是可以动态设置虚拟机参数】</p><pre><code>jinfo [ option ] pid
  -flags 可以动态的设置或者取消或者变更JVM参数
  默认输出系统属性、JVM信息(官方目前推荐用jcmd替代jinfo，以减少影响当前进程性能)
</code></pre><p>案例</p><p>jinfo 6564(这个命令jdk1.8报各种错，暂未解决)</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>➜  ~ jinfo <span class="token number">6564</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="jmap" tabindex="-1"><a class="header-anchor" href="#jmap" aria-hidden="true">#</a> jmap</h3><p>查看堆内存信息，可以生成dump文件</p><pre><code>jmap [ option ] pid
常用如
...
</code></pre><h3 id="jhat" tabindex="-1"><a class="header-anchor" href="#jhat" aria-hidden="true">#</a> jhat</h3><p>java堆分析工具，上述dump文件可以通过这个工具进行分析。这个工具会启动一个小型http服务器，可以通过浏览器查看分析结果。JDK11已经去掉了这个工具，直接用visual vm可视化工具分析</p><p>案例</p><p>jhat heap.bin</p><pre><code>➜  ~ jhat heap.bin
...
Server is ready.
</code></pre>`,77),x={href:"http://localhost:7000/",target:"_blank",rel:"noopener noreferrer"},C=t(`<h3 id="jstack" tabindex="-1"><a class="header-anchor" href="#jstack" aria-hidden="true">#</a> jstack</h3><p>打印线程栈信息，如可用来分析死循环、死锁等</p><pre><code>jstack [ option ] pid
	-m 打印Java和C++栈信息
	-l 额外打印关于锁的信息
</code></pre><p>案例</p><p>jstack -l 7588</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>➜  ~ jstack <span class="token parameter variable">-l</span> <span class="token number">7588</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="可视化工具" tabindex="-1"><a class="header-anchor" href="#可视化工具" aria-hidden="true">#</a> 可视化工具</h3><p>jconsole</p><p>可以监控CPU、内存、线程等情况</p><p>~jconsole</p><figure><img src="`+d+`" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure><p>reference：</p><pre><code>https://docs.oracle.com/javase/8/docs/technotes/tools/unix/jps.html
...
</code></pre><h2 id="jvm运维使用监控工具" tabindex="-1"><a class="header-anchor" href="#jvm运维使用监控工具" aria-hidden="true">#</a> JVM运维使用监控工具</h2><h3 id="visual-vm" tabindex="-1"><a class="header-anchor" href="#visual-vm" aria-hidden="true">#</a> Visual VM</h3>`,15),T={href:"https://visualvm.github.io/download.html%E8%BF%99%E9%87%8C%E4%B8%8B%E8%BD%BD",target:"_blank",rel:"noopener noreferrer"},S=a("p",null,"在1.8环境下执行",-1),M=a("p",null,"~ jvisualvm",-1),A=a("figure",null,[a("img",{src:u,alt:"在这里插入图片描述",tabindex:"0",loading:"lazy"}),a("figcaption",null,"在这里插入图片描述")],-1);function _(y,w){const s=l("ExternalLinkIcon");return p(),o("div",null,[m,a("p",null,[n("访问"),b,a("a",k,[n("http://192.168.0.104:8080/"),e(s)]),g,n(" 注意服务器地址，注意端口"),h,n(" 浏览器访问tomcat主页。注意关闭防火墙"),f,n(" 关闭tomcat（切记，否则你会遇见500）")]),j,a("p",null,[n("打开浏览器，"),a("a",x,[n("http://localhost:7000/"),e(s)]),n(" 即可看到分析信息")]),C,a("p",null,[n("Visual VM是一款All-in-One的Java分析工具，堆栈信息、线程信息等都可以分析，而且还支持装插件。但jdk1.9之后默认JDK不再支持，可以通过"),a("a",T,[n("https://visualvm.github.io/download.html这里下载"),e(s)])]),S,M,A])}const O=i(v,[["render",_],["__file","tomcat.html.vue"]]);export{O as default};
