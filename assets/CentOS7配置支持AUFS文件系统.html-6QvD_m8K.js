import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as e,c as n,e as a}from"./app-KTtNSx6m.js";const o="/assets/image-20220922155758884-2BKBZ0rV.png",c={},i=a(`<h1 id="使得内核支持aufs" tabindex="-1"><a class="header-anchor" href="#使得内核支持aufs" aria-hidden="true">#</a> 使得内核支持AUFS</h1><p>CentOS7 默认不支持<code>aufs</code>文件系统, 有时候我们需要使用, 就必须自己去安装内核了</p><ol><li>添加<code>yum</code>源</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 进入repo目录</span>
