import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o,c,a as n,e as s,d as t,f as e}from"./app-11b06613.js";const l="/assets/image-20201119172023747-bd62fcc0.png",u="/assets/image-20201119172557560-b42d7999.png",d="/assets/image-20201119174456690-2f62fb33.png",r="/assets/image-20201119174747564-34938174.png",k="/assets/image-20201119180244607-b04eac0d.png",m="/assets/image-20201119180544806-4ab57c86.png",v="/assets/image-20201119181842503-c102959d.png",b="/assets/image-20201119182825369-c9aa3264.png",g={},y=e(`<h1 id="_002-pyqt基本ui" tabindex="-1"><a class="header-anchor" href="#_002-pyqt基本ui" aria-hidden="true">#</a> 002-PyQt基本UI</h1><h2 id="一、第一个pyqt程序" tabindex="-1"><a class="header-anchor" href="#一、第一个pyqt程序" aria-hidden="true">#</a> 一、第一个PyQt程序</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行上述代码的效果如下：</p><figure><img src="`+l+'" alt="image-20201119172023747" tabindex="0" loading="lazy"><figcaption>image-20201119172023747</figcaption></figure><p>程序解释说明：</p><figure><img src="'+u+'" alt="image-20201119172557560" tabindex="0" loading="lazy"><figcaption>image-20201119172557560</figcaption></figure><h2 id="二、模块介绍" tabindex="-1"><a class="header-anchor" href="#二、模块介绍" aria-hidden="true">#</a> 二、模块介绍</h2><p>PyQt中有非常多的功能模块,开发中最常用的功能模块主要有三个:</p><ul><li><strong>QtCore</strong>:包含了核心的非GUI的功能。主要和时间、文件与文件夹、各种数据、流、URLs、mime类文件、进程与线程一起使用</li><li><strong>QtGui</strong>:包含了窗口系统、事件处理、2D图像、基本绘画、字体和文字类</li><li><strong>QtWidgets</strong>:包含了一些列创建桌面应用的UI元素</li></ul>',10),h={href:"https://www.riverbankcomputing.com/static/Docs/PyQt5/module_index.html#ref-module-index",target:"_blank",rel:"noopener noreferrer"},_={href:"https://doc.qt.io/qt-5/qtwidgets-module.html",target:"_blank",rel:"noopener noreferrer"},w=e(`<p><strong>用到什么功能就它相关的api或者别人分享的使用心得，这是学习最快的方式</strong></p><h2 id="三、基本ui" tabindex="-1"><a class="header-anchor" href="#三、基本ui" aria-hidden="true">#</a> 三、基本UI</h2><p>窗口内的所有控件，若想在窗口中显示，都需要表示它的父亲是谁，而不能直接使用 show 函数显示</p><h3 id="_1-按钮" tabindex="-1"><a class="header-anchor" href="#_1-按钮" aria-hidden="true">#</a> 1. 按钮</h3><p>按钮对应的控件名称为 <code> QPushButton</code> ， 位于 <code>PyQt5.QtWidgets</code> 里面</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># 程序进行循环等待状态</span>
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行效果：</p><figure><img src="`+d+`" alt="image-20201119174456690" tabindex="0" loading="lazy"><figcaption>image-20201119174456690</figcaption></figure><h3 id="_2-文本" tabindex="-1"><a class="header-anchor" href="#_2-文本" aria-hidden="true">#</a> 2. 文本</h3><p>纯文本控件名称为 <code> QLabel</code> ， 位于 <code>PyQt5.QtWidgets</code> 里面</p><p>纯文本控件仅仅作为标识显示而已，类似输入内容前的一段标签提示（账号 、密码）</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    <span class="token comment"># 程序进行循环等待状态</span>
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不在中央的样子</p><figure><img src="`+v+'" alt="image-20201119181842503" tabindex="0" loading="lazy"><figcaption>image-20201119181842503</figcaption></figure><p>在中央的样子</p><figure><img src="'+b+'" alt="image-20201119182825369" tabindex="0" loading="lazy"><figcaption>image-20201119182825369</figcaption></figure><h3 id="_6-设置窗口icon" tabindex="-1"><a class="header-anchor" href="#_6-设置窗口icon" aria-hidden="true">#</a> 6. 设置窗口icon</h3>',30),Q={href:"https://www.easyicon.net/",target:"_blank",rel:"noopener noreferrer"},f=e(`<div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">import</span> sys
...
<span class="token keyword">if</span> __name__ <span class="token operator">==</span> <span class="token string">&#39;__main__&#39;</span><span class="token punctuation">:</span>
    ...
    app<span class="token punctuation">.</span><span class="token keyword">exec</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,1);function x(W,q){const a=i("ExternalLinkIcon");return o(),c("div",null,[y,n("p",null,[s("可以参考PyQt官网的所有模块，地址："),n("a",h,[s("https://www.riverbankcomputing.com/static/Docs/PyQt5/module_index.html#ref-module-index"),t(a)])]),n("p",null,[s("C++具体实现的API文档，地址："),n("a",_,[s("https://doc.qt.io/qt-5/qtwidgets-module.html"),t(a)])]),w,n("p",null,[s("可以下载icon图标网站："),n("a",Q,[s("https://www.easyicon.net/"),t(a)])]),f])}const L=p(g,[["render",x],["__file","002-PyQt基本UI.html.vue"]]);export{L as default};
