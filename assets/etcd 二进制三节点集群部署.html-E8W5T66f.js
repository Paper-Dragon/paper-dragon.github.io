...
# cd /opt/src
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>下载etcd组件：</p><p>地址：https://github.com/etcd-io/etcd/tags</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># wget https://github.com/etcd-io/etcd/releases/download/v3.2.28/etcd-v3.2.28-linux-amd64.tar.gz
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,33),l=[i];function c(p,d){return n(),e("div",null,l)}const u=s(t,[["render",c],["__file","etcd 二进制三节点集群部署.html.vue"]]);export{u as default};
