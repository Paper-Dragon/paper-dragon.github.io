import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as n,d as o}from"./app-Bul9S3YU.js";const i={},r=o(`<h1 id="centos7-yum-install-git2-x-较新版本" tabindex="-1"><a class="header-anchor" href="#centos7-yum-install-git2-x-较新版本"><span>Centos7 yum install git2.x(较新版本)</span></a></h1><p>centos7 默认的git版本是1.8.x</p><pre><code># git --version
git version 1.8.3.1
