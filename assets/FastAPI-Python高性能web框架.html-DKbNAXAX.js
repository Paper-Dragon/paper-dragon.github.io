...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Pydantic是一个基于Python类型提示来定义数据验证，序列化和文档（使用JSON模式）库</p><p>Starlette是一个轻量级的ASGI框架/工具包，是构建高性能Asyncio服务的理想选择</p><figure><img src="`+d+`" alt="image-20210202092756107" tabindex="0" loading="lazy"><figcaption>image-20210202092756107</figcaption></figure><p>安装环境，python环境必须是3.6以上的，然后去github中将<a href="https://github.com/liaogx/fastapi-tutorial" target="_blank" rel="noopener noreferrer">github.com/liaogx/fastapi-tutorial</a> 拷贝下来，安装reqiurements.txt里面的包</p><p>一定要注意版本的兼容性</p><h3 id="_2-2-pydantic基础教程" tabindex="-1"><a class="header-anchor" href="#_2-2-pydantic基础教程"><span>2.2 Pydantic基础教程</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
...
# people.start()
# people.friend()
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>pycharm安装pydantic插件</strong> <img src="`+a+`" alt=" image-20210202100216847 " loading="lazy"></p><p><strong>校验失败的处理</strong></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
# 校验失败的处理
try:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-fastapi的结构" tabindex="-1"><a class="header-anchor" href="#_3-2-fastapi的结构"><span>3.2 fastApi的结构</span></a></h3><p>首先创建一个文件包，用于存放各个app <img src="`+t+`" alt=" image-20210202145110225" loading="lazy"></p><p>然后再<strong>chapter03.py</strong>中实现</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="第6章-安全、认证和授权" tabindex="-1"><a class="header-anchor" href="#第6章-安全、认证和授权"><span>第6章：安全、认证和授权</span></a></h2><h3 id="_6-1-oauth2-密码模式和-fastapi-的-oauth2passwordbearer" tabindex="-1"><a class="header-anchor" href="#_6-1-oauth2-密码模式和-fastapi-的-oauth2passwordbearer"><span>6.1 OAuth2 密码模式和 FastAPI 的 OAuth2PasswordBearer</span></a></h3><figure><img src="`+l+`" alt=" image-20210204152011882" tabindex="0" loading="lazy"><figcaption> image-20210204152011882</figcaption></figure><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
