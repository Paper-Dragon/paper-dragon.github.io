import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as e,o as a,d as i}from"./app-BgqHBY__.js";const t="/assets/20191031161908405-16919219329121-D44-kTRO.png",l="/assets/watermark_type_ZmFuZ3poZW5naGVpdGk_shadow_10_text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl8zODgxNTk5OA___size_16_color_FFFFFF_t_70-16919219356843-Csm-zIe5.png",o={},r=i('<h1 id="c语言volatile关键字详解" tabindex="-1"><a class="header-anchor" href="#c语言volatile关键字详解"><span>C语言volatile关键字详解</span></a></h1><h2 id="_1-volatile和什么有关" tabindex="-1"><a class="header-anchor" href="#_1-volatile和什么有关"><span>1.volatile和什么有关</span></a></h2><p>百度翻译是这样子翻译volatile的：</p><figure><img src="'+t+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>volatile属于C语言的关键字，《C Primer Plus》 是这样解释关键字的：关键字是C语言的词汇，由于编译器不具备真正的智能，所以你必须用编译器能理解的术语表示你的意图。开发者告诉编译器该变量是易变的，无非就是希望编译器去注意该变量的状态，时刻注意该变量是易变的，每次读取该变量的值都重新从内存中读取。（ahhhh，是不是一脸蒙蔽，举个例子吧）</p><pre><code>int i = 10;
int main(void){
...
</code></pre><p>但是仔细想一想，好像我们都遇到过上述情况，也没有对相对应的变量使用volatile修饰呀？也没出现奇怪的问题呀？本小白猜测，大佬您是不是没有开启编译器优化，编译器其实是默认不优化的，这对入门者是友好的，但是当进入企业开发中，我们可能就会遇到 leader 在编译源码时，选择了编译器优化，以减少可执行程序大小和提高性能，这时候我们就不得不去考虑编译器优化问题，如何启动编译器优化，我们结合 GCC 编译器和 keil 开发软件讲解。</p><div class="language- line-numbers-mode" data-ext="" data-title=""><pre class="shiki shiki-themes github-light one-dark-pro vp-code" style="background-color:#fff;--shiki-dark-bg:#282c34;color:#24292e;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>使用GCC编译器时，在编译脚本命令加入 -On  ; n: 0 ~ 3，数字代表优化等级，数字越大，优化级别越高。</span></span>
<span class="line"><span></span></span>
<span class="line"><span>例如：</span></span>
<span class="line"><span></span></span>
<span class="line"><span>gcc -O2 -O hello hello.c</span></span>
<span class="line"><span></span></span>
<span class="line"><span>使用 O2 优化级别编译 hello.c</span></span></code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用keil 软件，我们可以通过如下操作选择优化级别：</p><figure><img src="`+l+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h2 id="_2-volatile关键字什么情况下要用" tabindex="-1"><a class="header-anchor" href="#_2-volatile关键字什么情况下要用"><span>2.volatile关键字什么情况下要用</span></a></h2><pre><code>此博文为了限幅，达到更好的阅读效果，仅仅对如下几个方面进行简单分析，如需更加深入了解，可以访问实验博文进行查看。
...
void _start(void) //gcc编译器中，裸机程序的入口是start，不是main
{
	...
	GPIOAALTFN1 &amp;= ~(3&lt;&lt;24);
	GPIOAOUTENB &amp;= ~(1&lt;&lt;28);
</code></pre><p>​<br> ​ while(1) ​ { ​ //读取GPIO引脚电平 ​ if(!(GPIOAPAD &amp; (1&lt;&lt;28))) ​ GPIOEOUT &amp;= ~(1&lt;&lt;13); ​ else ​ GPIOEOUT |= (1&lt;&lt;13); ​ } ​ }</p><p>这种情况加volatile的情况是最多的，比如stm32函数库底层的寄存器定义就是加了volatile的：</p><p>所以，也没有实验ahhh！</p>`,34),p=[r];function s(d,c){return a(),e("div",null,p)}const m=n(o,[["render",s],["__file","C语言volatile关键字详解.html.vue"]]),g=JSON.parse('{"path":"/note-book/Research_Develop/C/C%E8%AF%AD%E8%A8%80volatile%E5%85%B3%E9%94%AE%E5%AD%97%E8%AF%A6%E8%A7%A3.html","title":"C语言volatile关键字详解","lang":"zh-CN","frontmatter":{"description":"C语言volatile关键字详解 1.volatile和什么有关 百度翻译是这样子翻译volatile的： imgimg volatile属于C语言的关键字，《C Primer Plus》 是这样解释关键字的：关键字是C语言的词汇，由于编译器不具备真正的智能，所以你必须用编译器能理解的术语表示你的意图。开发者告诉编译器该变量是易变的，无非就是希望编译器...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Research_Develop/C/C%E8%AF%AD%E8%A8%80volatile%E5%85%B3%E9%94%AE%E5%AD%97%E8%AF%A6%E8%A7%A3.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"C语言volatile关键字详解"}],["meta",{"property":"og:description","content":"C语言volatile关键字详解 1.volatile和什么有关 百度翻译是这样子翻译volatile的： imgimg volatile属于C语言的关键字，《C Primer Plus》 是这样解释关键字的：关键字是C语言的词汇，由于编译器不具备真正的智能，所以你必须用编译器能理解的术语表示你的意图。开发者告诉编译器该变量是易变的，无非就是希望编译器..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-03-19T07:56:45.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-03-19T07:56:45.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"C语言volatile关键字详解\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-03-19T07:56:45.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[{"level":2,"title":"1.volatile和什么有关","slug":"_1-volatile和什么有关","link":"#_1-volatile和什么有关","children":[]},{"level":2,"title":"2.volatile关键字什么情况下要用","slug":"_2-volatile关键字什么情况下要用","link":"#_2-volatile关键字什么情况下要用","children":[{"level":3,"title":"2.1自定义延时函数","slug":"_2-1自定义延时函数","link":"#_2-1自定义延时函数","children":[]},{"level":3,"title":"2.2多线程共享的全局变量","slug":"_2-2多线程共享的全局变量","link":"#_2-2多线程共享的全局变量","children":[]},{"level":3,"title":"2.3中断函数与主函数共享的全局变量","slug":"_2-3中断函数与主函数共享的全局变量","link":"#_2-3中断函数与主函数共享的全局变量","children":[]},{"level":3,"title":"2.4硬件寄存器","slug":"_2-4硬件寄存器","link":"#_2-4硬件寄存器","children":[]}]}],"git":{"createdTime":1691939318000,"updatedTime":1710835005000,"contributors":[{"name":"PaperDragon-SH","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":6.65,"words":1996},"filePathRelative":"note-book/Research_Develop/C/C语言volatile关键字详解.md","localizedDate":"2023年8月13日","excerpt":"\\n<h2>1.volatile和什么有关</h2>\\n<p>百度翻译是这样子翻译volatile的：</p>\\n<figure><figcaption>img</figcaption></figure>\\n<p>volatile属于C语言的关键字，《C Primer Plus》 是这样解释关键字的：关键字是C语言的词汇，由于编译器不具备真正的智能，所以你必须用编译器能理解的术语表示你的意图。开发者告诉编译器该变量是易变的，无非就是希望编译器去注意该变量的状态，时刻注意该变量是易变的，每次读取该变量的值都重新从内存中读取。（ahhhh，是不是一脸蒙蔽，举个例子吧）</p>\\n<pre><code>int i = 10;\\nint main(void){\\n \\n    int a, b;\\n \\n    a = i;\\n    ...//伪代码，里面不含有对 a 、 b 以及 i的操作\\n    b = i;\\n \\n    if(a == b){\\n        printf(\\"a = b\\");\\n    }\\n    else {\\n        printf(\\"a != b\\");\\n    }\\n    \\n    return 0;\\n}\\n</code></pre>","autoDesc":true}');export{m as comp,g as data};
