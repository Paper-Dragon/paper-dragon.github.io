import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,f as e}from"./app-1euMEaFY.js";const t={},i=e(`<p>CentOS下， yum install bind安装bind软件来实现DNS服务, yum info bind可以查看到描述：</p><pre><code>Description : BIND (Berkeley Internet Name Domain) is an implementation of the DNS
...
</code></pre><p>根据参考来配置各个文件。 named主配置文件</p><p>主配置文件/etc/named.conf包括：</p><pre><code>监听端口(listen-on port)和ip地址
...
</code></pre><p>区域配置文件</p><p>/var/named/ZONE_NAME.zone区域配置文件 这里给出我一个自定义的区域文件：zhangqifei.top.zone</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
