import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as e,d as a}from"./app-4xWcHoIH.js";const i="/assets/image-20220815102732430-DIu65CMX.png",t={},c=a(`<h1 id="一、安装helm工具" tabindex="-1"><a class="header-anchor" href="#一、安装helm工具"><span>一、安装helm工具</span></a></h1><h2 id="_1-下载软件包" tabindex="-1"><a class="header-anchor" href="#_1-下载软件包"><span>（1）下载软件包</span></a></h2><pre><code>wget https://get.helm.sh/helm-v3.8.0-linux-amd64.tar.gz
...
</code></pre><p>至此即可在gitlab上看到runner了 <img src="`+i+`" alt="image-20220815102732430" loading="lazy"></p><h1 id="五、一份已经配置好的values文件" tabindex="-1"><a class="header-anchor" href="#五、一份已经配置好的values文件"><span>五、一份已经配置好的values文件</span></a></h1><h2 id="values-yaml" tabindex="-1"><a class="header-anchor" href="#values-yaml"><span>values.yaml</span></a></h2><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment">## GitLab Runner Image</span>
