import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o,c as l,a as n,e as s,d as e,f as c}from"./app-f2f14b0c.js";const p="/assets/image-20211116145510909-16370457460581-c3fdd05d.png",r="/assets/image-20211116145621627-d8f5764d.png",u="/assets/image-20211116151442638-6a681ba6.png",d="/assets/image-20211117083904657-b38eb9c1.png",v="/assets/image-20211117231143675-4b5e6fc2.png",m="/assets/image-20211117231243044-10d107f9.png",b="/assets/image-20211117231251486-23fa06ba.png",k="/assets/image-20211117231308169-594bc857.png",g="/assets/image-20211117235501571-3bc8ae52.png",h="/assets/image-20211118000511866-4cafb692.png",f="/assets/image-20211118000504423-6da6dcd4.png",q="/assets/image-20211118000526400-44e98e16.png",_="/assets/image-20211118000641707-e267a086.png",y={},x=c('<h1 id="elk日志分析系统" tabindex="-1"><a class="header-anchor" href="#elk日志分析系统" aria-hidden="true">#</a> ELK日志分析系统</h1><figure><img src="'+p+'" alt="image-20211116145510909" tabindex="0" loading="lazy"><figcaption>image-20211116145510909</figcaption></figure><figure><img src="'+r+'" alt="image-20211116145621627" tabindex="0" loading="lazy"><figcaption>image-20211116145621627</figcaption></figure><h1 id="e-elasticsearch" tabindex="-1"><a class="header-anchor" href="#e-elasticsearch" aria-hidden="true">#</a> E Elasticsearch</h1><p>弹性搜索，日志<strong>存储</strong></p><h1 id="l-logstash" tabindex="-1"><a class="header-anchor" href="#l-logstash" aria-hidden="true">#</a> L Logstash</h1><p>日志收集</p><h1 id="k-kibana" tabindex="-1"><a class="header-anchor" href="#k-kibana" aria-hidden="true">#</a> K Kibana</h1><p>日志展示</p><figure><img src="'+u+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h1 id="实战" tabindex="-1"><a class="header-anchor" href="#实战" aria-hidden="true">#</a> 实战</h1><h2 id="环境" tabindex="-1"><a class="header-anchor" href="#环境" aria-hidden="true">#</a> 环境</h2><p>操作系统优化</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>master-slave模式</p><figure><img src="`+d+`" alt="image-20211117083904657" tabindex="0" loading="lazy"><figcaption>image-20211117083904657</figcaption></figure><p>内存：大于2G</p><h2 id="elasticsearch" tabindex="-1"><a class="header-anchor" href="#elasticsearch" aria-hidden="true">#</a> Elasticsearch</h2><h3 id="基础环境安装-node1-node2同时进行" tabindex="-1"><a class="header-anchor" href="#基础环境安装-node1-node2同时进行" aria-hidden="true">#</a> 基础环境安装 node1 node2同时进行</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@node1 ~<span class="token punctuation">]</span><span class="token comment"># rpm --import https://packages.elastic.co/GPG-KEY-elasticsearch</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装插件1" tabindex="-1"><a class="header-anchor" href="#安装插件1" aria-hidden="true">#</a> 安装插件1</h3><p>elk-node1/node2都安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>安装Elasticsearch插件
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>elasticsearch集群部署</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@node1 yum.repos.d<span class="token punctuation">]</span><span class="token comment"># vi /etc/elasticsearch/elasticsearch.yml</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="安装插件2" tabindex="-1"><a class="header-anchor" href="#安装插件2" aria-hidden="true">#</a> 安装插件2</h3><p>安装监控组件</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@node1 elasticsearch<span class="token punctuation">]</span><span class="token comment"># /usr/share/elasticsearch/bin/plugin install lmenezes/elasticsearch-kopf</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="两台服务器均可插件测试" tabindex="-1"><a class="header-anchor" href="#两台服务器均可插件测试" aria-hidden="true">#</a> 两台服务器均可插件测试</h3><figure><img src="`+v+'" alt="image-20211117231143675" tabindex="0" loading="lazy"><figcaption>image-20211117231143675</figcaption></figure><figure><img src="'+m+'" alt="image-20211117231243044" tabindex="0" loading="lazy"><figcaption>image-20211117231243044</figcaption></figure><figure><img src="'+b+'" alt="image-20211117231251486" tabindex="0" loading="lazy"><figcaption>image-20211117231251486</figcaption></figure><figure><img src="'+k+`" alt="image-20211117231308169" tabindex="0" loading="lazy"><figcaption>image-20211117231308169</figcaption></figure><h2 id="logstash" tabindex="-1"><a class="header-anchor" href="#logstash" aria-hidden="true">#</a> Logstash</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Apache
安装httpd并开启服务
...
-t：测试配置文件是否正确，然后退出
#输入采用标准输入，输出采用标准输出
</code></pre><p>使用rubydebug显示详细输出</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@apache bin<span class="token punctuation">]</span><span class="token comment"># logstash -e &#39;input { stdin{} } output { stdout{ codec =&gt; rubydebug } }&#39;</span>
Settings: Default filter workers: <span class="token number">1</span>
Logstash startup completed
www.baidu.com
<span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在logstash收集系统日志</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>模块总结</p><figure><img src="`+g+`" alt="image-20211117235501571" tabindex="0" loading="lazy"><figcaption>image-20211117235501571</figcaption></figure><h2 id="kibana" tabindex="-1"><a class="header-anchor" href="#kibana" aria-hidden="true">#</a> Kibana</h2><p>添加logstash配置，收集apache服务的访问日志和错误日志中的数据</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>上传kibana-4.3.1-linux-x64.tar.gz到/root下
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@apache ~<span class="token punctuation">]</span><span class="token comment"># cd /etc/logstash/conf.d/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+h+'" alt="image-20211118000511866" tabindex="0" loading="lazy"><figcaption>image-20211118000511866</figcaption></figure><figure><img src="'+f+'" alt="image-20211118000504423" tabindex="0" loading="lazy"><figcaption>image-20211118000504423</figcaption></figure><figure><img src="'+q+'" alt="image-20211118000526400" tabindex="0" loading="lazy"><figcaption>image-20211118000526400</figcaption></figure><figure><img src="'+_+`" alt="image-20211118000641707" tabindex="0" loading="lazy"><figcaption>image-20211118000641707</figcaption></figure><h1 id="elasticsearch-redis" tabindex="-1"><a class="header-anchor" href="#elasticsearch-redis" aria-hidden="true">#</a> Elasticsearch + Redis</h1><p>首先从redis这台服务器下手吧</p><pre><code>yum install -y redis
...
</code></pre><p>至这里，运行结果会把收集到的日志信息，标准输入至屏幕；</p>`,64),w={href:"http://192.168.1.13",target:"_blank",rel:"noopener noreferrer"},E=n("p",null,"最后,在es这台机器上，安装elasticsearch + kibana,安装方法不再演示:",-1),L=n("pre",null,[n("code",null,`vim /etc/elasticsearch/elasticsearch.yml
cluster.name: myes
node.name: "linux-node1"
保存退出，并启动
...
`)],-1),z={href:"http://192.168.1.10:5601",target:"_blank",rel:"noopener noreferrer"},K=n("p",null,"接下来还返回logstash server服务器",-1),T=n("p",null,"前面，我们是将结果标准输出到了屏幕，这次我们需要把结果输出到elasticsearch服务器",-1),Y=n("pre",null,[n("code",null,`vim /etc/logstash/conf.d/fromredis.conf 
修改为：
input {
        redis {
                port => "6379"
...
Configuration OK
[root@linux-node2 conf.d]# logstash -f /etc/logstash/conf.d/fromredis.conf
`)],-1),G=n("p",null,"想要知道是否成功的信息输出到了es上，可以验证",-1),M=n("pre",null,[n("code",null,`[root@linux-node1 ~]# curl -XGET 'localhost:9200/_cat/indices'
...
`)],-1),j=n("p",null,"接下来在kibana上显示：",-1),S={href:"http://192.168.1.10:5601/",target:"_blank",rel:"noopener noreferrer"},N=n("h1",{id:"面试题",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#面试题","aria-hidden":"true"},"#"),s(" 面试题：")],-1),O=n("p",null,"ELK插件",-1),C={href:"https://blog.csdn.net/sinat_35930259/article/details/81052139",target:"_blank",rel:"noopener noreferrer"};function A(D,P){const a=i("ExternalLinkIcon");return o(),l("div",null,[x,n("p",null,[s('打开浏览器输入" '),n("a",w,[s("http://192.168.1.13"),e(a)]),s('" 刷新几次，你会发现logstach server 这台服务器的屏幕会出现日志滚动信息，都是刚刚刷新收集到的最新日志信息；')]),E,L,n("p",null,[s('浏览器输入" '),n("a",z,[s("http://192.168.1.10:5601"),e(a)]),s('"打开kibana界面')]),K,T,Y,G,M,j,n("p",null,[s('浏览器" '),n("a",S,[s("http://192.168.1.10:5601/"),e(a)]),s('"')]),N,O,n("p",null,[n("a",C,[s("https://blog.csdn.net/sinat_35930259/article/details/81052139"),e(a)])])])}const J=t(y,[["render",A],["__file","ELK.html.vue"]]);export{J as default};
