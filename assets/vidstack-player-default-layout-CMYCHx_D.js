const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-CmqqnRgc-rWIVIFtJ.js","assets/app-D1IXJOTD.js"])))=>i.map(i=>d[i]);
var we=Object.getPrototypeOf;var ke=Reflect.get;var lt=(e,t,s)=>ke(we(e),s,t);import{a9 as b,aa as Et,ab as V,ac as Vt,ad as C,ae as Ce,af as G,ag as S,ah as Ae,ai as De,aj as Me,ak as x,al as Wt,am as Oe,an as F,ao as W,ap as Ie,aq as Ht,ar as h,as as Kt,at as Pe,au as _e,av as Qt,aw as z,ax as $t,ay as Ge,az as zt,_ as Ne,aA as Be,aB as Le,aC as Fe,aD as O,aE as Re,aF as Ee,aG as Ut,aH as rt,aI as Ve,aJ as We,aK as He,aL as Ke,aM as jt}from"./app-D1IXJOTD.js";import{A as I,T as Qe,D as Nt,x as l,s as ze,$ as Ue,L as qt}from"./vidstack-D2YigfqZ-BLArkuQb.js";/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const U={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},J=e=>(...t)=>({_$litDirective$:e,values:t});let gt=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,s,n){this._$Ct=t,this._$AM=s,this._$Ci=n}_$AS(t,s){return this.update(t,s)}update(t,s){return this.render(...s)}};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const R=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),R(o,t);return!0},j=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},Zt=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),ts(t)}};function Je(e){this._$AN!==void 0?(j(this),this._$AM=e,Zt(this)):this._$AM=e}function Xe(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)R(n[o],!1),j(n[o]);else n!=null&&(R(n,!1),j(n));else R(this,e)}const ts=e=>{var t,s,n,i;e.type==U.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Xe),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=Je))};class Yt extends gt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Zt(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(R(this,t),j(this))}setValue(t){if(qe(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}class es extends Yt{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===U.ATTRIBUTE||t.type===U.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Vt(this.h)):I}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?bt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function a(e){return J(es)(b(e))}class Jt{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=Et(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});V(()=>t.disconnect()),V(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){Ce(t)?(s.textContent="",s.append(t)):(Nt(null,s),Nt(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}Ha(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=this._m.flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&this.La(this.elements)}}let ss=0,Q="data-slot-id";class Xt{constructor(t){this._m=t,this.Gc=Et(this.Ha.bind(this)),this.slots=new Jt(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});V(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(Q);i||s.setAttribute(Q,i=++ss+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(Q)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(Q,i)}}}}function ns({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
  ...
  `}function me({placement:e,portal:t,tooltip:s}){return a(()=>{const{viewType:n}=h(),{translations:i,menuPortal:o,noModal:r,menuGroup:p,smallWhen:c}=d(),$=b(()=>r()?z(e):c()?null:z(e)),v=b(()=>!c()&&p()==="bottom"&&n()==="video"?26:0),m=x(!1);fs();function f(){m.set(!0)}function g(){m.set(!1)}const y=l`
    ...
    `})}function At({orientation:e,tooltip:t}){return a(()=>{const{pointer:s,muted:n,canSetVolume:i}=h();if(s()==="coarse"&&!n())return null;if(!i())return Bt({tooltip:t});const o=x(void 0),r=Ge(o);return l`
      <div class="vds-volume" ?data-active=${a(r)} ${X(o.set)}>
        ${Bt({tooltip:t})}
        <div class="vds-volume-popup">${Js({orientation:e})}</div>
      </div>
    `})}function Js({orientation:e}={}){const{translations:t}=d(),s=u(t,"Volume");return l`
    <media-volume-slider
  ...
  `}function tn(){return a(()=>{const{live:e,duration:t}=h();return e()?ae():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function ve(){return a(()=>{const{live:e}=h();return e()?ae():Xs()})}function fe(){return a(()=>{const{textTracks:e}=S(),{title:t,started:s}=h(),n=x(null);return Qt(e,"chapters",n.set),n()&&(s()||!t())?he():l`<media-title class="vds-chapter-title"></media-title>`})}function he(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class $e extends as{async Pf(){const t=(await Ne(async()=>{const{icons:n}=await import("./vidstack-CmqqnRgc-rWIVIFtJ.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=ns({name:n,paths:t[n]});return s}}var M;let en=(M=class extends N{},M.props={...lt(M,M,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576},M);function sn(){return[yt(),wt(),l`
    ...
    `]}function nn(){return a(()=>{let e=x(void 0),t=x(!1),s=S(),{title:n,started:i,currentTime:o,ended:r}=h(),{translations:p}=d(),c=We(e),$=()=>i()||o()>0;const v=()=>{const g=r()?"Replay":$()?"Continue":"Play";return`${T(p,g)}: ${n()}`};C(()=>{var g;c()&&document.activeElement===document.body&&((g=s.player.el)==null||g.focus())});function m(){const g=e(),y=!!g&&!c()&&g.clientWidth<g.children[0].clientWidth;g&&He(g,"vds-marquee",y),t.set(y)}function f(){return l`
      ...
      `}return zt(e,m),n()?l`
        ...
        `:A()})}function an(){const e="top end";return[re({tooltip:"top",placement:e,portal:!0}),me({tooltip:"top end",placement:e,portal:!0})]}const Z=class Z extends Ut(qt,en){constructor(){super(...arguments),this.en=x(!1)}onSetup(){this.forwardKeepAlive=!1,this.a=S(),this.classList.add("vds-audio-layout"),this.Fn()}onConnect(){se("audio",()=>this.isMatch),this.En()}render(){return a(this.Zm.bind(this))}Zm(){return this.isMatch?sn():null}En(){const{menuPortal:t}=d();C(()=>{if(!this.isMatch)return;const s=le(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),n=s?[this,s]:[this];return(this.$props.customIcons()?new Xt(n):new $e(n)).connect(),t.set(s),()=>{s.remove(),t.set(null)}})}Fn(){const{pointer:t}=this.a.$state;C(()=>{t()==="coarse"&&C(this.rn.bind(this))})}rn(){if(!this.en()){rt(this,"pointerdown",this.sn.bind(this),{capture:!0});return}rt(this,"pointerdown",t=>t.stopPropagation()),rt(window,"pointerdown",this.tn.bind(this))}sn(t){const{target:s}=t;Ve(s)&&s.closest(".vds-time-slider")&&(t.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),this.en.set(!0))}tn(){this.en.set(!1),this.removeAttribute("data-scrubbing")}};Z.tagName="media-audio-layout",Z.attrs={smallWhen:{converter(t){return t!=="never"&&!!t}}};let vt=Z;/**
 * @license
