...
</code></pre><p>3.找到en_US.UTF-8 UTF-8选项，按空格键将其进行取消</p><p>4.找到[ ]zh_CN.GBK_GBK 和[ ] zh-CN.UTF-8.UTF-8两个选项，使用空格将[ ]zh_CN.GBK_GBK 和[ ] zh-CN.UTF-8.UTF-8其两项勾选上</p><p>5.勾选完毕以后，在<code>0k</code>处按下空格，进行下一步</p><p>​ 在此处选择zh_CN.UTF-8字符编码，在<code>0k</code>处按空格键进行确认 ，并完成相关配置操作 7.配置完毕以后，使用reboot命令重启系统使其生效</p><p>8.重启完毕以后，可以看到相关登陆登陆页面已经是中文显示了，至此配置完毕。</p><h1 id="三-相关总结" tabindex="-1"><a class="header-anchor" href="#三-相关总结" aria-hidden="true">#</a> 三.相关总结</h1><p>1.打开Terminal Emulator 界面，查看当前系统语言为默认英文 2.在Terminal Emulator 中执行dpkg-reconfigure locales命令 3.使用空格键取消勾选en_US.UTF-8 UTF-8选项 4.勾选[ ]zh_CN.GBK_GBK 和[ ] zh-CN.UTF-8.UTF-8两个选项 5.使用reboot命令重启机器使其配置生效</p>`,12),c=[t];function i(d,h){return a(),r("div",null,c)}const s=e(n,[["render",i],["__file","更换系统和命令行语言.html.vue"]]);export{s as default};
