import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as i,c as n,f as r}from"./app-1euMEaFY.js";const e={},t=r(`<h1 id="grub2各种手动命令引导教程" tabindex="-1"><a class="header-anchor" href="#grub2各种手动命令引导教程" aria-hidden="true">#</a> grub2各种手动命令引导教程</h1><h2 id="手动引导ubuntu的iso镜像文件" tabindex="-1"><a class="header-anchor" href="#手动引导ubuntu的iso镜像文件" aria-hidden="true">#</a> 手动引导ubuntu的iso镜像文件</h2><p>从而安装ubuntu，grub&gt;代表命令的开始</p><p>假设ubuntu镜像在U盘的第一个分区的根目录下即：(hd0,1)/ubuntu-18.04-desktop-amd64.iso</p><p>手动引导下可以按TAB键补全命令、目录以及文件名</p><pre><code>#查询所有已安装磁盘并打印详细信息
grub&gt;ls -l
