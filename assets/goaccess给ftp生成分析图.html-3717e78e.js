import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as t,c as r,a as n,e as s,d as e,f as c}from"./app-83883b31.js";const o={},d=n("h1",{id:"goaccess给ftp生成分析图",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#goaccess给ftp生成分析图","aria-hidden":"true"},"#"),s(" goaccess给ftp生成分析图")],-1),p={href:"https://goaccess.io/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://github.com/allinurl/goaccess",target:"_blank",rel:"noopener noreferrer"},u=c(`<h2 id="日志格式" tabindex="-1"><a class="header-anchor" href="#日志格式" aria-hidden="true">#</a> 日志格式</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>Sat Oct <span class="token number">7</span> <span class="token number">2023</span> <span class="token number">14</span>:41:57 <span class="token number">1</span> <span class="token number">113.57</span>.80.113 <span class="token number">61</span> /catfish.txt b _ POST g LiuDanYi <span class="token function">ftp</span> <span class="token number">0</span> * <span class="token number">200</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,7);function b(v,k){const a=l("ExternalLinkIcon");return t(),r("div",null,[d,n("blockquote",null,[n("p",null,[s("官网："),n("a",p,[s("https://goaccess.io/"),e(a)])]),n("p",null,[s("源码： "),n("a",m,[s("https://github.com/allinurl/goaccess"),e(a)])])]),u])}const g=i(o,[["render",b],["__file","goaccess给ftp生成分析图.html.vue"]]);export{g as default};
