import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as i,d as s}from"./app-C9C5X1Gs.js";const d="/assets/1034759-20191123171511586-952619728-16918406481011-uAu3dDuT.png",a="/assets/1034759-20191123171846178-306539553-16918406503293-Cww3d7IA.png",l="/assets/1034759-20191123172154297-518829231-16918406525315-B-TYjRNQ.png",t="/assets/1034759-20191123173004191-1776516653-16918406560269-DYRhF87g.png",r="/assets/1034759-20191123173122519-900176878-16918406543237-BwUly3C9.png",c="/assets/1034759-20191123174517612-971806757-169184065782711-Bxcu9gqd.png",v={},u=s(`<h1 id="kubernetes进阶-三-服务发现-coredns" tabindex="-1"><a class="header-anchor" href="#kubernetes进阶-三-服务发现-coredns"><span>kubernetes进阶（三）服务发现-coredns</span></a></h1><p>服务发现，说白了就是服务(应用)之间相互定位的过程。</p><p>服务发现需要解决的问题：</p><p>1、服务动态性强--容器在k8s中ip变化或迁移</p><p>2、更新发布频繁--版本迭代快</p><p>3、支持自动伸缩--大促或流量高峰</p><p>我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题，</p><p>那么，如何解决service资源名称和service资源暴露出来的集群网络IP做自动的对应呢，从而达到服务的自动发现呢？</p><p>在k8s中，coredns就是为了解决以上问题。</p><p>从coredns开始，我们采用向k8s中交付容器的方式，来部署服务，并且使用声明式的方式，来部署服务。</p><p>首先在hdss7-200上创建一个nginx虚拟主机，用来获取资源配置清单：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>vi /etc/nginx/conf.d/k8s-yaml.od.com.conf
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+d+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>查看coredns的cluster ip：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># kubectl get svc -o wide -n kube-system
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+a+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>测试coredns：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># dig -t A www.baidu.com @192.168.0.2 +short
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+l+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>看到已经可以解析到百度。</p><p>测试coredns解析service资源名称，首先查看kube-public下是否有service资源，如果没有，创建一个，使用kubectl expose nginx-dp --port=80 -n kube-public</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># kubectl expose nginx-dp --port=80 -n kube-public
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><figure><img src="`+t+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>可以看到我们没有手动添加任何解析记录，我们nginx-dp的service资源的IP，已经被解析了：</p><figure><img src="'+r+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>那么为什么呢？</p><p>推荐大家了解一下coredns都做了什么：<a href="http://ccnuo.com/2019/08/25/CoreDNS%EF%BC%9AKubernetes%E5%86%85%E9%83%A8%E5%9F%9F%E5%90%8D%E8%A7%A3%E6%9E%90%E5%8E%9F%E7%90%86%E3%80%81%E5%BC%8A%E7%AB%AF%E5%8F%8A%E4%BC%98%E5%8C%96%E6%96%B9%E5%BC%8F/" target="_blank" rel="noopener noreferrer">Kubernetes内部域名解析原理、弊端及优化方式</a></p><p>大家可以看到，当我进入到pod内部以后，我们会发现我们的dns地址是我们的coredns地址，以及搜索域：</p><figure><img src="'+c+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>现在，我们已经解决了在集群内部解析的问题，但是我们怎么做到在集群外部访问我们的服务呢？</p><p>接下来我们来学习k8s服务暴露。</p>',59),m=[u];function o(b,p){return i(),n("div",null,m)}const k=e(v,[["render",o],["__file","13kubernetes进阶（三）服务发现-coredns.html.vue"]]),h=JSON.parse('{"path":"/note-book/Kubernetes/13kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%B8%89%EF%BC%89%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0-coredns.html","title":"kubernetes进阶（三）服务发现-coredns","lang":"zh-CN","frontmatter":{"description":"kubernetes进阶（三）服务发现-coredns 服务发现，说白了就是服务(应用)之间相互定位的过程。 服务发现需要解决的问题： 1、服务动态性强--容器在k8s中ip变化或迁移 2、更新发布频繁--版本迭代快 3、支持自动伸缩--大促或流量高峰 我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Kubernetes/13kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%B8%89%EF%BC%89%E6%9C%8D%E5%8A%A1%E5%8F%91%E7%8E%B0-coredns.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:title","content":"kubernetes进阶（三）服务发现-coredns"}],["meta",{"property":"og:description","content":"kubernetes进阶（三）服务发现-coredns 服务发现，说白了就是服务(应用)之间相互定位的过程。 服务发现需要解决的问题： 1、服务动态性强--容器在k8s中ip变化或迁移 2、更新发布频繁--版本迭代快 3、支持自动伸缩--大促或流量高峰 我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-03-25T08:41:17.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2024-03-25T08:41:17.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"kubernetes进阶（三）服务发现-coredns\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2024-03-25T08:41:17.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[],"git":{"createdTime":1691939318000,"updatedTime":1711356077000,"contributors":[{"name":"PaperDragon-SH","email":"2678885646@qq.com","commits":2}]},"readingTime":{"minutes":3.78,"words":1134},"filePathRelative":"note-book/Kubernetes/13kubernetes进阶（三）服务发现-coredns.md","localizedDate":"2023年8月13日","excerpt":"\\n<p>服务发现，说白了就是服务(应用)之间相互定位的过程。</p>\\n<p>服务发现需要解决的问题：</p>\\n<p>1、服务动态性强--容器在k8s中ip变化或迁移</p>\\n<p>2、更新发布频繁--版本迭代快</p>\\n<p>3、支持自动伸缩--大促或流量高峰</p>\\n<p>我们为了解决pod地址变化的问题，我们之前部署了service资源，将pod地址通过service资源暴露的固定地址，来解决以上问题，</p>\\n<p>那么，如何解决service资源名称和service资源暴露出来的集群网络IP做自动的对应呢，从而达到服务的自动发现呢？</p>\\n<p>在k8s中，coredns就是为了解决以上问题。</p>","autoDesc":true}');export{k as comp,h as data};
