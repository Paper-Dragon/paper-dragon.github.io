import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,e as a}from"./app-qg-d1EOx.js";const i="/assets/image-20220815102732430-yLuuQjFw.png",t={},c=a(`<h1 id="一、安装helm工具" tabindex="-1"><a class="header-anchor" href="#一、安装helm工具" aria-hidden="true">#</a> 一、安装helm工具</h1><h2 id="_1-下载软件包" tabindex="-1"><a class="header-anchor" href="#_1-下载软件包" aria-hidden="true">#</a> （1）下载软件包</h2><pre><code>wget https://get.helm.sh/helm-v3.8.0-linux-amd64.tar.gz
