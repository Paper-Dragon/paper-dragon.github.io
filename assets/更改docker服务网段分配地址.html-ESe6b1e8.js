import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,d as e}from"./app-FUNHprH_.js";const t={},c=e(`<h1 id="更改docker服务网段分配地址" tabindex="-1"><a class="header-anchor" href="#更改docker服务网段分配地址"><span>更改docker服务网段分配地址</span></a></h1><h2 id="在docker配置文件中追加参数" tabindex="-1"><a class="header-anchor" href="#在docker配置文件中追加参数"><span>在docker配置文件中追加参数</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># cat /etc/docker/daemon.json</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="更改docker-compose网桥地址" tabindex="-1"><a class="header-anchor" href="#更改docker-compose网桥地址"><span>更改docker-compose网桥地址</span></a></h2><p>使用单机容器编码工具，docker-compose时，容器之间的通信网络会用到br-xxx网桥，该网桥会在宿主机建立，示例如下：</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@xingyongsheng ~<span class="token punctuation">]</span><span class="token comment"># ifconfig | headbr-35fc9d6212bd: flags=4163&lt;UP,BROADCAST,RUNNING,MULTICAST&gt;  mtu 1500</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>该网段也有可能与，已有网段重复，若要修改此网段，可按如下步骤进行。安全停掉所有用docker-compose编排的容器，这里建议使用docker-compose down来彻底停掉容器，并自动帮你移除docker-compose之前创建的网桥。之后修改docker-compose.yml文件，增加自定义网络段，如下所示。</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> &#39;2.1&#39;services<span class="token punctuation">:</span>
