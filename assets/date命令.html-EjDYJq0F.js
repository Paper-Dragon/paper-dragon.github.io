import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as d,c as e,d as t}from"./app-tIMIha2G.js";const n={},a=t(`<h1 id="date-显示或设置时间" tabindex="-1"><a class="header-anchor" href="#date-显示或设置时间"><span>date 显示或设置时间</span></a></h1><h2 id="显示时间" tabindex="-1"><a class="header-anchor" href="#显示时间"><span>显示时间</span></a></h2><p>按照我们要求的格式显示当前日期: 年-月-日</p><pre><code>2019-04-10
...
2019_04_03-10_3
</code></pre><p>备份 设置时间</p><p>set date -s</p>`,12),r=[a];function _(c,u){return d(),e("div",null,r)}const s=o(n,[["render",_],["__file","date命令.html.vue"]]);export{s as default};
