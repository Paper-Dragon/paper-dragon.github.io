import{_ as s}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as n,c as e,d as a}from"./app-TZdkyv0k.js";const i={},d=a(`<h1 id="some-devices-missing" tabindex="-1"><a class="header-anchor" href="#some-devices-missing"><span>*** Some devices missing</span></a></h1><h2 id="问题原因" tabindex="-1"><a class="header-anchor" href="#问题原因"><span>问题原因：</span></a></h2><p>因为创建btrfs时使用了-f，所以硬盘被另一个btrfs抢走了，blkid改变</p><h2 id="问题描述" tabindex="-1"><a class="header-anchor" href="#问题描述"><span>问题描述</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@fedora ~<span class="token punctuation">]</span><span class="token comment"># btrfs fi show</span>
