import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,d as e}from"./app-C8EhNTY6.js";const t={},i=e(`<h1 id="bind9安装和使用" tabindex="-1"><a class="header-anchor" href="#bind9安装和使用"><span>Bind9安装和使用</span></a></h1><p>CentOS下， yum install bind安装bind软件来实现DNS服务, yum info bind可以查看到描述：</p><pre><code>Description : BIND (Berkeley Internet Name Domain) is an implementation of the DNS
