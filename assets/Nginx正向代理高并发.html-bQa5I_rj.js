import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as e,d as a}from"./app-PFp-t7ra.js";const i={},l=a(`<h1 id="nginx正向代理高并发" tabindex="-1"><a class="header-anchor" href="#nginx正向代理高并发"><span>Nginx正向代理高并发</span></a></h1><h2 id="proxy" tabindex="-1"><a class="header-anchor" href="#proxy"><span>Proxy</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash</span>
