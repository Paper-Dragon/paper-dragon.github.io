...
</code></pre><h2 id="jvm常用分析工具" tabindex="-1"><a class="header-anchor" href="#jvm常用分析工具"><span>JVM常用分析工具</span></a></h2><figure><img src="`+p+`" alt="image-20211110215222063" tabindex="0" loading="lazy"><figcaption>image-20211110215222063</figcaption></figure><p>命令行工具</p><h3 id="jps" tabindex="-1"><a class="header-anchor" href="#jps"><span>jps</span></a></h3><p>Java虚拟机进程状态工具</p><pre><code>jps [options] [hostid]
  -q 显示进程ID
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="可视化工具" tabindex="-1"><a class="header-anchor" href="#可视化工具"><span>可视化工具</span></a></h3><p>jconsole</p><p>可以监控CPU、内存、线程等情况</p><p>~jconsole</p><figure><img src="`+l+`" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure><p>reference：</p><pre><code>https://docs.oracle.com/javase/8/docs/technotes/tools/unix/jps.html
...
</code></pre><h2 id="jvm运维使用监控工具" tabindex="-1"><a class="header-anchor" href="#jvm运维使用监控工具"><span>JVM运维使用监控工具</span></a></h2><h3 id="visual-vm" tabindex="-1"><a class="header-anchor" href="#visual-vm"><span>Visual VM</span></a></h3><p>Visual VM是一款All-in-One的Java分析工具，堆栈信息、线程信息等都可以分析，而且还支持装插件。但jdk1.9之后默认JDK不再支持，可以通过https://visualvm.github.io/download.html这里下载</p><p>在1.8环境下执行</p><p>~ jvisualvm</p><figure><img src="`+i+'" alt="在这里插入图片描述" tabindex="0" loading="lazy"><figcaption>在这里插入图片描述</figcaption></figure>',126),r=[c];function d(v,u){return s(),n("div",null,r)}const k=a(o,[["render",d],["__file","tomcat.html.vue"]]);export{k as default};
