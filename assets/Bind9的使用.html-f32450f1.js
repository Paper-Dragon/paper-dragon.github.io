import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as e}from"./app-a9e2ba4f.js";const t={},i=e(`<p>CentOS下， yum install bind安装bind软件来实现DNS服务, yum info bind可以查看到描述：</p><pre><code>Description : BIND (Berkeley Internet Name Domain) is an implementation of the DNS
...
</code></pre><p>named 涉及的文件</p><pre><code>/etc/named.conf              # bind主配置文件
...
</code></pre><p>根据参考来配置各个文件。<br> named主配置文件</p><p>主配置文件/etc/named.conf包括：</p><pre><code>监听端口(listen-on port)和ip地址
...
</code></pre><p>配置解析库文件（Zone files）,一般是在/var/named下写，文件名格式一般写为ZONE_NAME.zone</p><table><thead><tr><th>named.conf配置文件所有的配置语句</th><th>含义</th></tr></thead><tbody><tr><td>acl</td><td>定义一个主机匹配列表，用户访问控制权限</td></tr><tr><td>controls</td><td>定义rndc工具与bind服务进程的通信</td></tr><tr><td>include</td><td>把其他文件的内容包含进来</td></tr><tr><td>key</td><td>定义加密秘钥</td></tr><tr><td>logging</td><td>定义系统日志信息</td></tr><tr><td>lwres</td><td>把named配置为轻量级解析器</td></tr><tr><td>masters</td><td>定义主域列表</td></tr><tr><td>options</td><td>设置全局选项</td></tr><tr><td>server</td><td>定义服务器属性</td></tr><tr><td>trusted-keys</td><td>定义信任的dnssec秘钥</td></tr><tr><td>view</td><td>定义视图</td></tr><tr><td>zone</td><td>定义区域</td></tr></tbody></table><ul><li>named.rfc1912.zones主配置文件</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>    zone <span class="token string">&quot;ZONE_NAME&quot;</span> IN <span class="token punctuation">{</span>
...
</code></pre><p>区域配置文件</p><p>/var/named/ZONE_NAME.zone区域配置文件<br> 这里给出我一个自定义的区域文件：zhangqifei.top.zone</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
www   CNAME   web1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token variable">$ORIGIN</span> host.com.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>具体配置选项意义，见前一节DNS记录类型。</li></ul><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>分号代表注释
TTL 过期时间
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>反向区域</strong></p><pre><code>区域名称：是网络地址的犯些.in-addr.arpa.
...
</code></pre><p>例子：</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code>配置<span class="token number">192.168</span><span class="token number">.111</span><span class="token punctuation">.</span>zone：
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,35),o=[i];function c(p,l){return s(),a("div",null,o)}const r=n(t,[["render",c],["__file","Bind9的使用.html.vue"]]);export{r as default};
