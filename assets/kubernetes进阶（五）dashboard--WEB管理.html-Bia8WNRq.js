import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as a,o as d,c as t,b as e,e as l,a as r,d as i}from"./app-BCjvT8Ib.js";const c="/assets/1034759-20191125193911658-1073438860-16918406809571-vo8SIs8l.png",v="/assets/1034759-20191126161244510-1269371002-16918406826423-DRHjp4PI.png",o="/assets/1034759-20191126163610063-918814879-16918406847055-MP1im4fS.png",u="/assets/1034759-20191126172440979-1913961041-16918406864827-BnZjQlGt.png",m="/assets/1034759-20191126172608230-363720611-16918406885179-CHqntM2q.png",b="/assets/1034759-20191126183554740-658611982-169184069139711-Bl8ssb93.png",p="/assets/1034759-20191126183711805-835833813-169184069393713-6vAtzZB8.png",g={},h=i(`<p>dashboard是k8s的可视化管理平台，是三种管理k8s集群方法之一</p><p>首先下载镜像上传到我们的私有仓库中：hdss7-200</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># docker pull k8scn/kubernetes-dashboard-amd64:v1.8.3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>等待滚动发布完成后，在刷新dashboard页面：</p><figure><img src="`+o+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>可以看到这里原来的skip跳过已经没有了，我们如果想登陆，必须输入token，那我们如何获取token呢：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># kubectl get secret  -n kube-system
# kubectl describe secret kubernetes-dashboard-admin-token-pg77n  -n kube-system
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="`+u+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>这样我们就拿到了token，接下来我们试试能不能登录：</p><p>我们发现我们还是无法登录，原因是必须使用https登录，接下来我们需要申请证书：</p><figure><img src="'+m+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>接下来我们申请证书：</p><p>依然使用cfssl来申请证书：hdss7-200</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># cd /opt/certs/
...
</code></pre>`,33);function y(_,f){const n=a("ExternalLinkIcon");return d(),t("div",null,[h,e("p",null,[e("a",x,[l("http://dashboard.od.com"),r(n)])]),k])}const B=s(g,[["render",y],["__file","kubernetes进阶（五）dashboard--WEB管理.html.vue"]]),C=JSON.parse('{"path":"/note-book/Kubernetes/kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%BA%94%EF%BC%89dashboard--WEB%E7%AE%A1%E7%90%86.html","title":"","lang":"zh-CN","frontmatter":{"description":"dashboard是k8s的可视化管理平台，是三种管理k8s集群方法之一 首先下载镜像上传到我们的私有仓库中：hdss7-200 编辑dashboard资源配置清单： 1、rbac.yaml 2、dp.yaml 3、svc.yaml 4、ingress.yaml 创建资源：任意node 添加域名解析： 通过浏览器访问： http://dashboard...","head":[["meta",{"property":"og:url","content":"https://paper-dragon.github.io/note-book/Kubernetes/kubernetes%E8%BF%9B%E9%98%B6%EF%BC%88%E4%BA%94%EF%BC%89dashboard--WEB%E7%AE%A1%E7%90%86.html"}],["meta",{"property":"og:site_name","content":"运维开发绿皮书"}],["meta",{"property":"og:description","content":"dashboard是k8s的可视化管理平台，是三种管理k8s集群方法之一 首先下载镜像上传到我们的私有仓库中：hdss7-200 编辑dashboard资源配置清单： 1、rbac.yaml 2、dp.yaml 3、svc.yaml 4、ingress.yaml 创建资源：任意node 添加域名解析： 通过浏览器访问： http://dashboard..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-08-13T15:08:38.000Z"}],["meta",{"property":"article:author","content":"PaperDragon"}],["meta",{"property":"article:modified_time","content":"2023-08-13T15:08:38.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2023-08-13T15:08:38.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"PaperDragon\\",\\"url\\":\\"https://github.com/Paper-Dragon\\",\\"email\\":\\"2678885646@qq.com\\"}]}"]]},"headers":[],"git":{"createdTime":1691939318000,"updatedTime":1691939318000,"contributors":[{"name":"PaperDragon","email":"2678885646@qq.com","commits":1}]},"readingTime":{"minutes":3.43,"words":1029},"filePathRelative":"note-book/Kubernetes/kubernetes进阶（五）dashboard--WEB管理.md","localizedDate":"2023年8月13日","excerpt":"<p>dashboard是k8s的可视化管理平台，是三种管理k8s集群方法之一</p>\\n<p>首先下载镜像上传到我们的私有仓库中：hdss7-200</p>\\n<div class=\\"language-text\\" data-ext=\\"text\\" data-title=\\"text\\"><pre class=\\"language-text\\"><code># docker pull k8scn/kubernetes-dashboard-amd64:v1.8.3\\n# docker tag fcac9aa03fd6 harbor.od.com/public/dashboard:v1.8.3\\n# docker push harbor.od.com/public/dashboard:v1.8.3\\n</code></pre></div>","autoDesc":true}');export{B as comp,C as data};
