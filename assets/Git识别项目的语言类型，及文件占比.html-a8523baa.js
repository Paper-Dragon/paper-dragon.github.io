import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{o as n,c as a,f as e}from"./app-e801a6f5.js";const t="/assets/20210705154350159-16919217537001-3e40ec25.png",i="/assets/image-20220512092647797-16919217571493-862ee34d.png",c={},o=e('<p>最近在做代码分析，想知道一个git仓库的语言类型，相信大家都见过这个：<br><img src="'+t+`" alt="在这里插入图片描述" loading="lazy"><br> 图中列出了不同的文件类型在代码仓中的占比，那如何实现这个功能呢？</p><p>结果研究，我写了一个脚本如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># git查询文件后缀的数量，用以区分项目使用的语言。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 完整命令，在已经git clone的目录下执行：</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>运行效果如下，每一种后缀的文件数量都被统计出来了：<br><img src="`+i+'" alt="image-20220512092647797" loading="lazy"></p><p>ps: 如果不想下载全部代码，请使用git的sparse-checkout功能。</p>',6),p=[o];function l(r,m){return n(),a("div",null,p)}const v=s(c,[["render",l],["__file","Git识别项目的语言类型，及文件占比.html.vue"]]);export{v as default};
