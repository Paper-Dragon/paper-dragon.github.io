import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,o as n,d as s}from"./app-j_b4sUmU.js";const a="/assets/1034759-20191125193911658-1073438860-16918406809571-vo8SIs8l.png",d="/assets/1034759-20191126161244510-1269371002-16918406826423-DRHjp4PI.png",t="/assets/1034759-20191126163610063-918814879-16918406847055-MP1im4fS.png",l="/assets/1034759-20191126172440979-1913961041-16918406864827-BnZjQlGt.png",r="/assets/1034759-20191126172608230-363720611-16918406885179-CHqntM2q.png",c="/assets/1034759-20191126183554740-658611982-169184069139711-Bl8ssb93.png",v="/assets/1034759-20191126183711805-835833813-169184069393713-6vAtzZB8.png",o={},u=s(`<h1 id="kubernetes进阶-五-dashboard-web管理" tabindex="-1"><a class="header-anchor" href="#kubernetes进阶-五-dashboard-web管理"><span>kubernetes进阶（五）dashboard--WEB管理</span></a></h1><p>dashboard是k8s的可视化管理平台，是三种管理k8s集群方法之一</p><p>首先下载镜像上传到我们的私有仓库中：hdss7-200</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># docker pull k8scn/kubernetes-dashboard-amd64:v1.8.3
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过浏览器访问：</p><p><a href="http://dashboard.od.com/" target="_blank" rel="noopener noreferrer">http://dashboard.od.com</a></p><figure><img src="`+a+'" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>美好的点点点运维开始了~</p><p>但是，我们可以看到我们安装1.8版本的dashboard，默认是可以跳过验证的：</p><figure><img src="'+d+`" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>很显然，跳过登录，是不科学的，因为我们在配置dashboard的rbac权限时，绑定的角色是system:admin，这个是集群管理员的角色，权限很大，所以这里我们把版本换成1.10以上版本</p><p>下载1.10.1版本：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code># docker pull loveone/kubernetes-dashboard-amd64:v1.10.1
