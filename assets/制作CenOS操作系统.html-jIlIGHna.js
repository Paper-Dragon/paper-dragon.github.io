import{_ as n}from"./plugin-vue_export-helper-x3n3nnut.js";import{o as s,c as a,e}from"./app-HEIvoBf_.js";const t={},o=e(`<h1 id="制作centos操作系统rootfs" tabindex="-1"><a class="header-anchor" href="#制作centos操作系统rootfs" aria-hidden="true">#</a> 制作CentOS操作系统RootFS</h1><h2 id="基础安装" tabindex="-1"><a class="header-anchor" href="#基础安装" aria-hidden="true">#</a> 基础安装</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token punctuation">[</span>root@monther ~<span class="token punctuation">]</span><span class="token comment"># mkdir mkRootfs</span>
